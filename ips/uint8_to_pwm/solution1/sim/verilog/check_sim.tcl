...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.uint8_to_pwm.autotvin_m0_V.dat"
         "c.uint8_to_pwm.autotvin_m1_V.dat"
         "c.uint8_to_pwm.autotvin_m2_V.dat"
         "c.uint8_to_pwm.autotvin_m3_V.dat"
         "c.uint8_to_pwm.autotvin_m4_V.dat"
         "c.uint8_to_pwm.autotvin_m5_V.dat"
         "c.uint8_to_pwm.autotvout_out_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.uint8_to_pwm.autotvout_out_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
