...
#ifndef __rpy_to_duty_mul_mbkb__HH__
#define __rpy_to_duty_mul_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rpy_to_duty_mul_mbkb) {
    ...
    SC_CTOR(rpy_to_duty_mul_mbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
