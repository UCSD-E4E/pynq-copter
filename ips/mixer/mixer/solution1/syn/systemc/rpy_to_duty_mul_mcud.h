...
#ifndef __rpy_to_duty_mul_mcud__HH__
#define __rpy_to_duty_mul_mcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rpy_to_duty_mul_mcud) {
    ...
    SC_CTOR(rpy_to_duty_mul_mcud):  ACMP_smul_us_U ("ACMP_smul_us_U") {
