...
#ifndef __hls_gpio_mul_mul_cud__HH__
#define __hls_gpio_mul_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_gpio_mul_mul_cud) {
    ...
    SC_CTOR(hls_gpio_mul_mul_cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
