...
BEGIN PROCESSOR
 ...
 PARAMETER compiler_flags =  -mlittle-endian -mxl-barrel-shift -mno-xl-soft-mul -mno-xl-soft-div -mcpu=v10.0
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_gpio
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hls_gpio
END
