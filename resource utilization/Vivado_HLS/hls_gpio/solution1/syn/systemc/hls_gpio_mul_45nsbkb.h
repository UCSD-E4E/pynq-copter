...
#ifndef __hls_gpio_mul_45nsbkb__HH__
#define __hls_gpio_mul_45nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_gpio_mul_45nsbkb) {
    ...
    SC_CTOR(hls_gpio_mul_45nsbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
