...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    input  wire [2:0]                    in_r_address0,
    input  wire                          in_r_ce0,
    output wire [0:0]                    in_r_q0
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_IER       = 5'h08,
    ADDR_ISR       = 5'h0c,
    ADDR_IN_R_BASE = 5'h10,
    ADDR_IN_R_HIGH = 5'h17,
    WRIDLE         = 2'd0,
    WRDATA         = 2'd1,
    WRRESP         = 2'd2,
    WRRESET        = 2'd3,
...
assign int_in_r_address1 = ar_hs? raddr[2:2] : waddr[2:2];
...
module atoi_AXILiteS_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
