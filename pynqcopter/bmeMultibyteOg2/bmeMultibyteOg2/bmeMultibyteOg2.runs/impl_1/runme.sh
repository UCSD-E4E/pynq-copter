...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyteOg2/bmeMultibyteOg2/bmeMultibyteOg2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyteOg2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeMultibyteOg2_wrapper.tcl -notrace
