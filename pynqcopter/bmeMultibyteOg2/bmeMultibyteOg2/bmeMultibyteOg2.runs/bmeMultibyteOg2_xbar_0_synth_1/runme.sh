...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyteOg2/bmeMultibyteOg2/bmeMultibyteOg2.runs/bmeMultibyteOg2_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyteOg2_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyteOg2_xbar_0.tcl
