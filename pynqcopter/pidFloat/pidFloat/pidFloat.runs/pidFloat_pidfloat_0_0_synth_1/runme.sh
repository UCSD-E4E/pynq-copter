...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/pidFloat/pidFloat/pidFloat.runs/pidFloat_pidfloat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pidFloat_pidfloat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pidFloat_pidfloat_0_0.tcl
