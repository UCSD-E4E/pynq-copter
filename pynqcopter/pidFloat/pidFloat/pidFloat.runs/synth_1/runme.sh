...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/pidFloat/pidFloat/pidFloat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pidFloat_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pidFloat_wrapper.tcl
