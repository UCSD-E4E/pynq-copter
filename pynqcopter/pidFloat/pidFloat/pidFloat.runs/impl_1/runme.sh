...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/pidFloat/pidFloat/pidFloat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pidFloat_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pidFloat_wrapper.tcl -notrace
