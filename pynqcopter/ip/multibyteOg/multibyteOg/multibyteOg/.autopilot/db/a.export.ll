; ModuleID = '/home/iavendano/pynq-copter/pynqcopter/ip/multibyteOg/multibyteOg/multibyteOg/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@multibyteOg_str = internal unnamed_addr constant [12 x i8] c"multibyteOg\00"
...
@delay_until_ms_MD_50_1 = internal unnamed_addr constant [44 x i8] c"delay_until_ms<500ull, 100000000ull>.region\00"
...
define void @multibyteOg(i32* %CTRL, i32* %pressure_msb, i32* %pressure_lsb, i32* %pressure_xlsb) {
...
; <label>:3                                       ; preds = %4, %2
  ...
  br i1 %tmp_3, label %"delay_until_ms<50ull, 100000000ull>.exit15", label %4
...
"delay_until_ms<50ull, 100000000ull>.exit15":     ; preds = %3
  %rend12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([43 x i8]* @delay_until_ms_MD_50, i32 %rbegin2) nounwind
...
; <label>:5                                       ; preds = %6, %"delay_until_ms<50ull, 100000000ull>.exit15"
  %p_014_0_i9 = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit15" ], [ %ctr_V_1, %6 ]
  %tmp_5 = icmp eq i23 %p_014_0_i9, -3388608
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5000000, i64 5000000, i64 5000000) nounwind
  %ctr_V_1 = add i23 %p_014_0_i9, 1
  br i1 %tmp_5, label %"delay_until_ms<50ull, 100000000ull>.exit10", label %6
...
; <label>:7                                       ; preds = %8, %"delay_until_ms<50ull, 100000000ull>.exit10"
  %p_014_0_i4 = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit10" ], [ %ctr_V_2, %8 ]
  %tmp_7 = icmp eq i23 %p_014_0_i4, -3388608
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5000000, i64 5000000, i64 5000000) nounwind
  %ctr_V_2 = add i23 %p_014_0_i4, 1
  br i1 %tmp_7, label %"delay_until_ms<50ull, 100000000ull>.exit5", label %8
...
; <label>:9                                       ; preds = %10, %"delay_until_ms<50ull, 100000000ull>.exit5"
  %p_014_0_i = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit5" ], [ %ctr_V_3, %10 ]
  ...
  %ctr_V_3 = add i23 %p_014_0_i, 1
  br i1 %tmp_9, label %"delay_until_ms<50ull, 100000000ull>.exit", label %10
...
"delay_until_ms<50ull, 100000000ull>.exit":       ; preds = %9
  ...
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([44 x i8]* @delay_until_ms_MD_50_1) nounwind
  call void (...)* @_ssdm_op_SpecProtocol(i32 0, [1 x i8]* @p_str1) nounwind
  br label %11

; <label>:11                                      ; preds = %12, %"delay_until_ms<50ull, 100000000ull>.exit"
  %p_014_0_i2 = phi i26 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit" ], [ %ctr_V_4, %12 ]
  %tmp_s = icmp eq i26 %p_014_0_i2, -17108864
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 50000000, i64 50000000, i64 50000000) nounwind
  %ctr_V_4 = add i26 %p_014_0_i2, 1
  br i1 %tmp_s, label %"delay_until_ms<500ull, 100000000ull>.exit", label %12
...
"delay_until_ms<500ull, 100000000ull>.exit":      ; preds = %11
  %rend17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([44 x i8]* @delay_until_ms_MD_50_1, i32 %rbegin3) nounwind
  ...
  %empty_8 = call i32 @_ssdm_op_Read.m_axi.volatile.i32P(i32* %CTRL_addr_60)
...
; <label>:13                                      ; preds = %_ifconv, %._crit_edge
  %sensorData_2_2 = phi i32 [ %sensorData_2_1, %._crit_edge ], [ %sensorData_2_1_11, %_ifconv ]
  ...
  br i1 %exitcond, label %14, label %_ifconv
...
_ifconv:                                          ; preds = %13
  ...
  %sensorData_2_10 = select i1 %sel_tmp, i32 %sensorData_2_2, i32 %sensorData_0
  %sel_tmp2 = icmp eq i2 %index, 0
  %sensorData_2_1_11 = select i1 %sel_tmp2, i32 %sensorData_2_2, i32 %sensorData_2_10
  %sensorData_2_2_12 = select i1 %sel_tmp, i32 %sensorData_0, i32 %sensorData_1_2
  %sensorData_2_3 = select i1 %sel_tmp2, i32 %sensorData_1_2, i32 %sensorData_2_2_12
