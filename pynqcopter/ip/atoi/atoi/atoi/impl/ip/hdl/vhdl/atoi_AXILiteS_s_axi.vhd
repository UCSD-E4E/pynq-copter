...
end entity atoi_AXILiteS_s_axi;
...
architecture behave of atoi_AXILiteS_s_axi is
    ...
    constant ADDR_IN_R_BASE : INTEGER := 16#10#;
    constant ADDR_IN_R_HIGH : INTEGER := 16#17#;
    ...
    -- memory signals
    signal int_in_r_address0   : UNSIGNED(0 downto 0);
    ...
    signal int_in_r_address1   : UNSIGNED(0 downto 0);
    ...
    component atoi_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component atoi_AXILiteS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_in_r
int_in_r : atoi_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
...
-- ----------------------- Memory logic ------------------
    -- in_r
    int_in_r_address0    <= SHIFT_RIGHT(UNSIGNED(in_r_address0), 2)(0 downto 0);
    int_in_r_ce0         <= in_r_ce0;
    int_in_r_we0         <= '0';
    int_in_r_be0         <= (others => '0');
    int_in_r_d0          <= (others => '0');
    in_r_q0              <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_in_r_q0, TO_INTEGER(int_in_r_shift) * 8)(0 downto 0));
    int_in_r_address1    <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
...
entity atoi_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity atoi_AXILiteS_s_axi_ram;

architecture behave of atoi_AXILiteS_s_axi_ram is
