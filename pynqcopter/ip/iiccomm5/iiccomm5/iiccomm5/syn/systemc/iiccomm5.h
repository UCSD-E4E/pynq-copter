...
struct iiccomm5 : public sc_module {
    ...
    sc_signal< sc_logic > outValue11_ap_vld;
    ...
    sc_signal< sc_lv<32> > iic_read_reg_433;
    sc_signal< sc_lv<32> > iic_addr_read_reg_444;
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_455;
    sc_signal< sc_lv<32> > iic_addr_2_read_reg_466;
    sc_signal< sc_lv<32> > iic_addr_3_read_reg_471;
    sc_signal< sc_lv<32> > iic_addr_4_read_reg_476;
    sc_signal< sc_lv<32> > iic_addr_5_read_reg_481;
    sc_signal< sc_lv<32> > iic_addr_6_read_reg_486;
    sc_signal< sc_lv<32> > iic_addr_7_read_reg_491;
    sc_signal< sc_lv<32> > iic_addr_8_read_reg_496;
