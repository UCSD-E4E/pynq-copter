...
struct iiccommmod : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_5_fu_339_p2;
    ...
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_371;
    sc_signal< sc_logic > ap_sig_ioackin_iic_AWREADY;
    sc_signal< sc_lv<32> > iic_addr_9_read_reg_386;
    sc_signal< sc_lv<29> > ctr_V_fu_325_p2;
    sc_signal< sc_logic > ap_CS_fsm_state30;
    sc_signal< sc_lv<29> > ctr_V_1_fu_345_p2;
    sc_signal< bool > ap_block_state32_io;
    sc_signal< sc_lv<32> > iic_addr_14_read_reg_417;
    sc_signal< sc_logic > grp_readData_fu_256_ap_start;
    sc_signal< sc_logic > grp_readData_fu_256_ap_done;
    sc_signal< sc_logic > grp_readData_fu_256_ap_idle;
    sc_signal< sc_logic > grp_readData_fu_256_ap_ready;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_AWVALID;
    sc_signal< sc_lv<32> > grp_readData_fu_256_m_axi_iic2_AWADDR;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_AWID;
    sc_signal< sc_lv<32> > grp_readData_fu_256_m_axi_iic2_AWLEN;
    sc_signal< sc_lv<3> > grp_readData_fu_256_m_axi_iic2_AWSIZE;
    sc_signal< sc_lv<2> > grp_readData_fu_256_m_axi_iic2_AWBURST;
    sc_signal< sc_lv<2> > grp_readData_fu_256_m_axi_iic2_AWLOCK;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_AWCACHE;
    sc_signal< sc_lv<3> > grp_readData_fu_256_m_axi_iic2_AWPROT;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_AWQOS;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_AWREGION;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_AWUSER;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_WVALID;
    sc_signal< sc_lv<32> > grp_readData_fu_256_m_axi_iic2_WDATA;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_WSTRB;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_WLAST;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_WID;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_WUSER;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_ARVALID;
    sc_signal< sc_lv<32> > grp_readData_fu_256_m_axi_iic2_ARADDR;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_ARID;
    sc_signal< sc_lv<32> > grp_readData_fu_256_m_axi_iic2_ARLEN;
    sc_signal< sc_lv<3> > grp_readData_fu_256_m_axi_iic2_ARSIZE;
    sc_signal< sc_lv<2> > grp_readData_fu_256_m_axi_iic2_ARBURST;
    sc_signal< sc_lv<2> > grp_readData_fu_256_m_axi_iic2_ARLOCK;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_ARCACHE;
    sc_signal< sc_lv<3> > grp_readData_fu_256_m_axi_iic2_ARPROT;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_ARQOS;
    sc_signal< sc_lv<4> > grp_readData_fu_256_m_axi_iic2_ARREGION;
    sc_signal< sc_lv<1> > grp_readData_fu_256_m_axi_iic2_ARUSER;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_RREADY;
    sc_signal< sc_logic > grp_readData_fu_256_m_axi_iic2_BREADY;
    sc_signal< sc_lv<29> > p_014_0_i4_reg_234;
    sc_signal< sc_lv<1> > tmp_fu_319_p2;
    sc_signal< sc_lv<29> > p_014_0_i_reg_245;
    sc_signal< sc_logic > ap_CS_fsm_state31;
    sc_signal< sc_logic > ap_reg_grp_readData_fu_256_ap_start;
