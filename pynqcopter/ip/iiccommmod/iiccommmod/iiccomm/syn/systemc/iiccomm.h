...
struct iiccomm : public sc_module {
    ...
    sc_signal< sc_lv<32> > iic_addr_reg_425;
    sc_signal< sc_logic > ap_sig_ioackin_iic_ARREADY;
    sc_signal< sc_lv<32> > iic_addr_1_reg_432;
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_446;
    sc_signal< sc_lv<32> > iic_addr_2_read_reg_451;
    sc_signal< sc_lv<32> > iic_addr_3_reg_456;
    sc_signal< sc_lv<32> > iic_addr_4_read_reg_479;
    ...
    void thread_iic_addr_1_reg_432();
    void thread_iic_addr_3_reg_456();
    void thread_iic_addr_reg_425();
