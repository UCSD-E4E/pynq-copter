...
`timescale 1ns/1ps
module bmesensor2_AXILiteS_s_axi
#(parameter
    ...
    input  wire [31:0]                   receivedSuccess,
    input  wire                          receivedSuccess_ap_vld,
...
localparam
    ...
    ADDR_RX_FIFO_OUTVALUE_I_DATA_0        = 9'h0e8,
    ADDR_RX_FIFO_OUTVALUE_I_CTRL          = 9'h0ec,
    ADDR_RX_FIFO_OUTVALUE_O_DATA_0        = 9'h0f0,
    ADDR_RX_FIFO_OUTVALUE_O_CTRL          = 9'h0f4,
    ...
    ADDR_RECEIVEDSUCCESS_DATA_0           = 9'h110,
    ADDR_RECEIVEDSUCCESS_CTRL             = 9'h114,
    ADDR_PRESSURE_MSB_I_DATA_0            = 9'h118,
    ADDR_PRESSURE_MSB_I_CTRL              = 9'h11c,
    ADDR_PRESSURE_MSB_O_DATA_0            = 9'h120,
    ADDR_PRESSURE_MSB_O_CTRL              = 9'h124,
    ADDR_PRESSURE_LSB_I_DATA_0            = 9'h128,
    ADDR_PRESSURE_LSB_I_CTRL              = 9'h12c,
    ADDR_PRESSURE_LSB_O_DATA_0            = 9'h130,
    ADDR_PRESSURE_LSB_O_CTRL              = 9'h134,
    ADDR_PRESSURE_XLSB_I_DATA_0           = 9'h138,
    ADDR_PRESSURE_XLSB_I_CTRL             = 9'h13c,
    ADDR_PRESSURE_XLSB_O_DATA_0           = 9'h140,
    ADDR_PRESSURE_XLSB_O_CTRL             = 9'h144,
    ADDR_STAT_REG_VAL6_STATE_DATA_0       = 9'h148,
    ADDR_STAT_REG_VAL6_STATE_CTRL         = 9'h14c,
    ADDR_CTRL_REG_VAL2_DATA_0             = 9'h150,
    ADDR_CTRL_REG_VAL2_CTRL               = 9'h154,
    ADDR_CTRL2REGSTATE_DATA_0             = 9'h158,
    ADDR_CTRL2REGSTATE_CTRL               = 9'h15c,
    ADDR_CTRL_REG_CHECK_DATA_0            = 9'h160,
    ADDR_CTRL_REG_CHECK_CTRL              = 9'h164,
    ADDR_ZEROBYTES_DATA_0                 = 9'h168,
    ADDR_ZEROBYTES_CTRL                   = 9'h16c,
    ADDR_INTERRSTATUS3STATE_DATA_0        = 9'h170,
    ADDR_INTERRSTATUS3STATE_CTRL          = 9'h174,
    ADDR_INTERRSTATUS5STATE_DATA_0        = 9'h178,
    ADDR_INTERRSTATUS5STATE_CTRL          = 9'h17c,
    ADDR_TX_FIFO_1_DATA_0                 = 9'h180,
    ADDR_TX_FIFO_1_CTRL                   = 9'h184,
    ADDR_TX_FIFO_2_DATA_0                 = 9'h188,
    ADDR_TX_FIFO_2_CTRL                   = 9'h18c,
    ADDR_INTERRSTATUS_DATA_0              = 9'h190,
    ADDR_INTERRSTATUS_CTRL                = 9'h194,
    ADDR_STAT_REG_VAL_DATA_0              = 9'h198,
    ADDR_STAT_REG_VAL_CTRL                = 9'h19c,
    ADDR_STATREGSTATE_DATA_0              = 9'h1a0,
    ADDR_STATREGSTATE_CTRL                = 9'h1a4,
    ADDR_CLEARINTERRSTATUS_DATA_0         = 9'h1a8,
    ADDR_CLEARINTERRSTATUS_CTRL           = 9'h1ac,
    ADDR_CLEARINTERRSTATUSCHECK_DATA_0    = 9'h1b0,
    ADDR_CLEARINTERRSTATUSCHECK_CTRL      = 9'h1b4,
    ADDR_ERROR1_DATA_0                    = 9'h1b8,
    ADDR_ERROR1_CTRL                      = 9'h1bc,
    ADDR_TX_FIFO_3_DATA_0                 = 9'h1c0,
    ADDR_TX_FIFO_3_CTRL                   = 9'h1c4,
    ADDR_INTERRSTATUS3_DATA_0             = 9'h1c8,
    ADDR_INTERRSTATUS3_CTRL               = 9'h1cc,
    WRIDLE                                = 2'd0,
    WRDATA                                = 2'd1,
    WRRESP                                = 2'd2,
    WRRESET                               = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_receivedSuccess = 'b0;
    reg                           int_receivedSuccess_ap_vld;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_RECEIVEDSUCCESS_DATA_0: begin
                    rdata <= int_receivedSuccess[31:0];
                end
                ADDR_RECEIVEDSUCCESS_CTRL: begin
                    rdata[0] <= int_receivedSuccess_ap_vld;
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_receivedSuccess <= 0;
    else if (ACLK_EN) begin
        if (receivedSuccess_ap_vld)
            int_receivedSuccess <= receivedSuccess;
    end
end

// int_receivedSuccess_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_receivedSuccess_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (receivedSuccess_ap_vld)
            int_receivedSuccess_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_RECEIVEDSUCCESS_CTRL)
            int_receivedSuccess_ap_vld <= 1'b0; // clear on read
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ERROR1_DATA_0)
            int_error1[31:0] <= (WDATA[31:0] & wmask) | (int_error1[31:0] & ~wmask);
    end
end
