...
set C_modelArgList {
	...
	{ rx_fifo_Outvalue int 32 regular {axi_slave 2}  }
	{ clearLatchedInterr int 32 regular {axi_slave 2}  }
	{ releaseBus int 32 regular {axi_slave 1}  }
	{ receivedSuccess int 32 regular {axi_slave 1}  }
	...
	{ error1 int 32 unused {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "iic", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "rx_fifo_Outvalue", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "rx_fifo_Outvalue","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":232, "out":240}, "offset_end" : {"in":239, "out":247}} , 
 	...
 	{ "Name" : "receivedSuccess", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "receivedSuccess","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":272}, "offset_end" : {"out":279}} , 
 	{ "Name" : "pressure_msb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_msb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":280, "out":288}, "offset_end" : {"in":287, "out":295}} , 
 	{ "Name" : "pressure_lsb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_lsb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":296, "out":304}, "offset_end" : {"in":303, "out":311}} , 
 	{ "Name" : "pressure_xlsb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_xlsb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":312, "out":320}, "offset_end" : {"in":319, "out":327}} , 
 	{ "Name" : "stat_reg_val6_state", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "stat_reg_val6_state","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":328}, "offset_end" : {"out":335}} , 
 	{ "Name" : "ctrl_reg_val2", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ctrl_reg_val2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":336}, "offset_end" : {"out":343}} , 
 	{ "Name" : "ctrl2RegState", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ctrl2RegState","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":344}, "offset_end" : {"out":351}} , 
 	{ "Name" : "ctrl_reg_check", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ctrl_reg_check","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":352}, "offset_end" : {"out":359}} , 
 	{ "Name" : "zeroBytes", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "zeroBytes","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":360}, "offset_end" : {"in":367}} , 
 	{ "Name" : "interrStatus3State", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "interrStatus3State","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":368}, "offset_end" : {"out":375}} , 
 	{ "Name" : "interrStatus5State", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "interrStatus5State","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":376}, "offset_end" : {"out":383}} , 
 	{ "Name" : "tx_fifo_1", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "tx_fifo_1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":384}, "offset_end" : {"out":391}} , 
 	{ "Name" : "tx_fifo_2", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "tx_fifo_2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":392}, "offset_end" : {"out":399}} , 
 	{ "Name" : "interrStatus", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "interrStatus","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":400}, "offset_end" : {"out":407}} , 
 	{ "Name" : "stat_reg_val", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "stat_reg_val","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":408}, "offset_end" : {"out":415}} , 
 	{ "Name" : "statRegState", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "statRegState","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":416}, "offset_end" : {"out":423}} , 
 	{ "Name" : "clearInterrStatus", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "clearInterrStatus","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":424}, "offset_end" : {"out":431}} , 
 	{ "Name" : "clearInterrStatusCheck", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "clearInterrStatusCheck","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":432}, "offset_end" : {"out":439}} , 
 	{ "Name" : "error1", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "error1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":440}, "offset_end" : {"in":447}} , 
 	{ "Name" : "tx_fifo_3", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "tx_fifo_3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":448}, "offset_end" : {"out":455}} , 
 	{ "Name" : "interrStatus3", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "interrStatus3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":456}, "offset_end" : {"out":463}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"bmesensor2","role":"start","value":"0","valid_bit":"0"},{"name":"bmesensor2","role":"continue","value":"0","valid_bit":"4"},{"name":"bmesensor2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"stat_reg_outValue1","role":"data","value":"16"},{"name":"empty_pirq_outValue","role":"data","value":"32"},{"name":"full_pirq_outValue","role":"data","value":"48"},{"name":"ctrl_reg_outValue1","role":"data","value":"64"},{"name":"clearedInterrStatus1","role":"data","value":"80"},{"name":"rxFifoDepth1","role":"data","value":"96"},{"name":"byteCountZero","role":"data","value":"128"},{"name":"clearedInterruptStatus2","role":"data","value":"136"},{"name":"interrStatus2","role":"data","value":"144"},{"name":"ctrl_reg_val3","role":"data","value":"200"},{"name":"lastByteRead","role":"data","value":"216"},{"name":"rx_fifo_Outvalue","role":"data","value":"232"},{"name":"clearLatchedInterr","role":"data","value":"248"},{"name":"pressure_msb","role":"data","value":"280"},{"name":"pressure_lsb","role":"data","value":"296"},{"name":"pressure_xlsb","role":"data","value":"312"},{"name":"zeroBytes","role":"data","value":"360"},{"name":"error1","role":"data","value":"440"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"bmesensor2","role":"start","value":"0","valid_bit":"0"},{"name":"bmesensor2","role":"done","value":"0","valid_bit":"1"},{"name":"bmesensor2","role":"idle","value":"0","valid_bit":"2"},{"name":"bmesensor2","role":"ready","value":"0","valid_bit":"3"},{"name":"bmesensor2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"stat_reg_outValue1","role":"data","value":"24"}, {"name":"stat_reg_outValue1","role":"valid","value":"28","valid_bit":"0"},{"name":"empty_pirq_outValue","role":"data","value":"40"}, {"name":"empty_pirq_outValue","role":"valid","value":"44","valid_bit":"0"},{"name":"full_pirq_outValue","role":"data","value":"56"}, {"name":"full_pirq_outValue","role":"valid","value":"60","valid_bit":"0"},{"name":"ctrl_reg_outValue1","role":"data","value":"72"}, {"name":"ctrl_reg_outValue1","role":"valid","value":"76","valid_bit":"0"},{"name":"clearedInterrStatus1","role":"data","value":"88"}, {"name":"clearedInterrStatus1","role":"valid","value":"92","valid_bit":"0"},{"name":"rxFifoDepth1","role":"data","value":"104"}, {"name":"rxFifoDepth1","role":"valid","value":"108","valid_bit":"0"},{"name":"resetAxiEnabled","role":"data","value":"112"}, {"name":"resetAxiEnabled","role":"valid","value":"116","valid_bit":"0"},{"name":"ctrl2RegState_enabled","role":"data","value":"120"}, {"name":"ctrl2RegState_enabled","role":"valid","value":"124","valid_bit":"0"},{"name":"interrStatus2","role":"data","value":"152"}, {"name":"interrStatus2","role":"valid","value":"156","valid_bit":"0"},{"name":"disableTxBitDirection","role":"data","value":"160"}, {"name":"disableTxBitDirection","role":"valid","value":"164","valid_bit":"0"},{"name":"pressByteCountEnabled","role":"data","value":"168"}, {"name":"pressByteCountEnabled","role":"valid","value":"172","valid_bit":"0"},{"name":"byteTracker","role":"data","value":"176"}, {"name":"byteTracker","role":"valid","value":"180","valid_bit":"0"},{"name":"interrStatus3StateEnabled","role":"data","value":"184"}, {"name":"interrStatus3StateEnabled","role":"valid","value":"188","valid_bit":"0"},{"name":"checkInterrReg","role":"data","value":"192"}, {"name":"checkInterrReg","role":"valid","value":"196","valid_bit":"0"},{"name":"ctrl_reg_val3","role":"data","value":"208"}, {"name":"ctrl_reg_val3","role":"valid","value":"212","valid_bit":"0"},{"name":"lastByteRead","role":"data","value":"224"}, {"name":"lastByteRead","role":"valid","value":"228","valid_bit":"0"},{"name":"rx_fifo_Outvalue","role":"data","value":"240"}, {"name":"rx_fifo_Outvalue","role":"valid","value":"244","valid_bit":"0"},{"name":"clearLatchedInterr","role":"data","value":"256"}, {"name":"clearLatchedInterr","role":"valid","value":"260","valid_bit":"0"},{"name":"releaseBus","role":"data","value":"264"}, {"name":"releaseBus","role":"valid","value":"268","valid_bit":"0"},{"name":"receivedSuccess","role":"data","value":"272"}, {"name":"receivedSuccess","role":"valid","value":"276","valid_bit":"0"},{"name":"pressure_msb","role":"data","value":"288"}, {"name":"pressure_msb","role":"valid","value":"292","valid_bit":"0"},{"name":"pressure_lsb","role":"data","value":"304"}, {"name":"pressure_lsb","role":"valid","value":"308","valid_bit":"0"},{"name":"pressure_xlsb","role":"data","value":"320"}, {"name":"pressure_xlsb","role":"valid","value":"324","valid_bit":"0"},{"name":"stat_reg_val6_state","role":"data","value":"328"}, {"name":"stat_reg_val6_state","role":"valid","value":"332","valid_bit":"0"},{"name":"ctrl_reg_val2","role":"data","value":"336"}, {"name":"ctrl_reg_val2","role":"valid","value":"340","valid_bit":"0"},{"name":"ctrl2RegState","role":"data","value":"344"}, {"name":"ctrl2RegState","role":"valid","value":"348","valid_bit":"0"},{"name":"ctrl_reg_check","role":"data","value":"352"}, {"name":"ctrl_reg_check","role":"valid","value":"356","valid_bit":"0"},{"name":"interrStatus3State","role":"data","value":"368"}, {"name":"interrStatus3State","role":"valid","value":"372","valid_bit":"0"},{"name":"interrStatus5State","role":"data","value":"376"}, {"name":"interrStatus5State","role":"valid","value":"380","valid_bit":"0"},{"name":"tx_fifo_1","role":"data","value":"384"}, {"name":"tx_fifo_1","role":"valid","value":"388","valid_bit":"0"},{"name":"tx_fifo_2","role":"data","value":"392"}, {"name":"tx_fifo_2","role":"valid","value":"396","valid_bit":"0"},{"name":"interrStatus","role":"data","value":"400"}, {"name":"interrStatus","role":"valid","value":"404","valid_bit":"0"},{"name":"stat_reg_val","role":"data","value":"408"}, {"name":"stat_reg_val","role":"valid","value":"412","valid_bit":"0"},{"name":"statRegState","role":"data","value":"416"}, {"name":"statRegState","role":"valid","value":"420","valid_bit":"0"},{"name":"clearInterrStatus","role":"data","value":"424"}, {"name":"clearInterrStatus","role":"valid","value":"428","valid_bit":"0"},{"name":"clearInterrStatusCheck","role":"data","value":"432"}, {"name":"clearInterrStatusCheck","role":"valid","value":"436","valid_bit":"0"},{"name":"tx_fifo_3","role":"data","value":"448"}, {"name":"tx_fifo_3","role":"valid","value":"452","valid_bit":"0"},{"name":"interrStatus3","role":"data","value":"456"}, {"name":"interrStatus3","role":"valid","value":"460","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "receivedSuccess", "Type" : "Vld", "Direction" : "O"},
			...
			{"Name" : "error1", "Type" : "None", "Direction" : "I"},
			{"Name" : "tx_fifo_3", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "interrStatus3", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "rx_fifo", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bmesensor2_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bmesensor2_iic_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	bmesensor2 {
		iic {Type IO LastRead 213 FirstWrite 9}
		...
		interrStatus2 {Type IO LastRead 7 FirstWrite 164}
		disableTxBitDirection {Type O LastRead -1 FirstWrite 133}
		pressByteCountEnabled {Type O LastRead -1 FirstWrite 188}
		byteTracker {Type O LastRead -1 FirstWrite 188}
		interrStatus3StateEnabled {Type O LastRead -1 FirstWrite 188}
		checkInterrReg {Type O LastRead -1 FirstWrite 188}
		ctrl_reg_val3 {Type IO LastRead 7 FirstWrite 188}
		lastByteRead {Type IO LastRead 195 FirstWrite 194}
		rx_fifo_Outvalue {Type IO LastRead 7 FirstWrite 212}
		clearLatchedInterr {Type IO LastRead 209 FirstWrite 208}
		releaseBus {Type O LastRead -1 FirstWrite 189}
		receivedSuccess {Type O LastRead -1 FirstWrite 189}
		pressure_msb {Type IO LastRead 7 FirstWrite 189}
		pressure_lsb {Type IO LastRead 7 FirstWrite 189}
		pressure_xlsb {Type IO LastRead 7 FirstWrite 189}
		stat_reg_val6_state {Type O LastRead -1 FirstWrite 189}
		ctrl_reg_val2 {Type O LastRead -1 FirstWrite 132}
		ctrl2RegState {Type O LastRead -1 FirstWrite 132}
		ctrl_reg_check {Type O LastRead -1 FirstWrite 164}
		zeroBytes {Type I LastRead -1 FirstWrite -1}
		interrStatus3State {Type O LastRead -1 FirstWrite 188}
		...
		stat_reg_val {Type O LastRead -1 FirstWrite 164}
		statRegState {Type O LastRead -1 FirstWrite 133}
		clearInterrStatus {Type O LastRead -1 FirstWrite 133}
		clearInterrStatusCheck {Type O LastRead -1 FirstWrite 178}
		error1 {Type I LastRead -1 FirstWrite -1}
		tx_fifo_3 {Type O LastRead -1 FirstWrite 147}
		interrStatus3 {Type O LastRead -1 FirstWrite 188}
		rx_fifo {Type O LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "239", "Max" : "319"}
	, {"Name" : "Interval", "Min" : "240", "Max" : "320"}
]}
