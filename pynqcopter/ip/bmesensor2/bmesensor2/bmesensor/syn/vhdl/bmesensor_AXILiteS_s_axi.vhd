...
--        others - reserved
-- 0x50 : Data signal of pressure_msb_i
--        bit 31~0 - pressure_msb_i[31:0] (Read/Write)
-- 0x54 : reserved
-- 0x58 : Data signal of pressure_msb_o
--        bit 31~0 - pressure_msb_o[31:0] (Read)
-- 0x5c : Control signal of pressure_msb_o
--        bit 0  - pressure_msb_o_ap_vld (Read/COR)
--        others - reserved
-- 0x60 : Data signal of pressure_lsb_i
--        bit 31~0 - pressure_lsb_i[31:0] (Read/Write)
-- 0x64 : reserved
-- 0x68 : Data signal of pressure_lsb_o
--        bit 31~0 - pressure_lsb_o[31:0] (Read)
-- 0x6c : Control signal of pressure_lsb_o
--        bit 0  - pressure_lsb_o_ap_vld (Read/COR)
--        others - reserved
-- 0x70 : Data signal of pressure_xlsb_i
--        bit 31~0 - pressure_xlsb_i[31:0] (Read/Write)
-- 0x74 : reserved
-- 0x78 : Data signal of pressure_xlsb_o
--        bit 31~0 - pressure_xlsb_o[31:0] (Read)
-- 0x7c : Control signal of pressure_xlsb_o
...
architecture behave of bmesensor_AXILiteS_s_axi is
    ...
    constant ADDR_PRESSURE_MSB_I_DATA_0        : INTEGER := 16#50#;
    constant ADDR_PRESSURE_MSB_I_CTRL          : INTEGER := 16#54#;
    constant ADDR_PRESSURE_MSB_O_DATA_0        : INTEGER := 16#58#;
    constant ADDR_PRESSURE_MSB_O_CTRL          : INTEGER := 16#5c#;
    constant ADDR_PRESSURE_LSB_I_DATA_0        : INTEGER := 16#60#;
    constant ADDR_PRESSURE_LSB_I_CTRL          : INTEGER := 16#64#;
    constant ADDR_PRESSURE_LSB_O_DATA_0        : INTEGER := 16#68#;
    constant ADDR_PRESSURE_LSB_O_CTRL          : INTEGER := 16#6c#;
    constant ADDR_PRESSURE_XLSB_I_DATA_0       : INTEGER := 16#70#;
    constant ADDR_PRESSURE_XLSB_I_CTRL         : INTEGER := 16#74#;
    constant ADDR_PRESSURE_XLSB_O_DATA_0       : INTEGER := 16#78#;
    constant ADDR_PRESSURE_XLSB_O_CTRL         : INTEGER := 16#7c#;
