set C_TypeInfoList {{ 
"bmesensor" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": ["0", [4096]]}] }, {"stat_reg_outValue1": [[], {"reference": "0"}] }, {"empty_pirq_outValue": [[], {"reference": "0"}] }, {"full_pirq_outValue": [[], {"reference": "0"}] }, {"ctrl_reg_outValue1": [[], {"reference": "0"}] }, {"pressure_msb": [[], {"reference": "0"}] }, {"pressure_lsb": [[], {"reference": "0"}] }, {"pressure_xlsb": [[], {"reference": "0"}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "iic", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "pressure_msb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_msb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":80, "out":88}, "offset_end" : {"in":87, "out":95}} , 
 	{ "Name" : "pressure_lsb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_lsb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":96, "out":104}, "offset_end" : {"in":103, "out":111}} , 
 	{ "Name" : "pressure_xlsb", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_ovld","bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressure_xlsb","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":112, "out":120}, "offset_end" : {"in":119, "out":127}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"bmesensor","role":"start","value":"0","valid_bit":"0"},{"name":"bmesensor","role":"continue","value":"0","valid_bit":"4"},{"name":"bmesensor","role":"auto_start","value":"0","valid_bit":"7"},{"name":"stat_reg_outValue1","role":"data","value":"16"},{"name":"empty_pirq_outValue","role":"data","value":"32"},{"name":"full_pirq_outValue","role":"data","value":"48"},{"name":"ctrl_reg_outValue1","role":"data","value":"64"},{"name":"pressure_msb","role":"data","value":"80"},{"name":"pressure_lsb","role":"data","value":"96"},{"name":"pressure_xlsb","role":"data","value":"112"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"bmesensor","role":"start","value":"0","valid_bit":"0"},{"name":"bmesensor","role":"done","value":"0","valid_bit":"1"},{"name":"bmesensor","role":"idle","value":"0","valid_bit":"2"},{"name":"bmesensor","role":"ready","value":"0","valid_bit":"3"},{"name":"bmesensor","role":"auto_start","value":"0","valid_bit":"7"},{"name":"stat_reg_outValue1","role":"data","value":"24"}, {"name":"stat_reg_outValue1","role":"valid","value":"28","valid_bit":"0"},{"name":"empty_pirq_outValue","role":"data","value":"40"}, {"name":"empty_pirq_outValue","role":"valid","value":"44","valid_bit":"0"},{"name":"full_pirq_outValue","role":"data","value":"56"}, {"name":"full_pirq_outValue","role":"valid","value":"60","valid_bit":"0"},{"name":"ctrl_reg_outValue1","role":"data","value":"72"}, {"name":"ctrl_reg_outValue1","role":"valid","value":"76","valid_bit":"0"},{"name":"pressure_msb","role":"data","value":"88"}, {"name":"pressure_msb","role":"valid","value":"92","valid_bit":"0"},{"name":"pressure_lsb","role":"data","value":"104"}, {"name":"pressure_lsb","role":"valid","value":"108","valid_bit":"0"},{"name":"pressure_xlsb","role":"data","value":"120"}, {"name":"pressure_xlsb","role":"valid","value":"124","valid_bit":"0"}] },
...
set ArgLastReadFirstWriteLatency {
	bmesensor {
		iic {Type IO LastRead 166 FirstWrite 9}
		...
		pressure_msb {Type IO LastRead 7 FirstWrite 157}
		pressure_lsb {Type IO LastRead 7 FirstWrite 157}
		pressure_xlsb {Type IO LastRead 7 FirstWrite 157}}}
