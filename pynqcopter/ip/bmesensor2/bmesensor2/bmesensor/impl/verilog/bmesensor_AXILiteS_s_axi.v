...
localparam
    ...
    ADDR_CTRL_REG_OUTVALUE1_I_DATA_0  = 7'h40,
    ADDR_CTRL_REG_OUTVALUE1_I_CTRL    = 7'h44,
    ADDR_CTRL_REG_OUTVALUE1_O_DATA_0  = 7'h48,
    ADDR_CTRL_REG_OUTVALUE1_O_CTRL    = 7'h4c,
    ADDR_PRESSURE_MSB_I_DATA_0        = 7'h50,
    ADDR_PRESSURE_MSB_I_CTRL          = 7'h54,
    ADDR_PRESSURE_MSB_O_DATA_0        = 7'h58,
    ADDR_PRESSURE_MSB_O_CTRL          = 7'h5c,
    ADDR_PRESSURE_LSB_I_DATA_0        = 7'h60,
    ADDR_PRESSURE_LSB_I_CTRL          = 7'h64,
    ADDR_PRESSURE_LSB_O_DATA_0        = 7'h68,
    ADDR_PRESSURE_LSB_O_CTRL          = 7'h6c,
    ADDR_PRESSURE_XLSB_I_DATA_0       = 7'h70,
    ADDR_PRESSURE_XLSB_I_CTRL         = 7'h74,
    ADDR_PRESSURE_XLSB_O_DATA_0       = 7'h78,
    ADDR_PRESSURE_XLSB_O_CTRL         = 7'h7c,
    WRIDLE                            = 2'd0,
    WRDATA                            = 2'd1,
    WRRESP                            = 2'd2,
    WRRESET                           = 2'd3,
