...
set Vendor      "UCSD"
set Library     "hlsip"
set IPName      "bmesensor"
set Version     "1.0"
set DisplayName "Bmesensor"
set Revision    "1808151217"
set Description "HLS Core: Bmesensor Function"
set Device      "zynq"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 stat_reg_outValue1_i W 0x0 "Data signal of stat_reg_outValue1_i" {{0 32 stat_reg_outValue1_i W 0 "Bit 31 to 0 Data signal of stat_reg_outValue1_i"}}} {0x18 stat_reg_outValue1_o R 0x0 "Data signal of stat_reg_outValue1_o" {{0 32 stat_reg_outValue1_o R 0 "Bit 31 to 0 Data signal of stat_reg_outValue1_o"}}} {0x1c stat_reg_outValue1_o_ctrl R 0x0 "Control signal of stat_reg_outValue1_o" {{0 1 stat_reg_outValue1_o_ap_vld R 0 "Control signal stat_reg_outValue1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 empty_pirq_outValue_i W 0x0 "Data signal of empty_pirq_outValue_i" {{0 32 empty_pirq_outValue_i W 0 "Bit 31 to 0 Data signal of empty_pirq_outValue_i"}}} {0x28 empty_pirq_outValue_o R 0x0 "Data signal of empty_pirq_outValue_o" {{0 32 empty_pirq_outValue_o R 0 "Bit 31 to 0 Data signal of empty_pirq_outValue_o"}}} {0x2c empty_pirq_outValue_o_ctrl R 0x0 "Control signal of empty_pirq_outValue_o" {{0 1 empty_pirq_outValue_o_ap_vld R 0 "Control signal empty_pirq_outValue_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 full_pirq_outValue_i W 0x0 "Data signal of full_pirq_outValue_i" {{0 32 full_pirq_outValue_i W 0 "Bit 31 to 0 Data signal of full_pirq_outValue_i"}}} {0x38 full_pirq_outValue_o R 0x0 "Data signal of full_pirq_outValue_o" {{0 32 full_pirq_outValue_o R 0 "Bit 31 to 0 Data signal of full_pirq_outValue_o"}}} {0x3c full_pirq_outValue_o_ctrl R 0x0 "Control signal of full_pirq_outValue_o" {{0 1 full_pirq_outValue_o_ap_vld R 0 "Control signal full_pirq_outValue_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 ctrl_reg_outValue1_i W 0x0 "Data signal of ctrl_reg_outValue1_i" {{0 32 ctrl_reg_outValue1_i W 0 "Bit 31 to 0 Data signal of ctrl_reg_outValue1_i"}}} {0x48 ctrl_reg_outValue1_o R 0x0 "Data signal of ctrl_reg_outValue1_o" {{0 32 ctrl_reg_outValue1_o R 0 "Bit 31 to 0 Data signal of ctrl_reg_outValue1_o"}}} {0x4c ctrl_reg_outValue1_o_ctrl R 0x0 "Control signal of ctrl_reg_outValue1_o" {{0 1 ctrl_reg_outValue1_o_ap_vld R 0 "Control signal ctrl_reg_outValue1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 clearedInterrStatus1_i W 0x0 "Data signal of clearedInterrStatus1_i" {{0 32 clearedInterrStatus1_i W 0 "Bit 31 to 0 Data signal of clearedInterrStatus1_i"}}} {0x58 clearedInterrStatus1_o R 0x0 "Data signal of clearedInterrStatus1_o" {{0 32 clearedInterrStatus1_o R 0 "Bit 31 to 0 Data signal of clearedInterrStatus1_o"}}} {0x5c clearedInterrStatus1_o_ctrl R 0x0 "Control signal of clearedInterrStatus1_o" {{0 1 clearedInterrStatus1_o_ap_vld R 0 "Control signal clearedInterrStatus1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 rxFifoDepth1_i W 0x0 "Data signal of rxFifoDepth1_i" {{0 32 rxFifoDepth1_i W 0 "Bit 31 to 0 Data signal of rxFifoDepth1_i"}}} {0x68 rxFifoDepth1_o R 0x0 "Data signal of rxFifoDepth1_o" {{0 32 rxFifoDepth1_o R 0 "Bit 31 to 0 Data signal of rxFifoDepth1_o"}}} {0x6c rxFifoDepth1_o_ctrl R 0x0 "Control signal of rxFifoDepth1_o" {{0 1 rxFifoDepth1_o_ap_vld R 0 "Control signal rxFifoDepth1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 resetAxiEnabled R 0x0 "Data signal of resetAxiEnabled" {{0 32 resetAxiEnabled R 0 "Bit 31 to 0 Data signal of resetAxiEnabled"}}} {0x74 resetAxiEnabled_ctrl R 0x0 "Control signal of resetAxiEnabled" {{0 1 resetAxiEnabled_ap_vld R 0 "Control signal resetAxiEnabled_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 ctrl2RegState_enabled R 0x0 "Data signal of ctrl2RegState_enabled" {{0 32 ctrl2RegState_enabled R 0 "Bit 31 to 0 Data signal of ctrl2RegState_enabled"}}} {0x7c ctrl2RegState_enabled_ctrl R 0x0 "Control signal of ctrl2RegState_enabled" {{0 1 ctrl2RegState_enabled_ap_vld R 0 "Control signal ctrl2RegState_enabled_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 byteCountZero W 0x0 "Data signal of byteCountZero" {{0 32 byteCountZero W 0 "Bit 31 to 0 Data signal of byteCountZero"}}} {0x88 clearedInterruptStatus2 W 0x0 "Data signal of clearedInterruptStatus2" {{0 32 clearedInterruptStatus2 W 0 "Bit 31 to 0 Data signal of clearedInterruptStatus2"}}} {0x90 interrStatus2_i W 0x0 "Data signal of interrStatus2_i" {{0 32 interrStatus2_i W 0 "Bit 31 to 0 Data signal of interrStatus2_i"}}} {0x98 interrStatus2_o R 0x0 "Data signal of interrStatus2_o" {{0 32 interrStatus2_o R 0 "Bit 31 to 0 Data signal of interrStatus2_o"}}} {0x9c interrStatus2_o_ctrl R 0x0 "Control signal of interrStatus2_o" {{0 1 interrStatus2_o_ap_vld R 0 "Control signal interrStatus2_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 disableTxBitDirection R 0x0 "Data signal of disableTxBitDirection" {{0 32 disableTxBitDirection R 0 "Bit 31 to 0 Data signal of disableTxBitDirection"}}} {0xa4 disableTxBitDirection_ctrl R 0x0 "Control signal of disableTxBitDirection" {{0 1 disableTxBitDirection_ap_vld R 0 "Control signal disableTxBitDirection_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 pressByteCountEnabled R 0x0 "Data signal of pressByteCountEnabled" {{0 32 pressByteCountEnabled R 0 "Bit 31 to 0 Data signal of pressByteCountEnabled"}}} {0xac pressByteCountEnabled_ctrl R 0x0 "Control signal of pressByteCountEnabled" {{0 1 pressByteCountEnabled_ap_vld R 0 "Control signal pressByteCountEnabled_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 byteTracker R 0x0 "Data signal of byteTracker" {{0 32 byteTracker R 0 "Bit 31 to 0 Data signal of byteTracker"}}} {0xb4 byteTracker_ctrl R 0x0 "Control signal of byteTracker" {{0 1 byteTracker_ap_vld R 0 "Control signal byteTracker_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 interrStatus3StateEnabled R 0x0 "Data signal of interrStatus3StateEnabled" {{0 32 interrStatus3StateEnabled R 0 "Bit 31 to 0 Data signal of interrStatus3StateEnabled"}}} {0xbc interrStatus3StateEnabled_ctrl R 0x0 "Control signal of interrStatus3StateEnabled" {{0 1 interrStatus3StateEnabled_ap_vld R 0 "Control signal interrStatus3StateEnabled_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 checkInterrReg R 0x0 "Data signal of checkInterrReg" {{0 32 checkInterrReg R 0 "Bit 31 to 0 Data signal of checkInterrReg"}}} {0xc4 checkInterrReg_ctrl R 0x0 "Control signal of checkInterrReg" {{0 1 checkInterrReg_ap_vld R 0 "Control signal checkInterrReg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 ctrl_reg_val3_i W 0x0 "Data signal of ctrl_reg_val3_i" {{0 32 ctrl_reg_val3_i W 0 "Bit 31 to 0 Data signal of ctrl_reg_val3_i"}}} {0xd0 ctrl_reg_val3_o R 0x0 "Data signal of ctrl_reg_val3_o" {{0 32 ctrl_reg_val3_o R 0 "Bit 31 to 0 Data signal of ctrl_reg_val3_o"}}} {0xd4 ctrl_reg_val3_o_ctrl R 0x0 "Control signal of ctrl_reg_val3_o" {{0 1 ctrl_reg_val3_o_ap_vld R 0 "Control signal ctrl_reg_val3_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd8 lastByteRead_i W 0x0 "Data signal of lastByteRead_i" {{0 32 lastByteRead_i W 0 "Bit 31 to 0 Data signal of lastByteRead_i"}}} {0xe0 lastByteRead_o R 0x0 "Data signal of lastByteRead_o" {{0 32 lastByteRead_o R 0 "Bit 31 to 0 Data signal of lastByteRead_o"}}} {0xe4 lastByteRead_o_ctrl R 0x0 "Control signal of lastByteRead_o" {{0 1 lastByteRead_o_ap_vld R 0 "Control signal lastByteRead_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe8 rx_fifo_i W 0x0 "Data signal of rx_fifo_i" {{0 32 rx_fifo_i W 0 "Bit 31 to 0 Data signal of rx_fifo_i"}}} {0xf0 rx_fifo_o R 0x0 "Data signal of rx_fifo_o" {{0 32 rx_fifo_o R 0 "Bit 31 to 0 Data signal of rx_fifo_o"}}} {0xf4 rx_fifo_o_ctrl R 0x0 "Control signal of rx_fifo_o" {{0 1 rx_fifo_o_ap_vld R 0 "Control signal rx_fifo_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xf8 clearLatchedInterr_i W 0x0 "Data signal of clearLatchedInterr_i" {{0 32 clearLatchedInterr_i W 0 "Bit 31 to 0 Data signal of clearLatchedInterr_i"}}} {0x100 clearLatchedInterr_o R 0x0 "Data signal of clearLatchedInterr_o" {{0 32 clearLatchedInterr_o R 0 "Bit 31 to 0 Data signal of clearLatchedInterr_o"}}} {0x104 clearLatchedInterr_o_ctrl R 0x0 "Control signal of clearLatchedInterr_o" {{0 1 clearLatchedInterr_o_ap_vld R 0 "Control signal clearLatchedInterr_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x108 releaseBus R 0x0 "Data signal of releaseBus" {{0 32 releaseBus R 0 "Bit 31 to 0 Data signal of releaseBus"}}} {0x10c releaseBus_ctrl R 0x0 "Control signal of releaseBus" {{0 1 releaseBus_ap_vld R 0 "Control signal releaseBus_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x110 receivedSuccess_i W 0x0 "Data signal of receivedSuccess_i" {{0 32 receivedSuccess_i W 0 "Bit 31 to 0 Data signal of receivedSuccess_i"}}} {0x118 receivedSuccess_o R 0x0 "Data signal of receivedSuccess_o" {{0 32 receivedSuccess_o R 0 "Bit 31 to 0 Data signal of receivedSuccess_o"}}} {0x11c receivedSuccess_o_ctrl R 0x0 "Control signal of receivedSuccess_o" {{0 1 receivedSuccess_o_ap_vld R 0 "Control signal receivedSuccess_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x120 pressure_msb_i W 0x0 "Data signal of pressure_msb_i" {{0 32 pressure_msb_i W 0 "Bit 31 to 0 Data signal of pressure_msb_i"}}} {0x128 pressure_msb_o R 0x0 "Data signal of pressure_msb_o" {{0 32 pressure_msb_o R 0 "Bit 31 to 0 Data signal of pressure_msb_o"}}} {0x12c pressure_msb_o_ctrl R 0x0 "Control signal of pressure_msb_o" {{0 1 pressure_msb_o_ap_vld R 0 "Control signal pressure_msb_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x130 pressure_lsb_i W 0x0 "Data signal of pressure_lsb_i" {{0 32 pressure_lsb_i W 0 "Bit 31 to 0 Data signal of pressure_lsb_i"}}} {0x138 pressure_lsb_o R 0x0 "Data signal of pressure_lsb_o" {{0 32 pressure_lsb_o R 0 "Bit 31 to 0 Data signal of pressure_lsb_o"}}} {0x13c pressure_lsb_o_ctrl R 0x0 "Control signal of pressure_lsb_o" {{0 1 pressure_lsb_o_ap_vld R 0 "Control signal pressure_lsb_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x140 pressure_xlsb_i W 0x0 "Data signal of pressure_xlsb_i" {{0 32 pressure_xlsb_i W 0 "Bit 31 to 0 Data signal of pressure_xlsb_i"}}} {0x148 pressure_xlsb_o R 0x0 "Data signal of pressure_xlsb_o" {{0 32 pressure_xlsb_o R 0 "Bit 31 to 0 Data signal of pressure_xlsb_o"}}} {0x14c pressure_xlsb_o_ctrl R 0x0 "Control signal of pressure_xlsb_o" {{0 1 pressure_xlsb_o_ap_vld R 0 "Control signal pressure_xlsb_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x150 stat_reg_val6_state R 0x0 "Data signal of stat_reg_val6_state" {{0 32 stat_reg_val6_state R 0 "Bit 31 to 0 Data signal of stat_reg_val6_state"}}} {0x154 stat_reg_val6_state_ctrl R 0x0 "Control signal of stat_reg_val6_state" {{0 1 stat_reg_val6_state_ap_vld R 0 "Control signal stat_reg_val6_state_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x158 ctrl_reg_val2 R 0x0 "Data signal of ctrl_reg_val2" {{0 32 ctrl_reg_val2 R 0 "Bit 31 to 0 Data signal of ctrl_reg_val2"}}} {0x15c ctrl_reg_val2_ctrl R 0x0 "Control signal of ctrl_reg_val2" {{0 1 ctrl_reg_val2_ap_vld R 0 "Control signal ctrl_reg_val2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x160 ctrl2RegState R 0x0 "Data signal of ctrl2RegState" {{0 32 ctrl2RegState R 0 "Bit 31 to 0 Data signal of ctrl2RegState"}}} {0x164 ctrl2RegState_ctrl R 0x0 "Control signal of ctrl2RegState" {{0 1 ctrl2RegState_ap_vld R 0 "Control signal ctrl2RegState_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x168 ctrl_reg_check R 0x0 "Data signal of ctrl_reg_check" {{0 32 ctrl_reg_check R 0 "Bit 31 to 0 Data signal of ctrl_reg_check"}}} {0x16c ctrl_reg_check_ctrl R 0x0 "Control signal of ctrl_reg_check" {{0 1 ctrl_reg_check_ap_vld R 0 "Control signal ctrl_reg_check_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x170 zeroBytes W 0x0 "Data signal of zeroBytes" {{0 32 zeroBytes W 0 "Bit 31 to 0 Data signal of zeroBytes"}}} {0x178 interrStatus3State R 0x0 "Data signal of interrStatus3State" {{0 32 interrStatus3State R 0 "Bit 31 to 0 Data signal of interrStatus3State"}}} {0x17c interrStatus3State_ctrl R 0x0 "Control signal of interrStatus3State" {{0 1 interrStatus3State_ap_vld R 0 "Control signal interrStatus3State_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x180 interrStatus5State R 0x0 "Data signal of interrStatus5State" {{0 32 interrStatus5State R 0 "Bit 31 to 0 Data signal of interrStatus5State"}}} {0x184 interrStatus5State_ctrl R 0x0 "Control signal of interrStatus5State" {{0 1 interrStatus5State_ap_vld R 0 "Control signal interrStatus5State_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x188 tx_fifo_1 R 0x0 "Data signal of tx_fifo_1" {{0 32 tx_fifo_1 R 0 "Bit 31 to 0 Data signal of tx_fifo_1"}}} {0x18c tx_fifo_1_ctrl R 0x0 "Control signal of tx_fifo_1" {{0 1 tx_fifo_1_ap_vld R 0 "Control signal tx_fifo_1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x190 tx_fifo_2 R 0x0 "Data signal of tx_fifo_2" {{0 32 tx_fifo_2 R 0 "Bit 31 to 0 Data signal of tx_fifo_2"}}} {0x194 tx_fifo_2_ctrl R 0x0 "Control signal of tx_fifo_2" {{0 1 tx_fifo_2_ap_vld R 0 "Control signal tx_fifo_2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x198 interrStatus R 0x0 "Data signal of interrStatus" {{0 32 interrStatus R 0 "Bit 31 to 0 Data signal of interrStatus"}}} {0x19c interrStatus_ctrl R 0x0 "Control signal of interrStatus" {{0 1 interrStatus_ap_vld R 0 "Control signal interrStatus_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1a0 stat_reg_val R 0x0 "Data signal of stat_reg_val" {{0 32 stat_reg_val R 0 "Bit 31 to 0 Data signal of stat_reg_val"}}} {0x1a4 stat_reg_val_ctrl R 0x0 "Control signal of stat_reg_val" {{0 1 stat_reg_val_ap_vld R 0 "Control signal stat_reg_val_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1a8 statRegState R 0x0 "Data signal of statRegState" {{0 32 statRegState R 0 "Bit 31 to 0 Data signal of statRegState"}}} {0x1ac statRegState_ctrl R 0x0 "Control signal of statRegState" {{0 1 statRegState_ap_vld R 0 "Control signal statRegState_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1b0 clearInterrStatus R 0x0 "Data signal of clearInterrStatus" {{0 32 clearInterrStatus R 0 "Bit 31 to 0 Data signal of clearInterrStatus"}}} {0x1b4 clearInterrStatus_ctrl R 0x0 "Control signal of clearInterrStatus" {{0 1 clearInterrStatus_ap_vld R 0 "Control signal clearInterrStatus_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1b8 clearInterrStatusCheck R 0x0 "Data signal of clearInterrStatusCheck" {{0 32 clearInterrStatusCheck R 0 "Bit 31 to 0 Data signal of clearInterrStatusCheck"}}} {0x1bc clearInterrStatusCheck_ctrl R 0x0 "Control signal of clearInterrStatusCheck" {{0 1 clearInterrStatusCheck_ap_vld R 0 "Control signal clearInterrStatusCheck_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c0 error1 R 0x0 "Data signal of error1" {{0 32 error1 R 0 "Bit 31 to 0 Data signal of error1"}}} {0x1c4 error1_ctrl R 0x0 "Control signal of error1" {{0 1 error1_ap_vld R 0 "Control signal error1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c8 tx_fifo_3 R 0x0 "Data signal of tx_fifo_3" {{0 32 tx_fifo_3 R 0 "Bit 31 to 0 Data signal of tx_fifo_3"}}} {0x1cc tx_fifo_3_ctrl R 0x0 "Control signal of tx_fifo_3" {{0 1 tx_fifo_3_ap_vld R 0 "Control signal tx_fifo_3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1d0 interrStatus3 R 0x0 "Data signal of interrStatus3" {{0 32 interrStatus3 R 0 "Bit 31 to 0 Data signal of interrStatus3"}}} {0x1d4 interrStatus3_ctrl R 0x0 "Control signal of interrStatus3" {{0 1 interrStatus3_ap_vld R 0 "Control signal interrStatus3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
