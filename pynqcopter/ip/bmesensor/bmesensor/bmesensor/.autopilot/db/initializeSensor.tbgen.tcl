set moduleName initializeSensor
...
set C_modelName {initializeSensor}
set C_modelType { void 0 }
set C_modelArgList {
	{ iic2 int 32 regular {axi_master 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "iic2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "iic2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	initializeSensor {
		iic2 {Type O LastRead 13 FirstWrite 1}}}
