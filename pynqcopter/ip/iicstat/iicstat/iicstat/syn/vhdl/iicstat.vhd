...
architecture behav of iicstat is 
    ...
    component iicstat_bus_r_m_axi IS
    generic (
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                    if ((ap_sig_ioackin_bus_r_ARREADY = ap_const_logic_1)) then 
                        ap_reg_ioackin_bus_r_ARREADY <= ap_const_logic_0;
                    elsif ((bus_r_ARREADY = ap_const_logic_1)) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state8, bus_r_RVALID, ap_sig_ioackin_bus_r_ARREADY)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((ap_sig_ioackin_bus_r_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    bus_r_ARADDR <= ap_const_lv64_41(32 - 1 downto 0);

    bus_r_ARVALID_assign_proc : process(ap_CS_fsm_state1, ap_reg_ioackin_bus_r_ARREADY)
    begin
        if (((ap_reg_ioackin_bus_r_ARREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    bus_r_blk_n_AR_assign_proc : process(m_axi_bus_r_ARREADY, ap_CS_fsm_state1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
