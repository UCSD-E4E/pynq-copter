; ModuleID = '/home/iavendano/pynq-copter/pynqcopter/ip/iicstat/iicstat/iicstat/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@llvm_global_ctors_1 = appending global [0 x void ()*] zeroinitializer
@llvm_global_ctors_0 = appending global [0 x i32] zeroinitializer
@iicstat_str = internal unnamed_addr constant [8 x i8] c"iicstat\00"
...
@p_str2 = private unnamed_addr constant [4 x i8] c"off\00", align 1
@p_str1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@p_str = private unnamed_addr constant [6 x i8] c"m_axi\00", align 1

declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

define void @iicstat(i32* %bus_r, i32* %outValue) nounwind uwtable {
  ...
  %bus_addr_read = call i32 @_ssdm_op_Read.m_axi.volatile.i32P(i32* %bus_addr) nounwind
  call void @_ssdm_op_Write.s_axilite.volatile.i32P(i32* %outValue, i32 %bus_addr_read) nounwind
  ret void
}
...
!23 = metadata !{metadata !"bus", metadata !24, metadata !"int", i32 0, i32 31}
!24 = metadata !{metadata !25}
!25 = metadata !{i32 0, i32 63, i32 1}
