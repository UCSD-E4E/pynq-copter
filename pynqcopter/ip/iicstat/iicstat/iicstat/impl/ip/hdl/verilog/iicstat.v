...
iicstat_outValue_first_s_axi_U(
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state1)) begin
            if ((ap_sig_ioackin_bus_r_ARREADY == 1'b1)) begin
                ap_reg_ioackin_bus_r_ARREADY <= 1'b0;
            end else if ((bus_r_ARREADY == 1'b1)) begin
...
always @ (*) begin
    if (((ap_reg_ioackin_bus_r_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state1))) begin
        bus_r_ARVALID = 1'b1;
    end else begin
        bus_r_ARVALID = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((ap_sig_ioackin_bus_r_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
