...
(* CORE_GENERATION_INFO="iiccomm2,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=38,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=1036,HLS_SYN_LUT=1516}" *)
...
reg   [31:0] iic_V_addr_read_reg_259;
reg    ap_sig_ioackin_iic_V_WREADY;
reg    ap_sig_ioackin_iic_V_AWREADY;
reg    ap_block_state10_io;
reg   [31:0] iic_V_addr_2_read_reg_276;
reg   [31:0] iic_V_addr_4_read_reg_296;
...
reg    ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack;
...
#0 ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state10)) begin
            if ((1'b0 == ap_block_state10_io)) begin
                ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack <= 1'b0;
            end else if ((1'b1 == 1'b1)) begin
                ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack <= 1'b1;
            end
        end
    end
end
...
always @ (*) begin
    if ((((ap_reg_ioackin_iic_V_AWREADY == 1'b0) & (iic_V_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state24)) | ((ap_reg_ioackin_iic_V_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state10)) | ((ap_reg_ioackin_iic_V_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state9)))) begin
        iic_V_AWVALID = 1'b1;
    end else begin
        iic_V_AWVALID = 1'b0;
    end
...
always @ (*) begin
    if (((ap_reg_ioackin_tx_fifo_outValue_V_dummy_ack == 1'b0) & (1'b1 == ap_CS_fsm_state10))) begin
        tx_fifo_outValue_V_ap_vld = 1'b1;
    end else begin
        tx_fifo_outValue_V_ap_vld = 1'b0;
    end
end
