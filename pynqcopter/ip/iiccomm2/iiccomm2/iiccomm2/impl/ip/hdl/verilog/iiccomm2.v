...
(* CORE_GENERATION_INFO="iiccomm2,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=500000075,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=1150,HLS_SYN_LUT=1690}" *)
...
reg   [31:0] iic_addr_1_read_reg_849;
reg   [31:0] iic_addr34_read_reg_854;
reg   [31:0] iic_addr_13_read_reg_869;
reg   [31:0] iic_addr_15_read_reg_874;
wire   [28:0] ctr_V_fu_829_p2;
reg    ap_block_state56_io;
reg   [31:0] iic_addr_65_read_reg_902;
reg   [31:0] iic_addr_67_read_reg_907;
reg   [31:0] iic_addr_69_read_reg_912;
reg   [28:0] p_014_0_i_reg_642;
...
iiccomm2_AXILiteS_s_axi_U(
    ...
    .ap_done(ap_done),
    .ap_idle(ap_idle),
    .empty_pirq_outValue(iic_addr_1_read_reg_849),
    .empty_pirq_outValue_ap_vld(empty_pirq_outValue_ap_vld),
    .full_pirq_outValue(iic_addr34_read_reg_854),
    .full_pirq_outValue_ap_vld(full_pirq_outValue_ap_vld),
    .ctrl_reg_outValue(iic_addr_13_read_reg_869),
    .ctrl_reg_outValue_ap_vld(ctrl_reg_outValue_ap_vld),
    .stat_reg_outValue1(iic_addr_15_read_reg_874),
    .stat_reg_outValue1_ap_vld(stat_reg_outValue1_ap_vld),
    .pressure_msb(iic_addr_65_read_reg_902),
    .pressure_msb_ap_vld(pressure_msb_ap_vld),
    .pressure_lsb(iic_addr_67_read_reg_907),
    .pressure_lsb_ap_vld(pressure_lsb_ap_vld),
    .pressure_xlsb(iic_addr_69_read_reg_912),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((~((ap_start == 1'b0) | (ap_sig_ioackin_iic_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state68)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state67)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state66)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state31)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state30)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state15)))) begin
            ap_reg_ioackin_iic_ARREADY <= 1'b0;
        end else if ((((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (iic_ARREADY == 1'b1)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state68)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state67)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state66)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state31)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state30)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state15)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((1'b0 == ap_block_state59_io) & (1'b1 == ap_CS_fsm_state59)) | ((1'b0 == ap_block_state58_io) & (1'b1 == ap_CS_fsm_state58)) | ((1'b1 == ap_CS_fsm_state57) & (1'b0 == ap_block_state57_io)) | ((1'b0 == ap_block_state56_io) & (tmp_fu_823_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state56)) | (~((1'b1 == ap_block_state49_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state49)) | (~((1'b1 == ap_block_state48_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state48)) | ((1'b0 == ap_block_state43_io) & (1'b1 == ap_CS_fsm_state43)) | (~((1'b1 == ap_block_state47_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state47)) | ((1'b0 == ap_block_state42_io) & (1'b1 == ap_CS_fsm_state42)) | (~((1'b1 == ap_block_state46_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state46)) | ((1'b0 == ap_block_state41_io) & (1'b1 == ap_CS_fsm_state41)) | (~((1'b1 == ap_block_state45_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state45)) | ((1'b0 == ap_block_state40_io) & (1'b1 == ap_CS_fsm_state40)) | (~((1'b1 == ap_block_state44_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state44)) | ((1'b0 == ap_block_state39_io) & (1'b1 == ap_CS_fsm_state39)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state38)) | ((1'b0 == ap_block_state23_io) & (1'b1 == ap_CS_fsm_state23)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state22)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8)))) begin
            ap_reg_ioackin_iic_AWREADY <= 1'b0;
        end else if ((((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state59)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state58)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state57)) | ((tmp_fu_823_p2 == 1'd1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state56)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state49)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state48)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state43)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state47)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state42)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state46)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state41)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state45)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state40)) | ((iic_BVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state44)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state39)) | ((iic_RVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state38)) | ((iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state23)) | ((iic_RVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state22)) | ((iic_RVALID == 1'b1) & (iic_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state8)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((ap_sig_ioackin_iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state60)) | ((1'b0 == ap_block_state59_io) & (1'b1 == ap_CS_fsm_state59)) | ((1'b0 == ap_block_state58_io) & (1'b1 == ap_CS_fsm_state58)) | ((1'b1 == ap_CS_fsm_state57) & (1'b0 == ap_block_state57_io)) | (~((ap_sig_ioackin_iic_WREADY == 1'b0) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state50)) | (~((1'b1 == ap_block_state49_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state49)) | (~((1'b1 == ap_block_state48_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state48)) | ((1'b0 == ap_block_state43_io) & (1'b1 == ap_CS_fsm_state43)) | (~((1'b1 == ap_block_state47_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state47)) | ((1'b0 == ap_block_state42_io) & (1'b1 == ap_CS_fsm_state42)) | (~((1'b1 == ap_block_state46_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state46)) | ((1'b0 == ap_block_state41_io) & (1'b1 == ap_CS_fsm_state41)) | (~((1'b1 == ap_block_state45_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state45)) | ((1'b0 == ap_block_state40_io) & (1'b1 == ap_CS_fsm_state40)) | (~((1'b1 == ap_block_state44_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state44)) | ((1'b0 == ap_block_state39_io) & (1'b1 == ap_CS_fsm_state39)) | ((ap_sig_ioackin_iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state24)) | ((1'b0 == ap_block_state23_io) & (1'b1 == ap_CS_fsm_state23)) | ((ap_sig_ioackin_iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state9)))) begin
            ap_reg_ioackin_iic_WREADY <= 1'b0;
        end else if ((((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state60)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state59)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state58)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state57)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state50)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state49)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state48)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state43)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state47)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state42)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state46)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state41)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state45)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state40)) | ((iic_BVALID == 1'b1) & (iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state44)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state39)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state24)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state23)) | ((iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state9)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state56_io) & (tmp_fu_823_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state56))) begin
        p_014_0_i_reg_642 <= ctr_V_fu_829_p2;
    end else if (((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state55))) begin
        p_014_0_i_reg_642 <= 29'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state22))) begin
        iic_addr34_read_reg_854 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state37))) begin
        iic_addr_13_read_reg_869 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state38))) begin
        iic_addr_15_read_reg_874 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8))) begin
        iic_addr_1_read_reg_849 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state73))) begin
        iic_addr_65_read_reg_902 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state74))) begin
        iic_addr_67_read_reg_907 <= iic_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state75))) begin
        iic_addr_69_read_reg_912 <= iic_RDATA;
    end
end
...
always @ (*) begin
    if ((((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state68)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state67)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state66)))) begin
    ...
    end else if ((((ap_start == 1'b1) & (ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state15)))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b1) & (ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state68)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state67)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state66)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state31)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state30)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state15)))) begin
        iic_ARVALID = 1'b1;
    end else begin
        iic_ARVALID = 1'b0;
    end
...
always @ (*) begin
    if ((((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state59)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state58)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state49)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state48)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state43)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state47)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state42)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state46)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state41)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state45)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state40)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state44)))) begin
        iic_AWADDR = grp_fu_741_p2;
    end else if ((((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state57)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state39)))) begin
        iic_AWADDR = grp_fu_719_p2;
    end else if ((((tmp_fu_823_p2 == 1'd1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state56)) | ((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state38)))) begin
        iic_AWADDR = 64'd268436546;
    end else if (((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state23))) begin
        iic_AWADDR = grp_fu_677_p2;
    end else if (((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state22))) begin
        iic_AWADDR = 64'd268436544;
    end else if (((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    if ((((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state59)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state58)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state57)) | ((tmp_fu_823_p2 == 1'd1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state56)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state49)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state48)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state43)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state47)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state42)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state46)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state41)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state45)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state40)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state44)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state39)) | ((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state38)) | ((ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state23)) | ((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state22)) | ((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state8)))) begin
        iic_AWVALID = 1'b1;
    end else begin
        iic_AWVALID = 1'b0;
    end
...
always @ (*) begin
    if ((((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state65)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state64)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state63)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state62)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state55)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state54)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state53)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state52)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state51)) | (~((ap_sig_ioackin_iic_WREADY == 1'b0) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state50)) | (~((1'b1 == ap_block_state49_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state49)) | (~((1'b1 == ap_block_state48_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state48)) | (~((1'b1 == ap_block_state47_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state47)) | (~((1'b1 == ap_block_state46_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state46)) | (~((1'b1 == ap_block_state45_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state45)) | (~((1'b1 == ap_block_state44_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state44)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state29)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state28)) | ((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state14)))) begin
        iic_BREADY = 1'b1;
    end else begin
        iic_BREADY = 1'b0;
    end
...
always @ (*) begin
    if ((((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state75)) | ((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state74)) | ((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state73)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state38)) | ((iic_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state37)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state22)) | (~((ap_sig_ioackin_iic_AWREADY == 1'b0) | (iic_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8)))) begin
        iic_RREADY = 1'b1;
    end else begin
        iic_RREADY = 1'b0;
    end
...
always @ (*) begin
    if (((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state60))) begin
        iic_WDATA = 32'd515;
    end else if (((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state59))) begin
        iic_WDATA = 32'd237;
    end else if (((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state58))) begin
        iic_WDATA = 32'd247;
    end else if (((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state50))) begin
        iic_WDATA = 32'd160;
    end else if (((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state49))) begin
        iic_WDATA = 32'd245;
    end else if (((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state47))) begin
        iic_WDATA = 32'd39;
    end else if (((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state46))) begin
        iic_WDATA = 32'd244;
    end else if (((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state44))) begin
        iic_WDATA = 32'd0;
        ...
        iic_WDATA = 32'd224;
    end else if ((((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state57)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state48)) | ((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state42)) | ((iic_BVALID == 1'b1) & (ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state45)) | ((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state39)))) begin
        iic_WDATA = 32'd492;
    end else if (((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state24))) begin
        iic_WDATA = 32'd1;
    end else if (((ap_reg_ioackin_iic_WREADY == 1'b0) & (1'b1 == ap_CS_fsm_state23))) begin
        iic_WDATA = 32'd2;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state68) | (1'b1 == ap_CS_fsm_state67) | (1'b1 == ap_CS_fsm_state66) | (1'b1 == ap_CS_fsm_state31) | (1'b1 == ap_CS_fsm_state30) | (1'b1 == ap_CS_fsm_state15) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state65) | (1'b1 == ap_CS_fsm_state64) | (1'b1 == ap_CS_fsm_state63) | (1'b1 == ap_CS_fsm_state62) | (1'b1 == ap_CS_fsm_state55) | (1'b1 == ap_CS_fsm_state54) | (1'b1 == ap_CS_fsm_state53) | (1'b1 == ap_CS_fsm_state52) | (1'b1 == ap_CS_fsm_state51) | (1'b1 == ap_CS_fsm_state50) | (1'b1 == ap_CS_fsm_state49) | (1'b1 == ap_CS_fsm_state48) | (1'b1 == ap_CS_fsm_state47) | (1'b1 == ap_CS_fsm_state46) | (1'b1 == ap_CS_fsm_state45) | (1'b1 == ap_CS_fsm_state44) | (1'b1 == ap_CS_fsm_state29) | (1'b1 == ap_CS_fsm_state28) | (1'b1 == ap_CS_fsm_state14))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state75) | (1'b1 == ap_CS_fsm_state74) | (1'b1 == ap_CS_fsm_state73) | (1'b1 == ap_CS_fsm_state38) | (1'b1 == ap_CS_fsm_state37) | (1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state60) | (1'b1 == ap_CS_fsm_state59) | (1'b1 == ap_CS_fsm_state58) | (1'b1 == ap_CS_fsm_state57) | (1'b1 == ap_CS_fsm_state50) | (1'b1 == ap_CS_fsm_state49) | (1'b1 == ap_CS_fsm_state48) | (1'b1 == ap_CS_fsm_state43) | (1'b1 == ap_CS_fsm_state47) | (1'b1 == ap_CS_fsm_state42) | (1'b1 == ap_CS_fsm_state46) | (1'b1 == ap_CS_fsm_state41) | (1'b1 == ap_CS_fsm_state45) | (1'b1 == ap_CS_fsm_state40) | (1'b1 == ap_CS_fsm_state44) | (1'b1 == ap_CS_fsm_state39) | (1'b1 == ap_CS_fsm_state24) | (1'b1 == ap_CS_fsm_state23) | (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state9 : begin
            if (((ap_sig_ioackin_iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        ap_ST_fsm_state14 : begin
            if (((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        ap_ST_fsm_state15 : begin
            if (((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state15))) begin
        ...
        ap_ST_fsm_state28 : begin
            if (((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state28))) begin
        ...
        ap_ST_fsm_state44 : begin
            if ((~((1'b1 == ap_block_state44_io) | (iic_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state44))) begin
        ...
        ap_ST_fsm_state51 : begin
            if (((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state51))) begin
        ...
        ap_ST_fsm_state56 : begin
            if (((1'b0 == ap_block_state56_io) & (tmp_fu_823_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state56))) begin
                ap_NS_fsm = ap_ST_fsm_state56;
            end else if (((1'b0 == ap_block_state56_io) & (tmp_fu_823_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state56))) begin
        ...
        ap_ST_fsm_state57 : begin
            if (((1'b1 == ap_CS_fsm_state57) & (1'b0 == ap_block_state57_io))) begin
        ...
        ap_ST_fsm_state60 : begin
            if (((ap_sig_ioackin_iic_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state60))) begin
        ...
        ap_ST_fsm_state62 : begin
            if (((iic_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state62))) begin
        ...
        ap_ST_fsm_state66 : begin
            if (((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state66))) begin
        ...
        ap_ST_fsm_state68 : begin
            if (((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state68))) begin
...
always @ (*) begin
    ap_block_state56_io = ((tmp_fu_823_p2 == 1'd1) & (ap_sig_ioackin_iic_AWREADY == 1'b0));
end

always @ (*) begin
    ap_block_state57_io = ((ap_sig_ioackin_iic_AWREADY == 1'b0) | (ap_sig_ioackin_iic_WREADY == 1'b0));
end
...
assign ctr_V_fu_829_p2 = (p_014_0_i_reg_642 + 29'd1);

assign grp_fu_677_p2 = 64'd268436544;

assign grp_fu_719_p2 = 64'd268436546;

assign grp_fu_741_p2 = 64'd268436546;

assign tmp_fu_823_p2 = ((p_014_0_i_reg_642 == 29'd500000000) ? 1'b1 : 1'b0);
