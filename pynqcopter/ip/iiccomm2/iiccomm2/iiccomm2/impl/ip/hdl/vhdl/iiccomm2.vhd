...
entity iiccomm2 is
generic (
    C_M_AXI_BUS_R_ADDR_WIDTH : INTEGER := 32;
    C_M_AXI_BUS_R_ID_WIDTH : INTEGER := 1;
    C_M_AXI_BUS_R_AWUSER_WIDTH : INTEGER := 1;
    C_M_AXI_BUS_R_DATA_WIDTH : INTEGER := 32;
    C_M_AXI_BUS_R_WUSER_WIDTH : INTEGER := 1;
    ...
    C_M_AXI_BUS_R_USER_VALUE : INTEGER := 0;
    C_M_AXI_BUS_R_PROT_VALUE : INTEGER := 0;
    C_M_AXI_BUS_R_CACHE_VALUE : INTEGER := 3 );
port (
    ap_clk : IN STD_LOGIC;
    ap_rst_n : IN STD_LOGIC;
    m_axi_bus_r_AWVALID : OUT STD_LOGIC;
    m_axi_bus_r_AWREADY : IN STD_LOGIC;
    m_axi_bus_r_AWADDR : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ADDR_WIDTH-1 downto 0);
    m_axi_bus_r_AWID : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ID_WIDTH-1 downto 0);
    ...
    m_axi_bus_r_AWUSER : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_AWUSER_WIDTH-1 downto 0);
    m_axi_bus_r_WVALID : OUT STD_LOGIC;
    m_axi_bus_r_WREADY : IN STD_LOGIC;
    m_axi_bus_r_WDATA : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_DATA_WIDTH-1 downto 0);
    m_axi_bus_r_WSTRB : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_DATA_WIDTH/8-1 downto 0);
    m_axi_bus_r_WLAST : OUT STD_LOGIC;
    m_axi_bus_r_WID : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ID_WIDTH-1 downto 0);
    m_axi_bus_r_WUSER : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_WUSER_WIDTH-1 downto 0);
    m_axi_bus_r_ARVALID : OUT STD_LOGIC;
    m_axi_bus_r_ARREADY : IN STD_LOGIC;
    m_axi_bus_r_ARADDR : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ADDR_WIDTH-1 downto 0);
    m_axi_bus_r_ARID : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ID_WIDTH-1 downto 0);
    ...
    m_axi_bus_r_ARUSER : OUT STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ARUSER_WIDTH-1 downto 0);
    m_axi_bus_r_RVALID : IN STD_LOGIC;
    m_axi_bus_r_RREADY : OUT STD_LOGIC;
    m_axi_bus_r_RDATA : IN STD_LOGIC_VECTOR (C_M_AXI_BUS_R_DATA_WIDTH-1 downto 0);
    m_axi_bus_r_RLAST : IN STD_LOGIC;
    m_axi_bus_r_RID : IN STD_LOGIC_VECTOR (C_M_AXI_BUS_R_ID_WIDTH-1 downto 0);
    m_axi_bus_r_RUSER : IN STD_LOGIC_VECTOR (C_M_AXI_BUS_R_RUSER_WIDTH-1 downto 0);
    ...
    s_axi_outValue_first_WDATA : IN STD_LOGIC_VECTOR (C_S_AXI_OUTVALUE_FIRST_DATA_WIDTH-1 downto 0);
    s_axi_outValue_first_WSTRB : IN STD_LOGIC_VECTOR (C_S_AXI_OUTVALUE_FIRST_DATA_WIDTH/8-1 downto 0);
    s_axi_outValue_first_ARVALID : IN STD_LOGIC;
    s_axi_outValue_first_ARREADY : OUT STD_LOGIC;
    s_axi_outValue_first_ARADDR : IN STD_LOGIC_VECTOR (C_S_AXI_OUTVALUE_FIRST_ADDR_WIDTH-1 downto 0);
    s_axi_outValue_first_RVALID : OUT STD_LOGIC;
    s_axi_outValue_first_RREADY : IN STD_LOGIC;
    s_axi_outValue_first_RDATA : OUT STD_LOGIC_VECTOR (C_S_AXI_OUTVALUE_FIRST_DATA_WIDTH-1 downto 0);
...
architecture behav of iiccomm2 is 
    ...
    "iiccomm2,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=8,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=658,HLS_SYN_LUT=798}";
    ...
    constant ap_const_lv64_40003104 : STD_LOGIC_VECTOR (63 downto 0) := "0000000000000000000000000000000001000000000000000011000100000100";
    ...
    signal bus_r_blk_n_R : STD_LOGIC;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal bus_r_AWREADY : STD_LOGIC;
    signal bus_r_WREADY : STD_LOGIC;
    signal bus_r_ARVALID : STD_LOGIC;
    signal bus_r_ARREADY : STD_LOGIC;
    signal bus_r_ARADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal bus_r_RVALID : STD_LOGIC;
    signal bus_r_RREADY : STD_LOGIC;
    signal bus_r_RDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal bus_r_RLAST : STD_LOGIC;
    signal bus_r_RID : STD_LOGIC_VECTOR (0 downto 0);
    signal bus_r_RUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal bus_r_RRESP : STD_LOGIC_VECTOR (1 downto 0);
    signal bus_r_BVALID : STD_LOGIC;
    signal bus_r_BRESP : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component iiccomm2_outValue_first_s_axi IS
    generic (
        C_S_AXI_ADDR_WIDTH : INTEGER;
        C_S_AXI_DATA_WIDTH : INTEGER );
    port (
    ...
    component iiccomm2_bus_r_m_axi IS
    generic (
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    ...
    iiccomm2_outValue_first_s_axi_U : component iiccomm2_outValue_first_s_axi
    generic map (
    ...
    iiccomm2_bus_r_m_axi_U : component iiccomm2_bus_r_m_axi
    generic map (
        USER_DW => 32,
        USER_AW => 32,
        USER_MAXREQS => 5,
    ...
    ap_reg_ioackin_bus_r_ARREADY_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                    if (not(((ap_sig_ioackin_bus_r_ARREADY = ap_const_logic_0) or (ap_start = ap_const_logic_0)))) then 
                        ap_reg_ioackin_bus_r_ARREADY <= ap_const_logic_0;
                    elsif (((bus_r_ARREADY = ap_const_logic_1) and (ap_start = ap_const_logic_1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state8, bus_r_RVALID, ap_sig_ioackin_bus_r_ARREADY)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_sig_ioackin_bus_r_ARREADY = ap_const_logic_0) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    ap_sig_ioackin_bus_r_ARREADY_assign_proc : process(bus_r_ARREADY, ap_reg_ioackin_bus_r_ARREADY)
    begin
        if ((ap_reg_ioackin_bus_r_ARREADY = ap_const_logic_0)) then 
    ...
    bus_r_ARADDR <= ap_const_lv64_40003104(32 - 1 downto 0);

    bus_r_ARVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_reg_ioackin_bus_r_ARREADY)
    begin
        if (((ap_reg_ioackin_bus_r_ARREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    bus_r_blk_n_AR_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_bus_r_ARREADY)
    begin
    ...
    bus_r_blk_n_R_assign_proc : process(m_axi_bus_r_RVALID, ap_CS_fsm_state8)
    begin
