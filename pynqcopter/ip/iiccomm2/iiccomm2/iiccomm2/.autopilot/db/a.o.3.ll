...
; [#uses=0]
define void @iiccomm2(i32* %bus, i32* %outValue) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %bus}, i64 0, metadata !28), !dbg !39 ; [debug line = 44:25] [debug variable = bus]
  call void @llvm.dbg.value(metadata !{i32* %outValue}, i64 0, metadata !40), !dbg !41 ; [debug line = 44:40] [debug variable = outValue]
  ...
  %bus_addr = getelementptr inbounds i32* %bus, i64 1073754372, !dbg !46 ; [#uses=2 type=i32*] [debug line = 53:2]
...
!29 = metadata !{i32 786478, i32 0, metadata !30, metadata !"iiccomm2", metadata !"iiccomm2", metadata !"_Z8iiccomm2PjRj", metadata !30, i32 44, metadata !31, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @iiccomm2, null, null, metadata !37, i32 45} ; [ DW_TAG_subprogram ]
!30 = metadata !{i32 786473, metadata !"iiccomm2.cpp", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm2", null} ; [ DW_TAG_file_type ]
...
!39 = metadata !{i32 44, i32 25, metadata !29, null}
...
!41 = metadata !{i32 44, i32 40, metadata !29, null}
