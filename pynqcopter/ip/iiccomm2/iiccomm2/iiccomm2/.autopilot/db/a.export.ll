...
"delay_until_ms<10000ull, 50000000ull>.exit":     ; preds = %1
  ...
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %iic_addr_59, i32 237, i4 -1)
  ...
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %pressure_msb, i32 %iic_addr_65_read)
  ...
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %pressure_lsb, i32 %iic_addr_67_read)
  %iic_addr_68 = getelementptr i32* %iic, i64 268436547
  %iic_load_6_req = call i1 @_ssdm_op_ReadReq.m_axi.i32P(i32* %iic_addr_68, i32 1)
  %iic_addr_69 = getelementptr i32* %iic, i64 268436547
  %iic_addr_69_read = call i32 @_ssdm_op_Read.m_axi.volatile.i32P(i32* %iic_addr_69)
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %pressure_xlsb, i32 %iic_addr_69_read)
  ret void
}
