; ModuleID = '/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm2/iiccomm2/iiccomm2/.autopilot/db/a.o.2.bc'
...
@iiccomm2_str = internal unnamed_addr constant [9 x i8] c"iiccomm2\00"
...
define void @iiccomm2(i32* %iic, i32* %empty_pirq_outValue, i32* %full_pirq_outValue, i32* %ctrl_reg_outValue, i32* %stat_reg_outValue1, i32* %stat_reg_val2, i32* %pressure_msb, i32* %pressure_lsb, i32* %pressure_xlsb, i32* %temp_msb, i32* %temp_lsb, i32* %temp_xlsb, i32* %press_raw, i32* %temp_raw, i32* %operation, i32* %press_cal, i32* %press_act) {
...
; <label>:2                                       ; preds = %3, %1
  ...
  %empty_30 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2500000, i64 2500000, i64 2500000) nounwind
...
; <label>:4                                       ; preds = %5, %"delay_until_ms<50ull, 50000000ull>.exit"
  %p_014_0_i9 = phi i19 [ 0, %"delay_until_ms<50ull, 50000000ull>.exit" ], [ %ctr_V_1, %5 ]
  %tmp_4 = icmp eq i19 %p_014_0_i9, -24288
  %empty_31 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 500000, i64 500000, i64 500000) nounwind
...
; <label>:8                                       ; preds = %9, %7
  ...
  %tmp_44 = icmp eq i19 %p_014_0_i5, -24288
  %empty_32 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 500000, i64 500000, i64 500000) nounwind
...
; <label>:10                                      ; preds = %6
  ...
  %tmp_60 = call i47 @_ssdm_op_PartSelect.i47.i62.i32.i32(i62 %tmp_38, i32 15, i32 61)
  %var3_1 = sext i47 %tmp_60 to i64
  %var3_1_cast4 = sext i47 %tmp_60 to i63
  %tmp_39_cast = zext i32 %tmp_8 to i33
  %tmp_40 = sub i33 1048576, %tmp_39_cast
  %tmp_40_cast_cast = sext i33 %tmp_40 to i52
  %tmp_61 = call i51 @_ssdm_op_PartSelect.i51.i63.i32.i32(i63 %var4_2, i32 12, i32 62)
  %tmp_41_cast_cast = sext i51 %tmp_61 to i52
  ...
  %tmp_62 = call i32 @_ssdm_op_PartSelect.i32.i63.i32.i32(i63 %pressure, i32 31, i32 62)
  %icmp = icmp eq i32 %tmp_62, 0
...
; <label>:12                                      ; preds = %10
  %tmp_46 = udiv i63 %pressure, %var3_1_cast4
...
; <label>:13                                      ; preds = %12, %11
  ...
  %tmp_63 = trunc i64 %pressure3 to i32
  %tmp_64 = call i32 @_ssdm_op_PartSelect.i32.i36.i32.i32(i36 %tmp_54, i32 4, i32 35)
  %tmp_56 = add i32 %tmp_64, %tmp_63
  ...
  %tmp_i_i_i_i_cast4 = zext i11 %loc_V to i12
  %sh_assign = add i12 -1023, %tmp_i_i_i_i_cast4
  %isNeg = call i1 @_ssdm_op_BitSelect.i1.i12.i32(i12 %sh_assign, i32 11)
  %tmp_60_i_i_i = sub i11 1023, %loc_V
  %tmp_60_i_i_i_cast = sext i11 %tmp_60_i_i_i to i12
  %sh_assign_1 = select i1 %isNeg, i12 %tmp_60_i_i_i_cast, i12 %sh_assign
  %sh_assign_1_cast = sext i12 %sh_assign_1 to i32
  %tmp_61_i_i_i = zext i32 %sh_assign_1_cast to i137
  %tmp_61_i_i_i_cast = zext i32 %sh_assign_1_cast to i54
  %tmp_62_i_i_i = lshr i54 %tmp_i_i_i, %tmp_61_i_i_i_cast
  %tmp_64_i_i_i = shl i137 %tmp_i_i_i_cast, %tmp_61_i_i_i
  %tmp_67 = call i1 @_ssdm_op_BitSelect.i1.i54.i32(i54 %tmp_62_i_i_i, i32 53)
  %tmp_65 = zext i1 %tmp_67 to i32
  %tmp_66 = call i32 @_ssdm_op_PartSelect.i32.i137.i32.i32(i137 %tmp_64_i_i_i, i32 53, i32 84)
  %p_Val2_3 = select i1 %isNeg, i32 %tmp_65, i32 %tmp_66
...
entry:
  ...
  %empty_33 = trunc i64 %empty to i63
  ret i63 %empty_33
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_34 = trunc i64 %empty to i62
  ret i62 %empty_34
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_35 = trunc i64 %empty to i61
  ret i61 %empty_35
}
...
entry:
  ...
  %empty_36 = trunc i63 %empty to i60
  ret i60 %empty_36
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_37 = trunc i64 %empty to i53
  ret i53 %empty_37
}
...
entry:
  ...
  %empty_38 = trunc i54 %empty to i52
  ret i52 %empty_38
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_39 = trunc i64 %empty to i51
  ret i51 %empty_39
}
...
entry:
  %empty = call i63 @llvm.part.select.i63(i63 %0, i32 %1, i32 %2)
  %empty_40 = trunc i63 %empty to i51
  ret i51 %empty_40
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_41 = trunc i64 %empty to i49
  ret i49 %empty_41
}
...
entry:
  ...
  %empty_42 = trunc i61 %empty to i48
  ret i48 %empty_42
}
...
entry:
  ...
  %empty_43 = trunc i62 %empty to i47
  ret i47 %empty_43
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_44 = trunc i64 %empty to i46
  ret i46 %empty_44
}
...
entry:
  ...
  %empty_45 = trunc i57 %empty to i45
  ret i45 %empty_45
}
...
entry:
  ...
  %empty_46 = trunc i45 %empty to i44
  ret i44 %empty_46
}
...
entry:
  ...
  %empty_47 = trunc i32 %empty to i4
  ret i4 %empty_47
}
...
entry:
  ...
  %empty_48 = trunc i51 %empty to i37
  ret i37 %empty_48
}
...
entry:
  ...
  %empty_49 = trunc i49 %empty to i36
  ret i36 %empty_49
}
...
entry:
  ...
  %empty_50 = trunc i48 %empty to i36
  ret i36 %empty_50
}
...
entry:
  %empty = call i45 @llvm.part.select.i45(i45 %0, i32 %1, i32 %2)
  %empty_51 = trunc i45 %empty to i34
  ret i34 %empty_51
}
...
entry:
  %empty = call i63 @llvm.part.select.i63(i63 %0, i32 %1, i32 %2)
  %empty_52 = trunc i63 %empty to i32
  ret i32 %empty_52
}
...
entry:
  ...
  %empty_53 = trunc i36 %empty to i32
  ret i32 %empty_53
}
...
entry:
  ...
  %empty_54 = trunc i137 %empty to i32
  ret i32 %empty_54
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_55 = trunc i32 %empty to i29
  ret i29 %empty_55
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_56 = trunc i32 %empty to i28
  ret i28 %empty_56
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2)
  %empty_57 = trunc i64 %empty to i11
  ret i11 %empty_57
}
...
entry:
  ...
  %empty_58 = shl i54 1, %empty
  %empty_59 = and i54 %0, %empty_58
  %empty_60 = icmp ne i54 %empty_59, 0
  ret i1 %empty_60
}
...
entry:
  %empty = shl i32 1, %1
  %empty_61 = and i32 %0, %empty
  %empty_62 = icmp ne i32 %empty_61, 0
  ret i1 %empty_62
}
...
entry:
  ...
  %empty_66 = zext i6 %1 to i7
  %empty_67 = shl i7 %empty, 6
  %empty_68 = or i7 %empty_67, %empty_66
  ret i7 %empty_68
}
...
entry:
  ...
  %empty_69 = zext i1 %1 to i64
  %empty_70 = shl i64 %empty, 1
...
entry:
  ...
  %empty_72 = zext i1 %2 to i53
  %empty_73 = shl i53 %empty, 1
  %empty_74 = or i53 %empty_73, %empty_72
  %empty_75 = zext i1 %0 to i54
  %empty_76 = zext i53 %empty_74 to i54
  %empty_77 = shl i54 %empty_75, 53
  %empty_78 = or i54 %empty_77, %empty_76
  ret i54 %empty_78
}
...
entry:
  ...
  %empty_79 = zext i28 %1 to i32
  %empty_80 = shl i32 %empty, 28
...
entry:
  ...
  %empty_82 = zext i12 %1 to i28
  %empty_83 = shl i28 %empty, 12
  %empty_84 = or i28 %empty_83, %empty_82
  ret i28 %empty_84
}
...
!1 = metadata !{metadata !"kernel_arg_addr_space", i32 1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0}
!2 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none"}
!3 = metadata !{metadata !"kernel_arg_type", metadata !"uint32_t*", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &", metadata !"uint32_t &"}
!4 = metadata !{metadata !"kernel_arg_type_qual", metadata !"volatile", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !"", metadata !""}
