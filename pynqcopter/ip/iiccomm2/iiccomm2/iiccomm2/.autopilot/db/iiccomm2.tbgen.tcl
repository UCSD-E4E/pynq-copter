set C_TypeInfoList {{ 
"iiccomm2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": ["0", [4096]]}] }, {"stat_reg_outValue1": [[], {"reference": "0"}] }, {"stat_reg_outValue2": [[], {"reference": "0"}] }, {"stat_reg_outValue3": [[], {"reference": "0"}] }, {"stat_reg_outValue4": [[], {"reference": "0"}] }, {"ctrl_reg_outValue": [[], {"reference": "0"}] }, {"empty_pirq_outValue": [[], {"reference": "0"}] }, {"full_pirq_outValue": [[], {"reference": "0"}] }, {"tx_fifo_outValue": [[], {"reference": "0"}] }, {"rx_fifo_outValue": [[], {"reference": "0"}] }],[],""], 
"0": [ "temp32", {"typedef": [[[],"1"],""]}], 
...
set C_modelArgList {
	...
	{ tx_fifo_outValue_V int 32 regular {axi_slave 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "iic_V", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "tx_fifo_outValue_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "tx_fifo_outValue.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":72}, "offset_end" : {"out":79}} , 
 	{ "Name" : "rx_fifo_outValue_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "rx_fifo_outValue.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":80}, "offset_end" : {"out":87}} ]}
...
set ArgLastReadFirstWriteLatency {
	iiccomm2 {
		...
		tx_fifo_outValue_V {Type O LastRead -1 FirstWrite 9}
