set C_TypeInfoList {{ 
"iiccomm2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"bus": [[],{ "pointer": "0"}] }, {"outValue": [[], {"reference": "0"}] }],[],""], 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"iiccomm2","role":"start","value":"0","valid_bit":"0"},{"name":"iiccomm2","role":"continue","value":"0","valid_bit":"4"},{"name":"iiccomm2","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.iiccomm2_outValue_first_s_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.iiccomm2_bus_r_m_axi_U", "Parent" : "0"}]}
