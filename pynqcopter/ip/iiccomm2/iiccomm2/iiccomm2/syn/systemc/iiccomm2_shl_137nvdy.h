...
#ifndef __iiccomm2_shl_137nvdy__HH__
#define __iiccomm2_shl_137nvdy__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_shl_137nvdy) {
    ...
    SC_CTOR(iiccomm2_shl_137nvdy):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
