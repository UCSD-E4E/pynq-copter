...
#ifndef __iiccomm2_mul_16nsfYi__HH__
#define __iiccomm2_mul_16nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_16nsfYi) {
    ...
    SC_CTOR(iiccomm2_mul_16nsfYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
