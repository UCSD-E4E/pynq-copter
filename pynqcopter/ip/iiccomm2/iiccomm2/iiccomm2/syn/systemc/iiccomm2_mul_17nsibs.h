...
#ifndef __iiccomm2_mul_17nsibs__HH__
#define __iiccomm2_mul_17nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_17nsibs) {
    ...
    SC_CTOR(iiccomm2_mul_17nsibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
