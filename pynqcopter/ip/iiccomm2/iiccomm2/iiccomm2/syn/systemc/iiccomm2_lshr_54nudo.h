...
#ifndef __iiccomm2_lshr_54nudo__HH__
#define __iiccomm2_lshr_54nudo__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_lshr_54nudo) {
    ...
    SC_CTOR(iiccomm2_lshr_54nudo):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
