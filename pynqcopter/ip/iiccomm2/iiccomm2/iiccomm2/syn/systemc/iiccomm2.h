...
struct iiccomm2 : public sc_module {
    ...
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_849;
    sc_signal< sc_lv<32> > iic_addr34_read_reg_854;
    sc_signal< sc_lv<32> > iic_addr_13_read_reg_869;
    sc_signal< sc_lv<32> > iic_addr_15_read_reg_874;
    sc_signal< sc_lv<29> > ctr_V_fu_829_p2;
    sc_signal< bool > ap_block_state56_io;
    sc_signal< sc_lv<32> > iic_addr_65_read_reg_902;
    sc_signal< sc_lv<32> > iic_addr_67_read_reg_907;
    sc_signal< sc_lv<32> > iic_addr_69_read_reg_912;
    sc_signal< sc_lv<29> > p_014_0_i_reg_642;
