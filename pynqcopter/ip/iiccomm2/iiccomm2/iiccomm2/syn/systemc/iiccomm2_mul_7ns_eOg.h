...
#ifndef __iiccomm2_mul_7ns_eOg__HH__
#define __iiccomm2_mul_7ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_7ns_eOg) {
    ...
    SC_CTOR(iiccomm2_mul_7ns_eOg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
