...
#ifndef __iiccomm2_mul_61s_rcU__HH__
#define __iiccomm2_mul_61s_rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_61s_rcU) {
    ...
    SC_CTOR(iiccomm2_mul_61s_rcU):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
