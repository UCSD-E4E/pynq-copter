...
#ifndef __iiccomm2_mul_52s_g8j__HH__
#define __iiccomm2_mul_52s_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_52s_g8j) {
    ...
    SC_CTOR(iiccomm2_mul_52s_g8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
