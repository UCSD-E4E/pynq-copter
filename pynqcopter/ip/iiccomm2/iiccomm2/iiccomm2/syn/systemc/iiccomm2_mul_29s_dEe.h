...
#ifndef __iiccomm2_mul_29s_dEe__HH__
#define __iiccomm2_mul_29s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_29s_dEe) {
    ...
    SC_CTOR(iiccomm2_mul_29s_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
