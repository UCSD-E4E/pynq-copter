...
#ifndef __iiccomm2_mul_17nsmb6__HH__
#define __iiccomm2_mul_17nsmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2_mul_17nsmb6) {
    ...
    SC_CTOR(iiccomm2_mul_17nsmb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {
