...
#ifndef __pwm_mul_32ns_33s_bkb__HH__
#define __pwm_mul_32ns_33s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pwm_mul_32ns_33s_bkb) {
    ...
    SC_CTOR(pwm_mul_32ns_33s_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
