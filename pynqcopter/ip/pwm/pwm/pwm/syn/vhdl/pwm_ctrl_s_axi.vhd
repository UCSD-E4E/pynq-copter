...
architecture behave of pwm_ctrl_s_axi is
    ...
    signal int_min_duty_V      : UNSIGNED(15 downto 0) := (others => '0');
    signal int_max_duty_V      : UNSIGNED(15 downto 0) := (others => '0');
    signal int_period_V        : UNSIGNED(15 downto 0) := (others => '0');
    -- memory signals
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MIN_DUTY_V_DATA_0 =>
                        rdata_data <= RESIZE(int_min_duty_V(15 downto 0), 32);
                    when ADDR_MAX_DUTY_V_DATA_0 =>
                        rdata_data <= RESIZE(int_max_duty_V(15 downto 0), 32);
                    when ADDR_PERIOD_V_DATA_0 =>
                        rdata_data <= RESIZE(int_period_V(15 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MIN_DUTY_V_DATA_0) then
                    int_min_duty_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_min_duty_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAX_DUTY_V_DATA_0) then
                    int_max_duty_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_max_duty_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_PERIOD_V_DATA_0) then
                    int_period_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_period_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
