...
architecture behave of pwm_ctrl_s_axi is
    ...
    constant ADDR_MIN_DUTY_V_DATA_0 : INTEGER := 16#10#;
    constant ADDR_MIN_DUTY_V_CTRL   : INTEGER := 16#14#;
    constant ADDR_MAX_DUTY_V_DATA_0 : INTEGER := 16#18#;
    constant ADDR_MAX_DUTY_V_CTRL   : INTEGER := 16#1c#;
    constant ADDR_PERIOD_V_DATA_0   : INTEGER := 16#20#;
    constant ADDR_PERIOD_V_CTRL     : INTEGER := 16#24#;
    ...
    signal int_min_duty_V      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_max_duty_V      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_period_V        : UNSIGNED(31 downto 0) := (others => '0');
    -- memory signals
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MIN_DUTY_V_DATA_0 =>
                        rdata_data <= RESIZE(int_min_duty_V(31 downto 0), 32);
                    when ADDR_MAX_DUTY_V_DATA_0 =>
                        rdata_data <= RESIZE(int_max_duty_V(31 downto 0), 32);
                    when ADDR_PERIOD_V_DATA_0 =>
                        rdata_data <= RESIZE(int_period_V(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
...
-- ----------------------- Register logic ----------------
    ...
    min_duty_V           <= STD_LOGIC_VECTOR(int_min_duty_V);
    max_duty_V           <= STD_LOGIC_VECTOR(int_max_duty_V);
    period_V             <= STD_LOGIC_VECTOR(int_period_V);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MIN_DUTY_V_DATA_0) then
                    int_min_duty_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_min_duty_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAX_DUTY_V_DATA_0) then
                    int_max_duty_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_max_duty_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_PERIOD_V_DATA_0) then
                    int_period_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_period_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    -- m_V
    int_m_V_address0     <= UNSIGNED(m_V_address0);
    int_m_V_ce0          <= m_V_ce0;
    int_m_V_we0          <= '0';
    int_m_V_be0          <= (others => '0');
    int_m_V_d0           <= (others => '0');
    m_V_q0               <= STD_LOGIC_VECTOR(RESIZE(int_m_V_q0, 32));
