...
architecture behave of pwm_AXILiteS_s_axi is
    ...
    constant ADDR_M_V_BASE : INTEGER := 16#10#;
    constant ADDR_M_V_HIGH : INTEGER := 16#1f#;
    ...
    component pwm_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component pwm_AXILiteS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_m_V
int_m_V : pwm_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
...
entity pwm_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity pwm_AXILiteS_s_axi_ram;

architecture behave of pwm_AXILiteS_s_axi_ram is
