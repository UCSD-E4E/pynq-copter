...
architecture behav of iiccomm is 
    ...
    "iiccomm,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=8,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=658,HLS_SYN_LUT=798}";
    ...
    component iiccomm_outValue_first_s_axi IS
    generic (
        C_S_AXI_ADDR_WIDTH : INTEGER;
        C_S_AXI_DATA_WIDTH : INTEGER );
    port (
    ...
    component iiccomm_bus_r_m_axi IS
    generic (
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    ...
    iiccomm_outValue_first_s_axi_U : component iiccomm_outValue_first_s_axi
    generic map (
    ...
    iiccomm_bus_r_m_axi_U : component iiccomm_bus_r_m_axi
    generic map (
        USER_DW => 32,
        USER_AW => 32,
        USER_MAXREQS => 5,
    ...
    bus_r_ARADDR <= ap_const_lv64_104(32 - 1 downto 0);
