...
(* CORE_GENERATION_INFO="iiccomm,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=500000073,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=1350,HLS_SYN_LUT=2130}" *)
...
reg   [31:0] iic_addr_1_read_reg_867;
reg   [31:0] iic_addr34_read_reg_872;
reg   [31:0] iic_addr_13_read_reg_887;
reg   [31:0] iic_addr_15_read_reg_892;
wire   [28:0] ctr_V_fu_847_p2;
reg    ap_block_state56_io;
reg   [31:0] iic_addr_65_read_reg_910;
reg   [28:0] p_014_0_i_reg_664;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((~((ap_start == 1'b0) | (ap_sig_ioackin_iic_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state66)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state31)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state30)) | ((ap_sig_ioackin_iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state15)))) begin
            ap_reg_ioackin_iic_ARREADY <= 1'b0;
        end else if ((((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (iic_ARREADY == 1'b1)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state66)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state31)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state30)) | ((iic_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state15)))) begin
...
always @ (*) begin
    if (((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state66))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b1) & (ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state66)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state31)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state30)) | ((ap_reg_ioackin_iic_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state15)))) begin
        iic_ARVALID = 1'b1;
    end else begin
        iic_ARVALID = 1'b0;
    end
...
always @ (*) begin
    ...
    end else if ((((tmp_fu_841_p2 == 1'd1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state56)) | ((iic_RVALID == 1'b1) & (ap_reg_ioackin_iic_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state38)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state66) | (1'b1 == ap_CS_fsm_state31) | (1'b1 == ap_CS_fsm_state30) | (1'b1 == ap_CS_fsm_state15) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state56 : begin
            if (((1'b0 == ap_block_state56_io) & (tmp_fu_841_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state56))) begin
                ap_NS_fsm = ap_ST_fsm_state56;
            end else if (((1'b0 == ap_block_state56_io) & (tmp_fu_841_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state56))) begin
...
always @ (*) begin
    ap_block_state56_io = ((tmp_fu_841_p2 == 1'd1) & (ap_sig_ioackin_iic_AWREADY == 1'b0));
end
...
assign ctr_V_fu_847_p2 = (p_014_0_i_reg_664 + 29'd1);

assign grp_fu_699_p2 = 64'd268436544;

assign grp_fu_741_p2 = 64'd268436546;

assign grp_fu_763_p2 = 64'd268436546;

assign tmp_fu_841_p2 = ((p_014_0_i_reg_664 == 29'd500000000) ? 1'b1 : 1'b0);
