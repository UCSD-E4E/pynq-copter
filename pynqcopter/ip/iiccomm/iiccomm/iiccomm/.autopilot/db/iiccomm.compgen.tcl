...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler iiccomm_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 2 \
			corename iiccomm_outValue_first_axilite \
			name iiccomm_outValue_first_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler iiccomm_outValue_first_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 3.5 \ 
    name {iiccomm_bus_r_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'bus_r'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler iiccomm_bus_r_m_axi
}
