...
; [#uses=0]
define void @iiccomm(i32* %iic, i32* %stat_reg_outValue1, i32* %empty_pirq_outValue, i32* %full_pirq_outValue, i32* %ctrl_reg_outValue, i32* %pressure_msb, i32* %pressure_lsb, i32* %pressure_xlsb) {
  ...
  call void @llvm.dbg.value(metadata !{i32* %iic}, i64 0, metadata !71), !dbg !86 ; [debug line = 48:32] [debug variable = iic]
  call void @llvm.dbg.value(metadata !{i32* %stat_reg_outValue1}, i64 0, metadata !87), !dbg !88 ; [debug line = 48:53] [debug variable = stat_reg_outValue1]
  call void @llvm.dbg.value(metadata !{i32* %empty_pirq_outValue}, i64 0, metadata !89), !dbg !90 ; [debug line = 48:83] [debug variable = empty_pirq_outValue]
  call void @llvm.dbg.value(metadata !{i32* %full_pirq_outValue}, i64 0, metadata !91), !dbg !92 ; [debug line = 48:114] [debug variable = full_pirq_outValue]
  call void @llvm.dbg.value(metadata !{i32* %ctrl_reg_outValue}, i64 0, metadata !93), !dbg !94 ; [debug line = 48:144] [debug variable = ctrl_reg_outValue]
  call void @llvm.dbg.value(metadata !{i32* %pressure_msb}, i64 0, metadata !95), !dbg !96 ; [debug line = 48:173] [debug variable = pressure_msb]
  call void @llvm.dbg.value(metadata !{i32* %pressure_lsb}, i64 0, metadata !97), !dbg !98 ; [debug line = 48:197] [debug variable = pressure_lsb]
  call void @llvm.dbg.value(metadata !{i32* %pressure_xlsb}, i64 0, metadata !99), !dbg !100 ; [debug line = 48:221] [debug variable = pressure_xlsb]
...
; <label>:1                                       ; preds = %meminst
  ...
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %iic_addr_42, i32 23, i4 -1), !dbg !130 ; [debug line = 100:2]
  ...
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %iic_addr_51, i32 36, i4 -1), !dbg !133 ; [debug line = 105:2]
  ...
  call void (...)* @_ssdm_op_SpecProtocol(i32 0, [1 x i8]* @p_str1) nounwind, !dbg !134 ; [debug line = 59:1@107:2]
  br label %2, !dbg !145                          ; [debug line = 63:10@107:2]

; <label>:2                                       ; preds = %3, %1
  %p_014_0_i = phi i26 [ 0, %1 ], [ %ctr_V, %3 ]  ; [#uses=2 type=i26]
  %tmp_2 = icmp eq i26 %p_014_0_i, -17108864, !dbg !147 ; [#uses=1 type=i1] [debug line = 2042:5@63:19@107:2]
  %empty_3 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 50000000, i64 50000000, i64 50000000) nounwind ; [#uses=0 type=i32]
  %ctr_V = add i26 %p_014_0_i, 1, !dbg !992       ; [#uses=1 type=i26] [debug line = 1879:145@1896:5@63:30@107:2]
  br i1 %tmp_2, label %"delay_until_ms<1000ull, 50000000ull>.exit", label %3, !dbg !991 ; [debug line = 63:19@107:2]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{i8* %dummy}, i64 0, metadata !999) nounwind, !dbg !1001 ; [debug line = 64:9@107:2] [debug variable = dummy]
  %dummy_1 = load volatile i8* %dummy, align 1, !dbg !1001 ; [#uses=1 type=i8] [debug line = 64:9@107:2]
  call void @llvm.dbg.value(metadata !{i8 %dummy_1}, i64 0, metadata !999) nounwind, !dbg !1001 ; [debug line = 64:9@107:2] [debug variable = dummy]
  store volatile i8 %dummy_1, i8* %dummy, align 1, !dbg !1001 ; [debug line = 64:9@107:2]
  call void @llvm.dbg.value(metadata !{i26 %ctr_V}, i64 0, metadata !1003) nounwind, !dbg !992 ; [debug line = 1879:145@1896:5@63:30@107:2] [debug variable = ctr.V]
  br label %2, !dbg !998                          ; [debug line = 63:30@107:2]
...
!72 = metadata !{i32 786478, i32 0, metadata !73, metadata !"iiccomm", metadata !"iiccomm", metadata !"_Z7iiccommPVjRjS1_S1_S1_S1_S1_S1_", metadata !73, i32 48, metadata !74, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !81, i32 49} ; [ DW_TAG_subprogram ]
!73 = metadata !{i32 786473, metadata !"iiccomm.cpp", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm", null} ; [ DW_TAG_file_type ]
...
!86 = metadata !{i32 48, i32 32, metadata !72, null}
...
!88 = metadata !{i32 48, i32 53, metadata !72, null}
...
!90 = metadata !{i32 48, i32 83, metadata !72, null}
...
!92 = metadata !{i32 48, i32 114, metadata !72, null}
...
!94 = metadata !{i32 48, i32 144, metadata !72, null}
...
!96 = metadata !{i32 48, i32 173, metadata !72, null}
...
!98 = metadata !{i32 48, i32 197, metadata !72, null}
...
!100 = metadata !{i32 48, i32 221, metadata !72, null}
...
!134 = metadata !{i32 59, i32 1, metadata !135, metadata !144}
!135 = metadata !{i32 786443, metadata !136, i32 56, i32 22, metadata !137, i32 3} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 786478, i32 0, metadata !137, metadata !"delay_until_ms<1000, 50000000>", metadata !"delay_until_ms<1000, 50000000>", metadata !"_Z14delay_until_msILy1000ELy50000000EEvv", metadata !137, i32 56, metadata !138, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !140, null, metadata !81, i32 56} ; [ DW_TAG_subprogram ]
!137 = metadata !{i32 786473, metadata !"./iiccomm.hpp", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm", null} ; [ DW_TAG_file_type ]
...
!145 = metadata !{i32 63, i32 10, metadata !146, metadata !144}
!146 = metadata !{i32 786443, metadata !135, i32 63, i32 5, metadata !137, i32 4} ; [ DW_TAG_lexical_block ]
...
!150 = metadata !{i32 786473, metadata !"/data/opt/Xilinx/Vivado/2017.4/common/technology/autopilot/ap_int_syn.h", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm", null} ; [ DW_TAG_file_type ]
...
!160 = metadata !{i32 786473, metadata !"/data/opt/Xilinx/Vivado/2017.4/common/technology/autopilot/etc/autopilot_dt.def", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm", null} ; [ DW_TAG_file_type ]
...
!991 = metadata !{i32 63, i32 19, metadata !146, metadata !144}
...
!998 = metadata !{i32 63, i32 30, metadata !146, metadata !144}
!999 = metadata !{i32 786688, metadata !135, metadata !"dummy", metadata !137, i32 60, metadata !1000, i32 0, metadata !144} ; [ DW_TAG_auto_variable ]
!1000 = metadata !{i32 786485, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !254} ; [ DW_TAG_volatile_type ]
!1001 = metadata !{i32 64, i32 9, metadata !1002, metadata !144}
!1002 = metadata !{i32 786443, metadata !146, i32 63, i32 36, metadata !137, i32 5} ; [ DW_TAG_lexical_block ]
!1003 = metadata !{i32 790529, metadata !1004, metadata !"ctr.V", null, i32 61, metadata !1093, i32 0, metadata !995} ; [ DW_TAG_auto_variable_field ]
!1004 = metadata !{i32 786688, metadata !135, metadata !"ctr", metadata !137, i32 61, metadata !1005, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!1006 = metadata !{i32 786473, metadata !"/data/opt/Xilinx/Vivado/2017.4/common/technology/autopilot/ap_int.h", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/iiccomm", null} ; [ DW_TAG_file_type ]
