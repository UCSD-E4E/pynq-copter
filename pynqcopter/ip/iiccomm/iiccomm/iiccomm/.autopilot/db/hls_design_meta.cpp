...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("pressure_msb", 32, hls_out, 10, "ap_vld", "out_data", 1),
	Port_Property("pressure_msb_ap_vld", 1, hls_out, 10, "ap_vld", "out_vld", 1),
	Port_Property("pressure_lsb", 32, hls_out, 11, "ap_vld", "out_data", 1),
	Port_Property("pressure_lsb_ap_vld", 1, hls_out, 11, "ap_vld", "out_vld", 1),
	Port_Property("pressure_xlsb", 32, hls_out, 12, "ap_vld", "out_data", 1),
	Port_Property("pressure_xlsb_ap_vld", 1, hls_out, 12, "ap_vld", "out_vld", 1),
