...
#include "iiccomm_outValue_first_s_axi.h"
#include "iiccomm_bus_r_m_axi.h"
...
struct iiccomm : public sc_module {
    ...
    sc_signal< sc_lv<32> > bus_addr_read_reg_68;
