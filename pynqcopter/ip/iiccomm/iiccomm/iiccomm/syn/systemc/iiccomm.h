...
struct iiccomm : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_fu_841_p2;
    ...
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_867;
    sc_signal< sc_lv<32> > iic_addr34_read_reg_872;
    sc_signal< sc_lv<32> > iic_addr_13_read_reg_887;
    sc_signal< sc_lv<32> > iic_addr_15_read_reg_892;
    sc_signal< sc_lv<29> > ctr_V_fu_847_p2;
    sc_signal< bool > ap_block_state56_io;
    sc_signal< sc_lv<32> > iic_addr_65_read_reg_910;
    sc_signal< sc_lv<29> > p_014_0_i_reg_664;
