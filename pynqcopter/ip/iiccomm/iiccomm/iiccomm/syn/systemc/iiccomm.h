...
struct iiccomm : public sc_module {
    ...
    sc_signal< sc_lv<32> > stat_reg_outValue2_i;
    sc_signal< sc_logic > stat_reg_outValue2_o_ap_vld;
    sc_signal< sc_lv<32> > stat_reg_outValue3_i;
    sc_signal< sc_logic > stat_reg_outValue3_o_ap_vld;
    sc_signal< sc_lv<32> > stat_reg_outValue4_i;
    sc_signal< sc_logic > stat_reg_outValue4_o_ap_vld;
    sc_signal< sc_lv<32> > tx_fifo_outValue_i;
    sc_signal< sc_logic > tx_fifo_outValue_o_ap_vld;
    sc_signal< sc_lv<32> > rx_fifo_outValue_i;
    sc_signal< sc_logic > rx_fifo_outValue_o_ap_vld;
    sc_signal< sc_lv<32> > ctrl_reg_outValue_i;
    sc_signal< sc_logic > ctrl_reg_outValue_o_ap_vld;
    ...
    sc_signal< sc_lv<32> > iic_addr_reg_351;
    sc_signal< sc_logic > ap_sig_ioackin_iic_ARREADY;
    sc_signal< sc_lv<32> > iic_addr_2_reg_365;
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_371;
    sc_signal< sc_lv<32> > iic_addr_3_reg_376;
    sc_signal< sc_lv<32> > iic_addr_3_read_reg_385;
    sc_signal< sc_lv<32> > iic_addr_4_read_reg_396;
    ...
    sc_signal< sc_logic > ap_reg_ioackin_tx_fifo_outValue_dummy_ack;
    sc_signal< sc_logic > ap_reg_ioackin_stat_reg_outValue2_dummy_ack;
    sc_signal< sc_logic > ap_reg_ioackin_stat_reg_outValue3_dummy_ack;
    ...
    void thread_ctrl_reg_outValue_o_ap_vld();
    ...
    void thread_iic_addr_2_reg_365();
    void thread_iic_addr_3_reg_376();
    void thread_iic_addr_reg_351();
    ...
    void thread_stat_reg_outValue2_o_ap_vld();
    void thread_stat_reg_outValue3_o_ap_vld();
    void thread_stat_reg_outValue4_o_ap_vld();
    void thread_tx_fifo_outValue_o_ap_vld();
