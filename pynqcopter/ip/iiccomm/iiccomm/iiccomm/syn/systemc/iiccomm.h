...
struct iiccomm : public sc_module {
    ...
    sc_signal< sc_lv<32> > stat_reg_outValue_i;
    sc_signal< sc_logic > stat_reg_outValue_o_ap_vld;
    sc_signal< sc_lv<32> > interr_reg_outValue_i;
    sc_signal< sc_logic > interr_reg_outValue_o_ap_vld;
    ...
    sc_signal< sc_lv<32> > iic_addr_2_reg_192;
    sc_signal< sc_lv<32> > iic_addr_read_reg_199;
    sc_signal< sc_lv<32> > iic_addr_1_read_reg_204;
    ...
    sc_signal< sc_logic > ap_reg_ioackin_stat_reg_outValue_dummy_ack;
    sc_signal< sc_logic > ap_reg_ioackin_interr_reg_outValue_dummy_ack;
