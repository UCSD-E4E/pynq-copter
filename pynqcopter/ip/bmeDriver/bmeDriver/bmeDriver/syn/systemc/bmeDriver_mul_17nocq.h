...
#ifndef __bmeDriver_mul_17nocq__HH__
#define __bmeDriver_mul_17nocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_17nocq) {
    ...
    SC_CTOR(bmeDriver_mul_17nocq):  ACMP_mul_us_U ("ACMP_mul_us_U") {
