...
#ifndef __bmeDriver_lshr_54wdI__HH__
#define __bmeDriver_lshr_54wdI__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_lshr_54wdI) {
    ...
    SC_CTOR(bmeDriver_lshr_54wdI):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
