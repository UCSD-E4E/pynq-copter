...
#ifndef __bmeDriver_mul_52sibs__HH__
#define __bmeDriver_mul_52sibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_52sibs) {
    ...
    SC_CTOR(bmeDriver_mul_52sibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
