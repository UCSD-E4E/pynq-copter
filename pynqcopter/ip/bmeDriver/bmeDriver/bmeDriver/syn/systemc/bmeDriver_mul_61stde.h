...
#ifndef __bmeDriver_mul_61stde__HH__
#define __bmeDriver_mul_61stde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_61stde) {
    ...
    SC_CTOR(bmeDriver_mul_61stde):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
