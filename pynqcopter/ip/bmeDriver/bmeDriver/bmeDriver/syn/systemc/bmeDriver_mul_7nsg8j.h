...
#ifndef __bmeDriver_mul_7nsg8j__HH__
#define __bmeDriver_mul_7nsg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_7nsg8j) {
    ...
    SC_CTOR(bmeDriver_mul_7nsg8j):  ACMP_mul_us_U ("ACMP_mul_us_U") {
