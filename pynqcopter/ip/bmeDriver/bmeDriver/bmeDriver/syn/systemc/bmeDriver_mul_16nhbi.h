...
#ifndef __bmeDriver_mul_16nhbi__HH__
#define __bmeDriver_mul_16nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_16nhbi) {
    ...
    SC_CTOR(bmeDriver_mul_16nhbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
