...
#ifndef __bmeDriver_mul_32nyd2__HH__
#define __bmeDriver_mul_32nyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bmeDriver_mul_32nyd2) {
    ...
    SC_CTOR(bmeDriver_mul_32nyd2):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
