...
set ID 45
set MemName bmeDriver_basepoibkb
...
# Memory (RAM/ROM)  definition:
set ID 46
set MemName bmeDriver_sensorDcud
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 6
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 47 \
			corename bmeDriver_AXILiteS_axilite \
			name bmeDriver_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bmeDriver_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bmeDriver_iic_m_axi
}
