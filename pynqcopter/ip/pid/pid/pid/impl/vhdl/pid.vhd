...
architecture behav of pid is 
    ...
    "pid,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.499750,HLS_SYN_LAT=69,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=24,HLS_SYN_FF=8673,HLS_SYN_LUT=8221}";
    ...
    component pid_faddfsub_32nsbkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component pid_fmul_32ns_32ncud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component pid_fdiv_32ns_32ndEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    pid_faddfsub_32nsbkb_U1 : component pid_faddfsub_32nsbkb
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    pid_faddfsub_32nsbkb_U2 : component pid_faddfsub_32nsbkb
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    pid_faddfsub_32nsbkb_U3 : component pid_faddfsub_32nsbkb
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U4 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U5 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U6 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U7 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U8 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fmul_32ns_32ncud_U9 : component pid_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    pid_fdiv_32ns_32ndEe_U10 : component pid_fdiv_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 30,
        din0_WIDTH => 32,
    ...
    pid_fdiv_32ns_32ndEe_U11 : component pid_fdiv_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 30,
        din0_WIDTH => 32,
    ...
    pid_fdiv_32ns_32ndEe_U12 : component pid_fdiv_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 30,
        din0_WIDTH => 32,
