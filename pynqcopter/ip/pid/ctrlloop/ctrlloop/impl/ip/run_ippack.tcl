...
set IPName      "ctrlloop"
set Version     "1.0"
set DisplayName "Ctrlloop"
set Revision    "1807161456"
set Description "HLS Core: Ctrlloop Function"
set Device      "zynq"
...
set Interfaces {
    s_axi_CTRL {
        ...
        memories "regs_V {base_address 512 range 512}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    m_axi_IOMEM {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IOMEM"
        data_width "32"
        param_prefix "C_M_AXI_IOMEM"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 100000001 II x}
