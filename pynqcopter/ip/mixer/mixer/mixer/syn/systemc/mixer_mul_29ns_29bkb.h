...
#ifndef __mixer_mul_29ns_29bkb__HH__
#define __mixer_mul_29ns_29bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_29ns_29bkb) {
    ...
    SC_CTOR(mixer_mul_29ns_29bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
