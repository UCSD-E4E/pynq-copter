...
#ifndef __mixer_mul_30s_59sibs__HH__
#define __mixer_mul_30s_59sibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_30s_59sibs) {
    ...
    SC_CTOR(mixer_mul_30s_59sibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
