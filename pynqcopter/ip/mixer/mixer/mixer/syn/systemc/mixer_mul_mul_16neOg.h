...
#ifndef __mixer_mul_mul_16neOg__HH__
#define __mixer_mul_mul_16neOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_mul_16neOg) {
    ...
    SC_CTOR(mixer_mul_mul_16neOg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
