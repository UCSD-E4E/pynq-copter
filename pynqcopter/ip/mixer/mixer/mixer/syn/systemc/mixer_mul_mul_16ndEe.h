...
#ifndef __mixer_mul_mul_16ndEe__HH__
#define __mixer_mul_mul_16ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_mul_16ndEe) {
    ...
    SC_CTOR(mixer_mul_mul_16ndEe):  ACMP_mul_us_U ("ACMP_mul_us_U") {
