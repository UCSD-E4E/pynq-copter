...
#ifndef __mixer_mul_mul_16seOg__HH__
#define __mixer_mul_mul_16seOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_mul_16seOg) {
    ...
    SC_CTOR(mixer_mul_mul_16seOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
