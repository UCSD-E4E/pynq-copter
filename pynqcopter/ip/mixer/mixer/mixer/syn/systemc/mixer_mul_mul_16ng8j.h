...
#ifndef __mixer_mul_mul_16ng8j__HH__
#define __mixer_mul_mul_16ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_mul_16ng8j) {
    ...
    SC_CTOR(mixer_mul_mul_16ng8j):  ACMP_mul_us_U ("ACMP_mul_us_U") {
