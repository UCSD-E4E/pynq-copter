...
#ifndef __mixer_mul_29ns_29cud__HH__
#define __mixer_mul_29ns_29cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mixer_mul_29ns_29cud) {
    ...
    SC_CTOR(mixer_mul_29ns_29cud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
