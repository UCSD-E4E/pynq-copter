...
//------------------------Parameter----------------------
`define TV_IN_m_V "../tv/cdatafile/c.mixer.autotvin_m_V.dat"
`define TV_OUT_m_V "../tv/rtldatafile/rtl.mixer.autotvout_m_V.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > m_V_mem_depth) begin
                $display ("/home/brennan/Documents/pynq-copter/pynqcopter/ip/mixer/mixer/mixer/sim/verilog/AESL_axi_master_m_V.v: Write request address %d exceed AXI master m_V array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, m_V_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > m_V_mem_depth) begin
                $display ("/home/brennan/Documents/pynq-copter/pynqcopter/ip/mixer/mixer/mixer/sim/verilog/AESL_axi_master_m_V.v: Read request address %d exceed AXI master m_V array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, m_V_mem_depth); 
                $finish;
            end
