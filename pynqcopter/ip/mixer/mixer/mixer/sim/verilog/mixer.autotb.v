...
`define AUTOTB_DUT      mixer
`define AUTOTB_DUT_INST AESL_inst_mixer
`define AUTOTB_TOP      apatb_mixer_top
`define AUTOTB_LAT_RESULT_FILE "mixer.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mixer.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mixer_top
...
`define AUTOTB_TVIN_regs_in_V_out_wrapc  "../tv/rtldatafile/rtl.mixer.autotvin_regs_in_V.dat"
`define AUTOTB_TVOUT_m_V  "../tv/cdatafile/c.mixer.autotvout_m_V.dat"
`define AUTOTB_TVOUT_m_V_out_wrapc  "../tv/rtldatafile/rtl.mixer.autotvout_m_V.dat"
module `AUTOTB_TOP;
