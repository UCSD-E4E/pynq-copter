...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mixer.autotvin.dat"
	set constFileTvOut       "mixer.autotvout.dat"
	set constFileHdlTvIn     "mixer.autohdltvin.dat"
	set constFileHdlTvOut    "mixer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
