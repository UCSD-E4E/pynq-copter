...
entity mixer_AXILiteS_s_axi is
generic (
...
architecture behave of mixer_AXILiteS_s_axi is
    ...
    end component mixer_AXILiteS_s_axi_ram;
...
-- ----------------------- Memory logic ------------------
    -- regs_in_V
    int_regs_in_V_address0 <= SHIFT_RIGHT(UNSIGNED(regs_in_V_address0), 1)(1 downto 0);
...
entity mixer_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity mixer_AXILiteS_s_axi_ram;

architecture behave of mixer_AXILiteS_s_axi_ram is
