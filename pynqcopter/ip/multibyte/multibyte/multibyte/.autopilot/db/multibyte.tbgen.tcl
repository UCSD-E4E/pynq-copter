set C_TypeInfoList {{ 
"multibyte" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": [ {"scalar": "int"}, [4096]]}] }, {"pressure_msb": [[], {"reference": "0"}] }, {"pressure_lsb": [[], {"reference": "0"}] }, {"pressure_xlsb": [[], {"reference": "0"}] }, {"temperature_msb": [[], {"reference": "0"}] }, {"temperature_lsb": [[], {"reference": "0"}] }, {"temperature_xlsb": [[], {"reference": "0"}] }, {"stateSetUp": [[], {"reference":  {"scalar": "int"}}] }, {"state": [[], {"reference":  {"scalar": "int"}}] }, {"stateDataReads": [[], {"reference":  {"scalar": "int"}}] }, {"dig_T1": [[], {"reference": "0"}] }, {"dig_P9": [[], {"reference": "0"}] }, {"pressureRaw": [[], {"reference": "0"}] }, {"temperatureRaw": [[], {"reference": "0"}] }, {"trimVal1": [[], {"reference": "0"}] }, {"trimVal2": [[], {"reference": "0"}] }, {"trimVal3": [[], {"reference": "0"}] }, {"trimVal4": [[], {"reference": "0"}] }, {"trimVal5": [[], {"reference": "0"}] }, {"trimVal6": [[], {"reference": "0"}] }, {"trimVal23": [[], {"reference": "0"}] }, {"trimVal24": [[], {"reference": "0"}] }],[],""], 
...
set C_modelArgList {
	...
	{ dig_T1 int 32 unused {axi_slave 0}  }
	{ dig_P9 int 32 unused {axi_slave 0}  }
	{ pressureRaw int 32 regular {axi_slave 1}  }
	{ temperatureRaw int 32 regular {axi_slave 1}  }
	{ trimVal1 int 32 unused {axi_slave 0}  }
	{ trimVal2 int 32 unused {axi_slave 0}  }
	{ trimVal3 int 32 unused {axi_slave 0}  }
	{ trimVal4 int 32 unused {axi_slave 0}  }
	{ trimVal5 int 32 unused {axi_slave 0}  }
	{ trimVal6 int 32 unused {axi_slave 0}  }
	{ trimVal23 int 32 unused {axi_slave 0}  }
	{ trimVal24 int 32 unused {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "CTRL", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "dig_T1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_T1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":88}, "offset_end" : {"in":95}} , 
 	{ "Name" : "dig_P9", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P9","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":96}, "offset_end" : {"in":103}} , 
 	...
 	{ "Name" : "trimVal1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":120}, "offset_end" : {"in":127}} , 
 	{ "Name" : "trimVal2", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":128}, "offset_end" : {"in":135}} , 
 	{ "Name" : "trimVal3", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":136}, "offset_end" : {"in":143}} , 
 	{ "Name" : "trimVal4", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal4","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":144}, "offset_end" : {"in":151}} , 
 	{ "Name" : "trimVal5", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal5","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":152}, "offset_end" : {"in":159}} , 
 	{ "Name" : "trimVal6", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal6","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":160}, "offset_end" : {"in":167}} , 
 	{ "Name" : "trimVal23", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal23","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":168}, "offset_end" : {"in":175}} , 
 	{ "Name" : "trimVal24", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal24","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":176}, "offset_end" : {"in":183}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"multibyte","role":"start","value":"0","valid_bit":"0"},{"name":"multibyte","role":"continue","value":"0","valid_bit":"4"},{"name":"multibyte","role":"auto_start","value":"0","valid_bit":"7"},{"name":"dig_T1","role":"data","value":"88"},{"name":"dig_P9","role":"data","value":"96"},{"name":"trimVal1","role":"data","value":"120"},{"name":"trimVal2","role":"data","value":"128"},{"name":"trimVal3","role":"data","value":"136"},{"name":"trimVal4","role":"data","value":"144"},{"name":"trimVal5","role":"data","value":"152"},{"name":"trimVal6","role":"data","value":"160"},{"name":"trimVal23","role":"data","value":"168"},{"name":"trimVal24","role":"data","value":"176"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "trimVal1", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal2", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal3", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal4", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal5", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal6", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal23", "Type" : "None", "Direction" : "I"},
			{"Name" : "trimVal24", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	multibyte {
		...
		stateSetUp {Type O LastRead -1 FirstWrite 2}
		...
		trimVal1 {Type I LastRead -1 FirstWrite -1}
		trimVal2 {Type I LastRead -1 FirstWrite -1}
		trimVal3 {Type I LastRead -1 FirstWrite -1}
		trimVal4 {Type I LastRead -1 FirstWrite -1}
		trimVal5 {Type I LastRead -1 FirstWrite -1}
		trimVal6 {Type I LastRead -1 FirstWrite -1}
		trimVal23 {Type I LastRead -1 FirstWrite -1}
		trimVal24 {Type I LastRead -1 FirstWrite -1}
		firstSample {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2000279", "Max" : "202000341"}
	, {"Name" : "Interval", "Min" : "2000280", "Max" : "202000342"}
]}
