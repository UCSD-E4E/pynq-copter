set C_TypeInfoList {{ 
"multibyte" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": [ {"scalar": "int"}, [4096]]}] }, {"pressure_msb": [[], {"reference": "0"}] }, {"pressure_lsb": [[], {"reference": "0"}] }, {"pressure_xlsb": [[], {"reference": "0"}] }, {"temperature_msb": [[], {"reference": "0"}] }, {"temperature_lsb": [[], {"reference": "0"}] }, {"temperature_xlsb": [[], {"reference": "0"}] }, {"stateSetUp": [[], {"reference":  {"scalar": "int"}}] }, {"state": [[], {"reference":  {"scalar": "int"}}] }, {"stateDataReads": [[], {"reference":  {"scalar": "int"}}] }, {"dig_T1": [[], {"reference": "0"}] }, {"dig_T2": [[], {"reference": "0"}] }, {"dig_T3": [[], {"reference": "0"}] }, {"dig_P1": [[], {"reference": "0"}] }, {"dig_P2": [[], {"reference": "0"}] }, {"dig_P3": [[], {"reference": "0"}] }, {"dig_P4": [[], {"reference": "0"}] }, {"dig_P5": [[], {"reference": "0"}] }, {"dig_P6": [[], {"reference": "0"}] }, {"dig_P7": [[], {"reference": "0"}] }, {"dig_P8": [[], {"reference": "0"}] }, {"dig_P9": [[], {"reference": "0"}] }, {"pressureRaw": [[], {"reference": "0"}] }, {"temperatureRaw": [[], {"reference": "0"}] }, {"trimVal1": [[], {"reference": "0"}] }, {"trimVal2": [[], {"reference": "0"}] }, {"trimVal3": [[], {"reference": "0"}] }, {"trimVal4": [[], {"reference": "0"}] }, {"trimVal5": [[], {"reference": "0"}] }, {"trimVal6": [[], {"reference": "0"}] }, {"trimVal23": [[], {"reference": "0"}] }, {"trimVal24": [[], {"reference": "0"}] }],[],""], 
...
set C_modelArgList {
	...
	{ dig_T1 int 32 regular {axi_slave 1}  }
	{ dig_T2 int 32 unused {pointer 0}  }
	{ dig_T3 int 32 unused {pointer 0}  }
	{ dig_P1 int 32 unused {pointer 0}  }
	{ dig_P2 int 32 unused {pointer 0}  }
	{ dig_P3 int 32 unused {pointer 0}  }
	{ dig_P4 int 32 unused {pointer 0}  }
	{ dig_P5 int 32 unused {pointer 0}  }
	{ dig_P6 int 32 unused {pointer 0}  }
	{ dig_P7 int 32 unused {pointer 0}  }
	{ dig_P8 int 32 unused {pointer 0}  }
	{ dig_P9 int 32 regular {axi_slave 1}  }
	{ pressureRaw int 32 regular {axi_slave 1}  }
	{ temperatureRaw int 32 regular {axi_slave 1}  }
	{ trimVal1 int 32 regular {axi_slave 1}  }
	{ trimVal2 int 32 regular {axi_slave 1}  }
	{ trimVal3 int 32 regular {axi_slave 1}  }
	{ trimVal4 int 32 regular {axi_slave 1}  }
	{ trimVal5 int 32 regular {axi_slave 1}  }
	{ trimVal6 int 32 regular {axi_slave 1}  }
	{ trimVal23 int 32 regular {axi_slave 1}  }
	{ trimVal24 int 32 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "CTRL", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "dig_T1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_T1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":88}, "offset_end" : {"out":95}} , 
 	{ "Name" : "dig_T2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_T2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_T3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_T3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P4", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P4","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P5", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P5","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P6", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P6","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P7", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P7","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P8", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P8","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "dig_P9", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P9","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":96}, "offset_end" : {"out":103}} , 
 	{ "Name" : "pressureRaw", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressureRaw","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":104}, "offset_end" : {"out":111}} , 
 	{ "Name" : "temperatureRaw", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "temperatureRaw","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":112}, "offset_end" : {"out":119}} , 
 	{ "Name" : "trimVal1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":120}, "offset_end" : {"out":127}} , 
 	{ "Name" : "trimVal2", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":128}, "offset_end" : {"out":135}} , 
 	{ "Name" : "trimVal3", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":136}, "offset_end" : {"out":143}} , 
 	{ "Name" : "trimVal4", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal4","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":144}, "offset_end" : {"out":151}} , 
 	{ "Name" : "trimVal5", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal5","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":152}, "offset_end" : {"out":159}} , 
 	{ "Name" : "trimVal6", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal6","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":160}, "offset_end" : {"out":167}} , 
 	{ "Name" : "trimVal23", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal23","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":168}, "offset_end" : {"out":175}} , 
 	{ "Name" : "trimVal24", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal24","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":176}, "offset_end" : {"out":183}} ]}
...
set portList { 
	...
	{ dig_T2 sc_in sc_lv 32 signal 11 } 
	{ dig_T3 sc_in sc_lv 32 signal 12 } 
	{ dig_P1 sc_in sc_lv 32 signal 13 } 
	{ dig_P2 sc_in sc_lv 32 signal 14 } 
	{ dig_P3 sc_in sc_lv 32 signal 15 } 
	{ dig_P4 sc_in sc_lv 32 signal 16 } 
	{ dig_P5 sc_in sc_lv 32 signal 17 } 
	{ dig_P6 sc_in sc_lv 32 signal 18 } 
	{ dig_P7 sc_in sc_lv 32 signal 19 } 
	{ dig_P8 sc_in sc_lv 32 signal 20 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"multibyte","role":"start","value":"0","valid_bit":"0"},{"name":"multibyte","role":"continue","value":"0","valid_bit":"4"},{"name":"multibyte","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "CTRL", "role": "interrupt" } }, 
 	...
 	{ "name": "dig_T2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_T2", "role": "default" }} , 
 	{ "name": "dig_T3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_T3", "role": "default" }} , 
 	{ "name": "dig_P1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P1", "role": "default" }} , 
 	{ "name": "dig_P2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P2", "role": "default" }} , 
 	{ "name": "dig_P3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P3", "role": "default" }} , 
 	{ "name": "dig_P4", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P4", "role": "default" }} , 
 	{ "name": "dig_P5", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P5", "role": "default" }} , 
 	{ "name": "dig_P6", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P6", "role": "default" }} , 
 	{ "name": "dig_P7", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P7", "role": "default" }} , 
 	{ "name": "dig_P8", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dig_P8", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "trimVal1", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal2", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal3", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal4", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal5", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal6", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal23", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "trimVal24", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	multibyte {
		CTRL {Type IO LastRead 100 FirstWrite 3}
		pressure_msb {Type O LastRead -1 FirstWrite 97}
		pressure_lsb {Type O LastRead -1 FirstWrite 97}
		pressure_xlsb {Type O LastRead -1 FirstWrite 97}
		temperature_msb {Type O LastRead -1 FirstWrite 97}
		temperature_lsb {Type O LastRead -1 FirstWrite 97}
		temperature_xlsb {Type O LastRead -1 FirstWrite 97}
		stateSetUp {Type O LastRead -1 FirstWrite 97}
		state {Type O LastRead -1 FirstWrite 75}
		stateDataReads {Type O LastRead -1 FirstWrite 92}
		dig_T1 {Type O LastRead -1 FirstWrite 81}
		...
		dig_P9 {Type O LastRead -1 FirstWrite 81}
		pressureRaw {Type O LastRead -1 FirstWrite 97}
		temperatureRaw {Type O LastRead -1 FirstWrite 97}
		trimVal1 {Type O LastRead -1 FirstWrite 81}
		trimVal2 {Type O LastRead -1 FirstWrite 81}
		trimVal3 {Type O LastRead -1 FirstWrite 81}
		trimVal4 {Type O LastRead -1 FirstWrite 81}
		trimVal5 {Type O LastRead -1 FirstWrite 81}
		trimVal6 {Type O LastRead -1 FirstWrite 81}
		trimVal23 {Type O LastRead -1 FirstWrite 81}
		trimVal24 {Type O LastRead -1 FirstWrite 81}
		firstSample {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3000333", "Max" : "203000395"}
	, {"Name" : "Interval", "Min" : "3000334", "Max" : "203000396"}
]}
...
set Spec2ImplPortList { 
	...
	dig_T2 { ap_none {  { dig_T2 in_data 0 32 } } }
	dig_T3 { ap_none {  { dig_T3 in_data 0 32 } } }
	dig_P1 { ap_none {  { dig_P1 in_data 0 32 } } }
	dig_P2 { ap_none {  { dig_P2 in_data 0 32 } } }
	dig_P3 { ap_none {  { dig_P3 in_data 0 32 } } }
	dig_P4 { ap_none {  { dig_P4 in_data 0 32 } } }
	dig_P5 { ap_none {  { dig_P5 in_data 0 32 } } }
	dig_P6 { ap_none {  { dig_P6 in_data 0 32 } } }
	dig_P7 { ap_none {  { dig_P7 in_data 0 32 } } }
	dig_P8 { ap_none {  { dig_P8 in_data 0 32 } } }
}
