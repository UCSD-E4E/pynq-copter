...
meminst8:                                         ; preds = %meminst8, %meminst8.preheader
  %invdar9 = phi i3 [ %indvarinc, %meminst8 ], [ 0, %meminst8.preheader ]
  %indvarinc = add i3 %invdar9, 1
  %tmp = zext i3 %invdar9 to i64
  %sensorData_addr = getelementptr [6 x i32]* %sensorData, i64 0, i64 %tmp
  store i32 0, i32* %sensorData_addr, align 4
  %tmp_1 = icmp eq i3 %invdar9, -3
  ...
  br i1 %tmp_1, label %0, label %meminst8
...
; <label>:2                                       ; preds = %3, %1
  ...
  br i1 %tmp_3, label %"delay_until_ms<50ull, 100000000ull>.exit30", label %3
...
; <label>:4                                       ; preds = %5, %"delay_until_ms<50ull, 100000000ull>.exit30"
  %p_014_0_i2 = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit30" ], [ %ctr_V_1, %5 ]
  ...
  br i1 %tmp_5, label %"delay_until_ms<50ull, 100000000ull>.exit25", label %5
...
; <label>:6                                       ; preds = %7, %"delay_until_ms<50ull, 100000000ull>.exit25"
  %p_014_0_i3 = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit25" ], [ %ctr_V_2, %7 ]
  ...
  br i1 %tmp_7, label %"delay_until_ms<50ull, 100000000ull>.exit20", label %7
...
; <label>:8                                       ; preds = %9, %"delay_until_ms<50ull, 100000000ull>.exit20"
  %p_014_0_i4 = phi i23 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit20" ], [ %ctr_V_3, %9 ]
  %tmp_9 = icmp eq i23 %p_014_0_i4, -3388608
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5000000, i64 5000000, i64 5000000) nounwind
  %ctr_V_3 = add i23 %p_014_0_i4, 1
  br i1 %tmp_9, label %"delay_until_ms<50ull, 100000000ull>.exit15", label %9
...
; <label>:10                                      ; preds = %11, %"delay_until_ms<50ull, 100000000ull>.exit15"
  %p_014_0_i5 = phi i28 [ 0, %"delay_until_ms<50ull, 100000000ull>.exit15" ], [ %ctr_V_4, %11 ]
  %tmp_s = icmp eq i28 %p_014_0_i5, -93435456
  ...
  br i1 %tmp_s, label %"delay_until_ms<1750ull, 100000000ull>.exit", label %11
...
; <label>:15                                      ; preds = %14
  %p_req48 = call i1 @_ssdm_op_ReadReq.m_axi.i32P(i32* %CTRL_addr_5, i32 1)
  %empty_14 = call i32 @_ssdm_op_Read.m_axi.volatile.i32P(i32* %CTRL_addr_5)
  br label %14
...
"delay_until_ms<10ull, 100000000ull>.exit48":     ; preds = %17
  %rend45 = call i32 (...)* @_ssdm_op_SpecRegionEnd([43 x i8]* @delay_until_ms_MD_10, i32 %rbegin6) nounwind
  %CTRL_addr_4_req40 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_4, i32 1)
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %CTRL_addr_4, i32 492, i4 -1)
  %CTRL_addr_4_resp41 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_4)
  %CTRL_addr_4_req42 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_4, i32 1)
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %CTRL_addr_4, i32 247, i4 -1)
  %CTRL_addr_4_resp43 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_4)
  %CTRL_addr_4_req44 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_4, i32 1)
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %CTRL_addr_4, i32 493, i4 -1)
  %CTRL_addr_4_resp45 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_4)
  %CTRL_addr_4_req46 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_4, i32 1)
  call void @_ssdm_op_Write.m_axi.volatile.i32P(i32* %CTRL_addr_4, i32 518, i4 -1)
  %CTRL_addr_4_resp47 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_4)
...
; <label>:19                                      ; preds = %20, %"delay_until_ms<10ull, 100000000ull>.exit48"
  %p_014_0_i7 = phi i20 [ 0, %"delay_until_ms<10ull, 100000000ull>.exit48" ], [ %ctr_V_7, %20 ]
  %tmp_6 = icmp eq i20 %p_014_0_i7, -48576
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1000000, i64 1000000, i64 1000000) nounwind
  %ctr_V_7 = add i20 %p_014_0_i7, 1
  br i1 %tmp_6, label %"delay_until_ms<10ull, 100000000ull>.exit43", label %20
...
"delay_until_ms<10ull, 100000000ull>.exit43":     ; preds = %19
  %rend40 = call i32 (...)* @_ssdm_op_SpecRegionEnd([43 x i8]* @delay_until_ms_MD_10, i32 %rbegin7) nounwind
...
; <label>:21                                      ; preds = %22, %"delay_until_ms<10ull, 100000000ull>.exit43"
  %index2 = phi i3 [ 0, %"delay_until_ms<10ull, 100000000ull>.exit43" ], [ %index_2, %22 ]
...
.loopexit:                                        ; preds = %21
  ...
  %tmp_8 = shl i32 %sensorData_load, 12
  %tmp_10 = shl i32 %sensorData_load_1, 4
  %tmp_12 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %sensorData_load_2, i32 4, i32 31)
  %tmp_11 = sext i28 %tmp_12 to i32
  %tmp1 = or i32 %tmp_8, %tmp_11
  ...
  %tmp_17 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %sensorData_load_5, i32 4, i32 31)
  %tmp_16 = sext i28 %tmp_17 to i32
  %tmp2 = or i32 %tmp_14, %tmp_16
