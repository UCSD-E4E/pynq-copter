...
@p_str4 = private unnamed_addr constant [11 x i8] c"IIC_OFFSET\00", align 1
...
define void @sensor(i32* %iicData, i32* %iicStatus) nounwind uwtable {
  ...
  %iicStatus_load = call i32 @_ssdm_op_Read.s_axilite.volatile.i32P(i32* %iicStatus) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %iicData, [6 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [11 x i8]* @p_str4, [1 x i8]* @p_str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  %iicData_addr = getelementptr inbounds i32* %iicData, i64 268438534
  %iicData_load_req = call i1 @_ssdm_op_ReadReq.m_axi.i32P(i32* %iicData_addr, i32 1) nounwind
  %iicData_addr_read = call i32 @_ssdm_op_Read.m_axi.volatile.i32P(i32* %iicData_addr) nounwind
  call void @_ssdm_op_Write.s_axilite.volatile.i32P(i32* %iicStatus, i32 %iicData_addr_read) nounwind
  ret void
}
