...
define void @sensor(i32* %iicData, i32* %iicStatus) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %iicData) nounwind, !map !50
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %iicStatus) nounwind, !map !56
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @sensor.str) nounwind
  call void @llvm.dbg.value(metadata !{i32* %iicData}, i64 0, metadata !60), !dbg !61 ; [debug line = 37:36] [debug variable = iicData]
  call void @llvm.dbg.value(metadata !{i32* %iicStatus}, i64 0, metadata !62), !dbg !63 ; [debug line = 37:59] [debug variable = iicStatus]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [5 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !64 ; [debug line = 39:1]
  %iicStatus.load = load volatile i32* %iicStatus, align 4, !dbg !66 ; [#uses=0 type=i32] [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %iicStatus, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !66 ; [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %iicData, [6 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [11 x i8]* @.str4, [6 x i8]* @.str5, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !67 ; [debug line = 41:1]
  %iicData.addr = getelementptr inbounds i32* %iicData, i64 65, !dbg !68 ; [#uses=1 type=i32*] [debug line = 49:2]
  %iicData.load = load volatile i32* %iicData.addr, align 4, !dbg !68 ; [#uses=1 type=i32] [debug line = 49:2]
  store volatile i32 %iicData.load, i32* %iicStatus, align 4, !dbg !69 ; [debug line = 50:2]
  ret void, !dbg !70                              ; [debug line = 52:2]
}
...
!53 = metadata !{metadata !"iicData", metadata !54, metadata !"unsigned int", i32 0, i32 31}
!54 = metadata !{metadata !55}
!55 = metadata !{i32 0, i32 0, i32 1}
!56 = metadata !{metadata !57}
!57 = metadata !{i32 0, i32 31, metadata !58}
!58 = metadata !{metadata !59}
!59 = metadata !{metadata !"iicStatus", metadata !54, metadata !"int", i32 0, i32 31}
!60 = metadata !{i32 786689, metadata !5, metadata !"iicData", metadata !6, i32 16777253, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!61 = metadata !{i32 37, i32 36, metadata !5, null}
!62 = metadata !{i32 786689, metadata !5, metadata !"iicStatus", metadata !6, i32 33554469, metadata !12, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!63 = metadata !{i32 37, i32 59, metadata !5, null}
!64 = metadata !{i32 39, i32 1, metadata !65, null}
!65 = metadata !{i32 786443, metadata !5, i32 37, i32 69, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 40, i32 1, metadata !65, null}
!67 = metadata !{i32 41, i32 1, metadata !65, null}
!68 = metadata !{i32 49, i32 2, metadata !65, null}
!69 = metadata !{i32 50, i32 2, metadata !65, null}
!70 = metadata !{i32 52, i32 2, metadata !65, null}
