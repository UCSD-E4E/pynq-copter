...
define void @_Z6sensorPVjRVi(i32* %iicData, i32* %iicStatus) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{i32** %1}, metadata !50), !dbg !51 ; [debug line = 37:36] [debug variable = iicData]
  store i32* %iicStatus, i32** %2, align 8
  call void @llvm.dbg.declare(metadata !{i32** %2}, metadata !52), !dbg !53 ; [debug line = 37:59] [debug variable = iicStatus]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 39:1]
  %3 = load i32** %2, align 8, !dbg !56           ; [#uses=1 type=i32*] [debug line = 40:1]
  %4 = load volatile i32* %3, align 4, !dbg !56   ; [#uses=1 type=i32] [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %4, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !56 ; [debug line = 40:1]
  %5 = load i32** %1, align 8, !dbg !57           ; [#uses=1 type=i32*] [debug line = 41:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %5, i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([11 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !57 ; [debug line = 41:1]
  %6 = load i32** %1, align 8, !dbg !58           ; [#uses=1 type=i32*] [debug line = 49:2]
  %7 = getelementptr inbounds i32* %6, i64 65, !dbg !58 ; [#uses=1 type=i32*] [debug line = 49:2]
  %8 = load volatile i32* %7, align 4, !dbg !58   ; [#uses=1 type=i32] [debug line = 49:2]
  store i32 %8, i32* @_ZL6status, align 4, !dbg !58 ; [debug line = 49:2]
  %9 = load i32* @_ZL6status, align 4, !dbg !59   ; [#uses=1 type=i32] [debug line = 50:2]
  %10 = load i32** %2, align 8, !dbg !59          ; [#uses=1 type=i32*] [debug line = 50:2]
  store volatile i32 %9, i32* %10, align 4, !dbg !59 ; [debug line = 50:2]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"sensor", metadata !"sensor", metadata !"_Z6sensorPVjRVi", metadata !6, i32 37, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @_Z6sensorPVjRVi, null, null, metadata !15, i32 37} ; [ DW_TAG_subprogram ]
...
!19 = metadata !{i32 786484, i32 0, null, metadata !"status", metadata !"status", metadata !"_ZL6status", metadata !6, i32 35, metadata !14, i32 1, i32 1, i32* @_ZL6status} ; [ DW_TAG_variable ]
