...
set Vendor      "UCSD"
set Library     "hlsip"
set IPName      "iiccomm2update"
set Version     "1.0"
set DisplayName "Iiccomm2update"
set Revision    "1808252002"
set Description "HLS Core: Iiccomm2update Function"
set Device      "zynq"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 empty_pirq_outValue R 0x0 "Data signal of empty_pirq_outValue" {{0 32 empty_pirq_outValue R 0 "Bit 31 to 0 Data signal of empty_pirq_outValue"}}} {0x14 empty_pirq_outValue_ctrl R 0x0 "Control signal of empty_pirq_outValue" {{0 1 empty_pirq_outValue_ap_vld R 0 "Control signal empty_pirq_outValue_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 full_pirq_outValue R 0x0 "Data signal of full_pirq_outValue" {{0 32 full_pirq_outValue R 0 "Bit 31 to 0 Data signal of full_pirq_outValue"}}} {0x1c full_pirq_outValue_ctrl R 0x0 "Control signal of full_pirq_outValue" {{0 1 full_pirq_outValue_ap_vld R 0 "Control signal full_pirq_outValue_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 ctrl_reg_outValue R 0x0 "Data signal of ctrl_reg_outValue" {{0 32 ctrl_reg_outValue R 0 "Bit 31 to 0 Data signal of ctrl_reg_outValue"}}} {0x24 ctrl_reg_outValue_ctrl R 0x0 "Control signal of ctrl_reg_outValue" {{0 1 ctrl_reg_outValue_ap_vld R 0 "Control signal ctrl_reg_outValue_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 stat_reg_outValue1 R 0x0 "Data signal of stat_reg_outValue1" {{0 32 stat_reg_outValue1 R 0 "Bit 31 to 0 Data signal of stat_reg_outValue1"}}} {0x2c stat_reg_outValue1_ctrl R 0x0 "Control signal of stat_reg_outValue1" {{0 1 stat_reg_outValue1_ap_vld R 0 "Control signal stat_reg_outValue1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 stat_reg_val2 R 0x0 "Data signal of stat_reg_val2" {{0 32 stat_reg_val2 R 0 "Bit 31 to 0 Data signal of stat_reg_val2"}}} {0x34 stat_reg_val2_ctrl R 0x0 "Control signal of stat_reg_val2" {{0 1 stat_reg_val2_ap_vld R 0 "Control signal stat_reg_val2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 pressure_msb R 0x0 "Data signal of pressure_msb" {{0 32 pressure_msb R 0 "Bit 31 to 0 Data signal of pressure_msb"}}} {0x3c pressure_msb_ctrl R 0x0 "Control signal of pressure_msb" {{0 1 pressure_msb_ap_vld R 0 "Control signal pressure_msb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 pressure_lsb R 0x0 "Data signal of pressure_lsb" {{0 32 pressure_lsb R 0 "Bit 31 to 0 Data signal of pressure_lsb"}}} {0x44 pressure_lsb_ctrl R 0x0 "Control signal of pressure_lsb" {{0 1 pressure_lsb_ap_vld R 0 "Control signal pressure_lsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 pressure_xlsb R 0x0 "Data signal of pressure_xlsb" {{0 32 pressure_xlsb R 0 "Bit 31 to 0 Data signal of pressure_xlsb"}}} {0x4c pressure_xlsb_ctrl R 0x0 "Control signal of pressure_xlsb" {{0 1 pressure_xlsb_ap_vld R 0 "Control signal pressure_xlsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 temp_msb R 0x0 "Data signal of temp_msb" {{0 32 temp_msb R 0 "Bit 31 to 0 Data signal of temp_msb"}}} {0x54 temp_msb_ctrl R 0x0 "Control signal of temp_msb" {{0 1 temp_msb_ap_vld R 0 "Control signal temp_msb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 temp_lsb R 0x0 "Data signal of temp_lsb" {{0 32 temp_lsb R 0 "Bit 31 to 0 Data signal of temp_lsb"}}} {0x5c temp_lsb_ctrl R 0x0 "Control signal of temp_lsb" {{0 1 temp_lsb_ap_vld R 0 "Control signal temp_lsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 temp_xlsb R 0x0 "Data signal of temp_xlsb" {{0 32 temp_xlsb R 0 "Bit 31 to 0 Data signal of temp_xlsb"}}} {0x64 temp_xlsb_ctrl R 0x0 "Control signal of temp_xlsb" {{0 1 temp_xlsb_ap_vld R 0 "Control signal temp_xlsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 press_raw R 0x0 "Data signal of press_raw" {{0 32 press_raw R 0 "Bit 31 to 0 Data signal of press_raw"}}} {0x6c press_raw_ctrl R 0x0 "Control signal of press_raw" {{0 1 press_raw_ap_vld R 0 "Control signal press_raw_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 temp_raw R 0x0 "Data signal of temp_raw" {{0 32 temp_raw R 0 "Bit 31 to 0 Data signal of temp_raw"}}} {0x74 temp_raw_ctrl R 0x0 "Control signal of temp_raw" {{0 1 temp_raw_ap_vld R 0 "Control signal temp_raw_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 operation R 0x0 "Data signal of operation" {{0 32 operation R 0 "Bit 31 to 0 Data signal of operation"}}} {0x7c operation_ctrl R 0x0 "Control signal of operation" {{0 1 operation_ap_vld R 0 "Control signal operation_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 press_cal R 0x0 "Data signal of press_cal" {{0 32 press_cal R 0 "Bit 31 to 0 Data signal of press_cal"}}} {0x84 press_cal_ctrl R 0x0 "Control signal of press_cal" {{0 1 press_cal_ap_vld R 0 "Control signal press_cal_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 press_act R 0x0 "Data signal of press_act" {{0 32 press_act R 0 "Bit 31 to 0 Data signal of press_act"}}} {0x8c press_act_ctrl R 0x0 "Control signal of press_act" {{0 1 press_act_ap_vld R 0 "Control signal press_act_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 basepoint_i W 0x0 "Data signal of basepoint_i" {{0 32 basepoint_i W 0 "Bit 31 to 0 Data signal of basepoint_i"}}} {0x98 basepoint_o R 0x0 "Data signal of basepoint_o" {{0 32 basepoint_o R 0 "Bit 31 to 0 Data signal of basepoint_o"}}} {0x9c basepoint_o_ctrl R 0x0 "Control signal of basepoint_o" {{0 1 basepoint_o_ap_vld R 0 "Control signal basepoint_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 flag R 0x0 "Data signal of flag" {{0 32 flag R 0 "Bit 31 to 0 Data signal of flag"}}} {0xa4 flag_ctrl R 0x0 "Control signal of flag" {{0 1 flag_ap_vld R 0 "Control signal flag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 pressure_diff R 0x0 "Data signal of pressure_diff" {{0 32 pressure_diff R 0 "Bit 31 to 0 Data signal of pressure_diff"}}} {0xac pressure_diff_ctrl R 0x0 "Control signal of pressure_diff" {{0 1 pressure_diff_ap_vld R 0 "Control signal pressure_diff_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 flag2 R 0x0 "Data signal of flag2" {{0 32 flag2 R 0 "Bit 31 to 0 Data signal of flag2"}}} {0xb4 flag2_ctrl R 0x0 "Control signal of flag2" {{0 1 flag2_ap_vld R 0 "Control signal flag2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 flag3 R 0x0 "Data signal of flag3" {{0 32 flag3 R 0 "Bit 31 to 0 Data signal of flag3"}}} {0xbc flag3_ctrl R 0x0 "Control signal of flag3" {{0 1 flag3_ap_vld R 0 "Control signal flag3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 basepointVal R 0x0 "Data signal of basepointVal" {{0 32 basepointVal R 0 "Bit 31 to 0 Data signal of basepointVal"}}} {0xc4 basepointVal_ctrl R 0x0 "Control signal of basepointVal" {{0 1 basepointVal_ap_vld R 0 "Control signal basepointVal_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 basepoint0 R 0x0 "Data signal of basepoint0" {{0 32 basepoint0 R 0 "Bit 31 to 0 Data signal of basepoint0"}}} {0xcc basepoint0_ctrl R 0x0 "Control signal of basepoint0" {{0 1 basepoint0_ap_vld R 0 "Control signal basepoint0_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 basepoint9 R 0x0 "Data signal of basepoint9" {{0 32 basepoint9 R 0 "Bit 31 to 0 Data signal of basepoint9"}}} {0xd4 basepoint9_ctrl R 0x0 "Control signal of basepoint9" {{0 1 basepoint9_ap_vld R 0 "Control signal basepoint9_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
