...
#ifndef __iiccomm2update_muyd2__HH__
#define __iiccomm2update_muyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_muyd2) {
    ...
    SC_CTOR(iiccomm2update_muyd2):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
