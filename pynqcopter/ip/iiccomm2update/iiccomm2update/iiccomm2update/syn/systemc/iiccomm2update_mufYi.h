...
#ifndef __iiccomm2update_mufYi__HH__
#define __iiccomm2update_mufYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_mufYi) {
    ...
    SC_CTOR(iiccomm2update_mufYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
