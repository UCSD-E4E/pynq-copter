...
#ifndef __iiccomm2update_lswdI__HH__
#define __iiccomm2update_lswdI__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_lswdI) {
    ...
    SC_CTOR(iiccomm2update_lswdI):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
