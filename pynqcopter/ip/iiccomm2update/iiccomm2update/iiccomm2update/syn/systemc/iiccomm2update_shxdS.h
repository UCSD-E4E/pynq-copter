...
#ifndef __iiccomm2update_shxdS__HH__
#define __iiccomm2update_shxdS__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_shxdS) {
    ...
    SC_CTOR(iiccomm2update_shxdS):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
