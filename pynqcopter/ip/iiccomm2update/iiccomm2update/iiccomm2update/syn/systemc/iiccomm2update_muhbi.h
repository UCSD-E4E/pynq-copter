...
#ifndef __iiccomm2update_muhbi__HH__
#define __iiccomm2update_muhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_muhbi) {
    ...
    SC_CTOR(iiccomm2update_muhbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
