...
#ifndef __iiccomm2update_mutde__HH__
#define __iiccomm2update_mutde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_mutde) {
    ...
    SC_CTOR(iiccomm2update_mutde):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
