...
#ifndef __iiccomm2update_mukbM__HH__
#define __iiccomm2update_mukbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_mukbM) {
    ...
    SC_CTOR(iiccomm2update_mukbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
