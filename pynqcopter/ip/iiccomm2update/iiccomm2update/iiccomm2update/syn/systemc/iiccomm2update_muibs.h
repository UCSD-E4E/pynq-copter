...
#ifndef __iiccomm2update_muibs__HH__
#define __iiccomm2update_muibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(iiccomm2update_muibs) {
    ...
    SC_CTOR(iiccomm2update_muibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
