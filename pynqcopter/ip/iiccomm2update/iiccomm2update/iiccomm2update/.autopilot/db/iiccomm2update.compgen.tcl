...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler iiccomm2update_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler iiccomm2update_iic_m_axi
}
