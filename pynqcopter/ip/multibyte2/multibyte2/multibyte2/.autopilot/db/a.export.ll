...
; <label>:2                                       ; preds = %1
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %stateSetUp, i32 100)
...
; <label>:3                                       ; preds = %4, %2
  ...
  br i1 %tmp_5, label %"delay_until_ms<50ull, 100000000ull>.exit19", label %4
...
; <label>:5                                       ; preds = %6, %"delay_until_ms<50ull, 100000000ull>.exit19"
  ...
  br i1 %tmp_7, label %"delay_until_ms<50ull, 100000000ull>.exit14", label %6
...
; <label>:11                                      ; preds = %12, %"delay_until_ms<10ull, 100000000ull>.exit38"
  ...
  %tmp_4 = icmp eq i28 %p_014_0_i4, -93435456
...
"delay_until_ms<1750ull, 100000000ull>.exit":     ; preds = %11
  ...
  %tmp_6 = icmp eq i32 %CTRL_addr_58_read, 96
  br i1 %tmp_6, label %13, label %.loopexit
...
; <label>:13                                      ; preds = %"delay_until_ms<1750ull, 100000000ull>.exit"
  ...
  %CTRL_addr_2_req34 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_59, i32 1)
  ...
  %CTRL_addr_2_resp35 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_61)
  %CTRL_addr_62 = getelementptr i32* %CTRL, i64 268436546
  %CTRL_addr_2_req36 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_62, i32 1)
  ...
  %CTRL_addr_2_resp37 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_64)
  %CTRL_addr_65 = getelementptr i32* %CTRL, i64 268436546
  %CTRL_addr_2_req38 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_65, i32 1)
  ...
  %CTRL_addr_2_resp39 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_67)
  %CTRL_addr_68 = getelementptr i32* %CTRL, i64 268436546
  %CTRL_addr_2_req40 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_68, i32 1)
  ...
  %CTRL_addr_2_resp41 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_70)
...
; <label>:16                                      ; preds = %17, %"delay_until_ms<10ull, 100000000ull>.exit33"
  ...
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 24, i64 24, i64 24) nounwind
...
; <label>:18                                      ; preds = %19, %.loopexit
  ...
  %empty_17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5000000, i64 5000000, i64 5000000) nounwind
...
._crit_edge:                                      ; preds = %"delay_until_ms<50ull, 100000000ull>.exit", %1
  %trimmingData_addr_2 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 0
  %trimmingData_load = load i16* %trimmingData_addr_2, align 16
  %tmp_13 = zext i16 %trimmingData_load to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal1, i32 %tmp_13)
  %trimmingData_addr_3 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 1
  %trimmingData_load_1 = load i16* %trimmingData_addr_3, align 2
  %tmp_14 = zext i16 %trimmingData_load_1 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal2, i32 %tmp_14)
  %trimmingData_addr_4 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 2
  %trimmingData_load_2 = load i16* %trimmingData_addr_4, align 4
  %tmp_15 = zext i16 %trimmingData_load_2 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal3, i32 %tmp_15)
  %trimmingData_addr_5 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 3
  %trimmingData_load_3 = load i16* %trimmingData_addr_5, align 2
  %tmp_16 = zext i16 %trimmingData_load_3 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal4, i32 %tmp_16)
  %trimmingData_addr_6 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 4
  %trimmingData_load_4 = load i16* %trimmingData_addr_6, align 8
  %tmp_17 = zext i16 %trimmingData_load_4 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal5, i32 %tmp_17)
  %trimmingData_addr_7 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 5
  %trimmingData_load_5 = load i16* %trimmingData_addr_7, align 2
  %tmp_18 = zext i16 %trimmingData_load_5 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal6, i32 %tmp_18)
  %trimmingData_addr_8 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 22
  %trimmingData_load_6 = load i16* %trimmingData_addr_8, align 4
  %tmp_19 = zext i16 %trimmingData_load_6 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal23, i32 %tmp_19)
  %trimmingData_addr_9 = getelementptr inbounds [24 x i16]* %trimmingData, i64 0, i64 23
  %trimmingData_load_7 = load i16* %trimmingData_addr_9, align 2
  %tmp_20 = zext i16 %trimmingData_load_7 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %trimVal24, i32 %tmp_20)
  %tmp_21 = shl i16 %trimmingData_load_1, 8
  %tmp_23 = or i16 %trimmingData_load, %tmp_21
  %tmp_28 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %trimmingData_load_1, i32 8, i32 15)
  %tmp_29 = call i24 @_ssdm_op_BitConcatenate.i24.i8.i16(i8 %tmp_28, i16 %tmp_23)
  %tmp_22 = zext i24 %tmp_29 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %dig_T1, i32 %tmp_22)
  %tmp_31 = shl i16 %trimmingData_load_7, 8
  %tmp_33 = or i16 %trimmingData_load_6, %tmp_31
  %tmp_34 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %trimmingData_load_7, i32 8, i32 15)
  %tmp_36 = call i24 @_ssdm_op_BitConcatenate.i24.i8.i16(i8 %tmp_34, i16 %tmp_33)
  %tmp_24 = zext i24 %tmp_36 to i32
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %dig_P9, i32 %tmp_24)
  ...
  %CTRL_addr_4_req42 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_76, i32 1)
  ...
  %CTRL_addr_4_resp43 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_78)
  %CTRL_addr_79 = getelementptr i32* %CTRL, i64 268436546
  %CTRL_addr_4_req44 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_79, i32 1)
  ...
  %CTRL_addr_4_resp45 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_81)
  %CTRL_addr_82 = getelementptr i32* %CTRL, i64 268436546
  %CTRL_addr_4_req46 = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %CTRL_addr_82, i32 1)
  ...
  %CTRL_addr_4_resp47 = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %CTRL_addr_84)
...
; <label>:23                                      ; preds = %22
  ...
  %tmp_26 = zext i3 %index1 to i64
  %sensorData_addr_1 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 %tmp_26
...
"delay_until_ms<10ull, 100000000ull>.exit":       ; preds = %25
  ...
  %tmp_38 = shl i32 %sensorData_load, 12
  %tmp_39 = shl i32 %sensorData_load_1, 4
  %tmp_40 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %sensorData_load_2, i32 4, i32 31)
  %tmp_30 = sext i28 %tmp_40 to i32
  %tmp1 = or i32 %tmp_38, %tmp_30
  %tmp_32 = or i32 %tmp1, %tmp_39
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %pressureRaw, i32 %tmp_32)
  %tmp_41 = shl i32 %sensorData_load_3, 12
  %tmp_42 = shl i32 %sensorData_load_4, 4
  %tmp_43 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %sensorData_load_5, i32 4, i32 31)
  %tmp_35 = sext i28 %tmp_43 to i32
  %tmp2 = or i32 %tmp_41, %tmp_35
  %tmp_37 = or i32 %tmp2, %tmp_42
  call void @_ssdm_op_Write.s_axilite.i32P(i32* %temperatureRaw, i32 %tmp_37)
  ret void
}
...
entry:
  ...
  %empty_23 = zext i16 %1 to i24
  %empty_24 = shl i24 %empty, 16
