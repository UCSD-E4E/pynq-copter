set C_TypeInfoList {{ 
"multibyte2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": [ {"scalar": "int"}, [4096]]}] }, {"pressure_msb": [[], {"reference": "0"}] }, {"pressure_lsb": [[], {"reference": "0"}] }, {"pressure_xlsb": [[], {"reference": "0"}] }, {"temperature_msb": [[], {"reference": "0"}] }, {"temperature_lsb": [[], {"reference": "0"}] }, {"temperature_xlsb": [[], {"reference": "0"}] }, {"stateSetUp": [[], {"reference":  {"scalar": "int"}}] }, {"state": [[], {"reference":  {"scalar": "int"}}] }, {"stateDataReads": [[], {"reference":  {"scalar": "int"}}] }, {"trimmingSuccess": [[], {"reference":  {"scalar": "int"}}] }, {"dig_T1": [[], {"reference": "0"}] }, {"dig_T2": [[], {"reference": "0"}] }, {"dig_T3": [[], {"reference": "0"}] }, {"dig_P1": [[], {"reference": "0"}] }, {"dig_P2": [[], {"reference": "0"}] }, {"dig_P3": [[], {"reference": "0"}] }, {"dig_P4": [[], {"reference": "0"}] }, {"dig_P5": [[], {"reference": "0"}] }, {"dig_P6": [[], {"reference": "0"}] }, {"dig_P7": [[], {"reference": "0"}] }, {"dig_P8": [[], {"reference": "0"}] }, {"dig_P9": [[], {"reference": "0"}] }, {"pressureRaw": [[], {"reference": "0"}] }, {"temperatureRaw": [[], {"reference": "0"}] }, {"trimVal1": [[], {"reference": "0"}] }, {"trimVal2": [[], {"reference": "0"}] }, {"trimVal3": [[], {"reference": "0"}] }, {"trimVal4": [[], {"reference": "0"}] }, {"trimVal5": [[], {"reference": "0"}] }, {"trimVal6": [[], {"reference": "0"}] }, {"trimVal23": [[], {"reference": "0"}] }, {"trimVal24": [[], {"reference": "0"}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "CTRL", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "iic","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "dig_T1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_T1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":96}, "offset_end" : {"out":103}} , 
 	...
 	{ "Name" : "dig_P9", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dig_P9","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":104}, "offset_end" : {"out":111}} , 
 	{ "Name" : "pressureRaw", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "pressureRaw","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":112}, "offset_end" : {"out":119}} , 
 	{ "Name" : "temperatureRaw", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "temperatureRaw","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":120}, "offset_end" : {"out":127}} , 
 	{ "Name" : "trimVal1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal1","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":128}, "offset_end" : {"out":135}} , 
 	{ "Name" : "trimVal2", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal2","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":136}, "offset_end" : {"out":143}} , 
 	{ "Name" : "trimVal3", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal3","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":144}, "offset_end" : {"out":151}} , 
 	{ "Name" : "trimVal4", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal4","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":152}, "offset_end" : {"out":159}} , 
 	{ "Name" : "trimVal5", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal5","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":160}, "offset_end" : {"out":167}} , 
 	{ "Name" : "trimVal6", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal6","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":168}, "offset_end" : {"out":175}} , 
 	{ "Name" : "trimVal23", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal23","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":176}, "offset_end" : {"out":183}} , 
 	{ "Name" : "trimVal24", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "trimVal24","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":184}, "offset_end" : {"out":191}} ]}
...
set portList { 
	...
	{ dig_T2 sc_in sc_lv 32 signal 12 } 
	{ dig_T3 sc_in sc_lv 32 signal 13 } 
	{ dig_P1 sc_in sc_lv 32 signal 14 } 
	{ dig_P2 sc_in sc_lv 32 signal 15 } 
	{ dig_P3 sc_in sc_lv 32 signal 16 } 
	{ dig_P4 sc_in sc_lv 32 signal 17 } 
	{ dig_P5 sc_in sc_lv 32 signal 18 } 
	{ dig_P6 sc_in sc_lv 32 signal 19 } 
	{ dig_P7 sc_in sc_lv 32 signal 20 } 
	{ dig_P8 sc_in sc_lv 32 signal 21 } 
...
set ArgLastReadFirstWriteLatency {
	multibyte2 {
		CTRL {Type IO LastRead 99 FirstWrite 3}
		...
		stateSetUp {Type O LastRead -1 FirstWrite 3}
		state {Type I LastRead -1 FirstWrite -1}
		stateDataReads {Type O LastRead -1 FirstWrite 91}
		trimmingSuccess {Type O LastRead -1 FirstWrite 66}
		dig_T1 {Type O LastRead -1 FirstWrite 82}
		...
		dig_P9 {Type O LastRead -1 FirstWrite 82}
		pressureRaw {Type O LastRead -1 FirstWrite 97}
		temperatureRaw {Type O LastRead -1 FirstWrite 97}
		trimVal1 {Type O LastRead -1 FirstWrite 82}
		trimVal2 {Type O LastRead -1 FirstWrite 82}
		trimVal3 {Type O LastRead -1 FirstWrite 82}
		trimVal4 {Type O LastRead -1 FirstWrite 82}
		trimVal5 {Type O LastRead -1 FirstWrite 82}
		trimVal6 {Type O LastRead -1 FirstWrite 82}
		trimVal23 {Type O LastRead -1 FirstWrite 82}
		trimVal24 {Type O LastRead -1 FirstWrite 82}
		firstSample {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2000105", "Max" : "199000395"}
	, {"Name" : "Interval", "Min" : "2000106", "Max" : "199000396"}
]}
