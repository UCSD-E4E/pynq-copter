...
set Vendor      "UCSD"
set Library     "hlsip"
set IPName      "multibyte2"
set Version     "1.0"
set DisplayName "Multibyte2"
set Revision    "1808181729"
set Description "HLS Core: Multibyte2 Function"
set Device      "zynq"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 pressure_msb R 0x0 "Data signal of pressure_msb" {{0 32 pressure_msb R 0 "Bit 31 to 0 Data signal of pressure_msb"}}} {0x14 pressure_msb_ctrl R 0x0 "Control signal of pressure_msb" {{0 1 pressure_msb_ap_vld R 0 "Control signal pressure_msb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 pressure_lsb R 0x0 "Data signal of pressure_lsb" {{0 32 pressure_lsb R 0 "Bit 31 to 0 Data signal of pressure_lsb"}}} {0x1c pressure_lsb_ctrl R 0x0 "Control signal of pressure_lsb" {{0 1 pressure_lsb_ap_vld R 0 "Control signal pressure_lsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 pressure_xlsb R 0x0 "Data signal of pressure_xlsb" {{0 32 pressure_xlsb R 0 "Bit 31 to 0 Data signal of pressure_xlsb"}}} {0x24 pressure_xlsb_ctrl R 0x0 "Control signal of pressure_xlsb" {{0 1 pressure_xlsb_ap_vld R 0 "Control signal pressure_xlsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 temperature_msb R 0x0 "Data signal of temperature_msb" {{0 32 temperature_msb R 0 "Bit 31 to 0 Data signal of temperature_msb"}}} {0x2c temperature_msb_ctrl R 0x0 "Control signal of temperature_msb" {{0 1 temperature_msb_ap_vld R 0 "Control signal temperature_msb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 temperature_lsb R 0x0 "Data signal of temperature_lsb" {{0 32 temperature_lsb R 0 "Bit 31 to 0 Data signal of temperature_lsb"}}} {0x34 temperature_lsb_ctrl R 0x0 "Control signal of temperature_lsb" {{0 1 temperature_lsb_ap_vld R 0 "Control signal temperature_lsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 temperature_xlsb R 0x0 "Data signal of temperature_xlsb" {{0 32 temperature_xlsb R 0 "Bit 31 to 0 Data signal of temperature_xlsb"}}} {0x3c temperature_xlsb_ctrl R 0x0 "Control signal of temperature_xlsb" {{0 1 temperature_xlsb_ap_vld R 0 "Control signal temperature_xlsb_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 stateSetUp R 0x0 "Data signal of stateSetUp" {{0 32 stateSetUp R 0 "Bit 31 to 0 Data signal of stateSetUp"}}} {0x44 stateSetUp_ctrl R 0x0 "Control signal of stateSetUp" {{0 1 stateSetUp_ap_vld R 0 "Control signal stateSetUp_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 state W 0x0 "Data signal of state" {{0 32 state W 0 "Bit 31 to 0 Data signal of state"}}} {0x50 stateDataReads R 0x0 "Data signal of stateDataReads" {{0 32 stateDataReads R 0 "Bit 31 to 0 Data signal of stateDataReads"}}} {0x54 stateDataReads_ctrl R 0x0 "Control signal of stateDataReads" {{0 1 stateDataReads_ap_vld R 0 "Control signal stateDataReads_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 trimmingSuccess R 0x0 "Data signal of trimmingSuccess" {{0 32 trimmingSuccess R 0 "Bit 31 to 0 Data signal of trimmingSuccess"}}} {0x5c trimmingSuccess_ctrl R 0x0 "Control signal of trimmingSuccess" {{0 1 trimmingSuccess_ap_vld R 0 "Control signal trimmingSuccess_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 dig_T1 R 0x0 "Data signal of dig_T1" {{0 16 dig_T1 R 0 "Bit 15 to 0 Data signal of dig_T1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x64 dig_T1_ctrl R 0x0 "Control signal of dig_T1" {{0 1 dig_T1_ap_vld R 0 "Control signal dig_T1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 dig_T2 R 0x0 "Data signal of dig_T2" {{0 16 dig_T2 R 0 "Bit 15 to 0 Data signal of dig_T2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c dig_T2_ctrl R 0x0 "Control signal of dig_T2" {{0 1 dig_T2_ap_vld R 0 "Control signal dig_T2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 dig_T3 R 0x0 "Data signal of dig_T3" {{0 16 dig_T3 R 0 "Bit 15 to 0 Data signal of dig_T3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 dig_T3_ctrl R 0x0 "Control signal of dig_T3" {{0 1 dig_T3_ap_vld R 0 "Control signal dig_T3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 dig_P1 R 0x0 "Data signal of dig_P1" {{0 16 dig_P1 R 0 "Bit 15 to 0 Data signal of dig_P1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x7c dig_P1_ctrl R 0x0 "Control signal of dig_P1" {{0 1 dig_P1_ap_vld R 0 "Control signal dig_P1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 dig_P2 R 0x0 "Data signal of dig_P2" {{0 16 dig_P2 R 0 "Bit 15 to 0 Data signal of dig_P2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x84 dig_P2_ctrl R 0x0 "Control signal of dig_P2" {{0 1 dig_P2_ap_vld R 0 "Control signal dig_P2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 dig_P3 R 0x0 "Data signal of dig_P3" {{0 16 dig_P3 R 0 "Bit 15 to 0 Data signal of dig_P3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x8c dig_P3_ctrl R 0x0 "Control signal of dig_P3" {{0 1 dig_P3_ap_vld R 0 "Control signal dig_P3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 dig_P4 R 0x0 "Data signal of dig_P4" {{0 16 dig_P4 R 0 "Bit 15 to 0 Data signal of dig_P4"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x94 dig_P4_ctrl R 0x0 "Control signal of dig_P4" {{0 1 dig_P4_ap_vld R 0 "Control signal dig_P4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 dig_P5 R 0x0 "Data signal of dig_P5" {{0 16 dig_P5 R 0 "Bit 15 to 0 Data signal of dig_P5"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x9c dig_P5_ctrl R 0x0 "Control signal of dig_P5" {{0 1 dig_P5_ap_vld R 0 "Control signal dig_P5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 dig_P6 R 0x0 "Data signal of dig_P6" {{0 16 dig_P6 R 0 "Bit 15 to 0 Data signal of dig_P6"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xa4 dig_P6_ctrl R 0x0 "Control signal of dig_P6" {{0 1 dig_P6_ap_vld R 0 "Control signal dig_P6_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 dig_P7 R 0x0 "Data signal of dig_P7" {{0 16 dig_P7 R 0 "Bit 15 to 0 Data signal of dig_P7"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xac dig_P7_ctrl R 0x0 "Control signal of dig_P7" {{0 1 dig_P7_ap_vld R 0 "Control signal dig_P7_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 dig_P8 R 0x0 "Data signal of dig_P8" {{0 16 dig_P8 R 0 "Bit 15 to 0 Data signal of dig_P8"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xb4 dig_P8_ctrl R 0x0 "Control signal of dig_P8" {{0 1 dig_P8_ap_vld R 0 "Control signal dig_P8_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 dig_P9 R 0x0 "Data signal of dig_P9" {{0 16 dig_P9 R 0 "Bit 15 to 0 Data signal of dig_P9"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xbc dig_P9_ctrl R 0x0 "Control signal of dig_P9" {{0 1 dig_P9_ap_vld R 0 "Control signal dig_P9_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 pressureRaw R 0x0 "Data signal of pressureRaw" {{0 32 pressureRaw R 0 "Bit 31 to 0 Data signal of pressureRaw"}}} {0xc4 pressureRaw_ctrl R 0x0 "Control signal of pressureRaw" {{0 1 pressureRaw_ap_vld R 0 "Control signal pressureRaw_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 temperatureRaw R 0x0 "Data signal of temperatureRaw" {{0 32 temperatureRaw R 0 "Bit 31 to 0 Data signal of temperatureRaw"}}} {0xcc temperatureRaw_ctrl R 0x0 "Control signal of temperatureRaw" {{0 1 temperatureRaw_ap_vld R 0 "Control signal temperatureRaw_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 2000113 II x}
