...
architecture behav of iiccomm4 is 
    ...
    "iiccomm4,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=1728,HLS_SYN_LUT=2378}";
    ...
    signal ctr_V_fu_1073_p2 : STD_LOGIC_VECTOR (24 downto 0);
    ...
    signal p_014_0_i_reg_725 : STD_LOGIC_VECTOR (24 downto 0);
    ...
    component iiccomm4_mux_42_3bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    iiccomm4_mux_42_3bkb_U1 : component iiccomm4_mux_42_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    iiccomm4_mux_42_3bkb_U2 : component iiccomm4_mux_42_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    iiccomm4_mux_42_3bkb_U3 : component iiccomm4_mux_42_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    ctr_V_fu_1073_p2 <= std_logic_vector(unsigned(p_014_0_i_reg_725) + unsigned(ap_const_lv25_1));
    ...
    tmp_2_fu_1067_p2 <= "1" when (p_014_0_i_reg_725 = ap_const_lv25_1C9C380) else "0";
