...
@delay_until_ms_MD_600ull_MC__AC_50000000ull_OD__OC_region.str = internal unnamed_addr constant [43 x i8] c"delay_until_ms<600ull, 50000000ull>.region\00" ; [#uses=2 type=[43 x i8]*]
...
@.str1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=87 type=[1 x i8]*]
@.str = private unnamed_addr constant [10 x i8] c"s_axilite\00", align 1 ; [#uses=13 type=[10 x i8]*]
...
; [#uses=0]
define void @iiccomm4([4096 x i32]* %iic, i32* %empty_pirq_outValue, i32* %full_pirq_outValue, i32* %ctrl_reg_outValue, i32* %stat_reg_outValue1, i32* %stat_reg_val2, i32* %pressure_msb, i32* %pressure_lsb, i32* %pressure_xlsb, i32* %temp_msb, i32* %temp_lsb, i32* %temp_xlsb, i32* %operation) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %temp_msb) nounwind, !map !3732
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %temp_lsb) nounwind, !map !3736
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %temp_xlsb) nounwind, !map !3740
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %operation) nounwind, !map !3744
  ...
  call void @llvm.dbg.value(metadata !{[4096 x i32]* %iic}, i64 0, metadata !3748), !dbg !3752 ; [debug line = 40:33] [debug variable = iic]
  call void @llvm.dbg.value(metadata !{i32* %empty_pirq_outValue}, i64 0, metadata !3753), !dbg !3754 ; [debug line = 41:12] [debug variable = empty_pirq_outValue]
  call void @llvm.dbg.value(metadata !{i32* %full_pirq_outValue}, i64 0, metadata !3755), !dbg !3756 ; [debug line = 41:43] [debug variable = full_pirq_outValue]
  call void @llvm.dbg.value(metadata !{i32* %ctrl_reg_outValue}, i64 0, metadata !3757), !dbg !3758 ; [debug line = 41:73] [debug variable = ctrl_reg_outValue]
  call void @llvm.dbg.value(metadata !{i32* %stat_reg_outValue1}, i64 0, metadata !3759), !dbg !3760 ; [debug line = 42:12] [debug variable = stat_reg_outValue1]
  call void @llvm.dbg.value(metadata !{i32* %stat_reg_val2}, i64 0, metadata !3761), !dbg !3762 ; [debug line = 42:42] [debug variable = stat_reg_val2]
  call void @llvm.dbg.value(metadata !{i32* %pressure_msb}, i64 0, metadata !3763), !dbg !3764 ; [debug line = 43:12] [debug variable = pressure_msb]
  call void @llvm.dbg.value(metadata !{i32* %pressure_lsb}, i64 0, metadata !3765), !dbg !3766 ; [debug line = 43:36] [debug variable = pressure_lsb]
  call void @llvm.dbg.value(metadata !{i32* %pressure_xlsb}, i64 0, metadata !3767), !dbg !3768 ; [debug line = 43:60] [debug variable = pressure_xlsb]
  call void @llvm.dbg.value(metadata !{i32* %temp_msb}, i64 0, metadata !3769), !dbg !3770 ; [debug line = 44:12] [debug variable = temp_msb]
  call void @llvm.dbg.value(metadata !{i32* %temp_lsb}, i64 0, metadata !3771), !dbg !3772 ; [debug line = 44:32] [debug variable = temp_lsb]
  call void @llvm.dbg.value(metadata !{i32* %temp_xlsb}, i64 0, metadata !3773), !dbg !3774 ; [debug line = 44:52] [debug variable = temp_xlsb]
  call void @llvm.dbg.value(metadata !{i32* %operation}, i64 0, metadata !3775), !dbg !3776 ; [debug line = 45:12] [debug variable = operation]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3777 ; [debug line = 47:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %empty_pirq_outValue, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3779 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %full_pirq_outValue, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3780 ; [debug line = 52:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %ctrl_reg_outValue, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3781 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %stat_reg_outValue1, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3782 ; [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %stat_reg_val2, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3783 ; [debug line = 55:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %operation, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3784 ; [debug line = 56:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %pressure_msb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3785 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %pressure_lsb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3786 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %pressure_xlsb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3787 ; [debug line = 59:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %temp_msb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3788 ; [debug line = 60:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %temp_lsb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3789 ; [debug line = 61:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %temp_xlsb, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3790 ; [debug line = 62:1]
  call void @llvm.dbg.declare(metadata !{[6 x i32]* %sensorData}, metadata !3791), !dbg !3795 ; [debug line = 70:11] [debug variable = sensorData]
  br label %meminst

meminst:                                          ; preds = %meminst, %0
  %invdar = phi i3 [ 0, %0 ], [ %indvarinc, %meminst ] ; [#uses=3 type=i3]
  %indvarinc = add i3 %invdar, 1, !dbg !3796      ; [#uses=1 type=i3] [debug line = 70:29]
  %tmp = zext i3 %invdar to i64, !dbg !3796       ; [#uses=1 type=i64] [debug line = 70:29]
  %sensorData.addr = getelementptr [6 x i32]* %sensorData, i64 0, i64 %tmp, !dbg !3796 ; [#uses=1 type=i32*] [debug line = 70:29]
  store i32 0, i32* %sensorData.addr, align 4, !dbg !3796 ; [debug line = 70:29]
  %tmp.1 = icmp eq i3 %invdar, -3, !dbg !3796     ; [#uses=1 type=i1] [debug line = 70:29]
  ...
  br i1 %tmp.1, label %3, label %meminst, !dbg !3796 ; [debug line = 70:29]

; <label>:3                                       ; preds = %meminst
  %iic.addr = getelementptr [4096 x i32]* %iic, i64 0, i64 268436552, !dbg !3797 ; [#uses=3 type=i32*] [debug line = 74:2]
  %iic.load = load volatile i32* %iic.addr, align 4, !dbg !3797 ; [#uses=1 type=i32] [debug line = 74:2]
  store i32 %iic.load, i32* %empty_pirq_outValue, align 4, !dbg !3798 ; [debug line = 75:2]
  store volatile i32 15, i32* %iic.addr, align 4, !dbg !3799 ; [debug line = 78:2]
  %iic.load.1 = load volatile i32* %iic.addr, align 4, !dbg !3800 ; [#uses=1 type=i32] [debug line = 79:2]
  store i32 %iic.load.1, i32* %full_pirq_outValue, align 4, !dbg !3801 ; [debug line = 80:2]
  %iic.addr.1 = getelementptr [4096 x i32]* %iic, i64 0, i64 268436544, !dbg !3802 ; [#uses=3 type=i32*] [debug line = 83:2]
  store volatile i32 2, i32* %iic.addr.1, align 4, !dbg !3802 ; [debug line = 83:2]
  store volatile i32 1, i32* %iic.addr.1, align 4, !dbg !3803 ; [debug line = 86:2]
  %iic.load.2 = load volatile i32* %iic.addr.1, align 4, !dbg !3804 ; [#uses=1 type=i32] [debug line = 87:2]
  store i32 %iic.load.2, i32* %ctrl_reg_outValue, align 4, !dbg !3805 ; [debug line = 88:2]
  %iic.addr.2 = getelementptr [4096 x i32]* %iic, i64 0, i64 268436545, !dbg !3806 ; [#uses=3 type=i32*] [debug line = 91:5]
  %iic.load.3 = load volatile i32* %iic.addr.2, align 4, !dbg !3806 ; [#uses=1 type=i32] [debug line = 91:5]
  store i32 %iic.load.3, i32* %stat_reg_outValue1, align 4, !dbg !3807 ; [debug line = 92:5]
  %iic.addr.3 = getelementptr [4096 x i32]* %iic, i64 0, i64 268436546, !dbg !3808 ; [#uses=16 type=i32*] [debug line = 96:2]
  store volatile i32 492, i32* %iic.addr.3, align 4, !dbg !3808 ; [debug line = 96:2]
  store volatile i32 224, i32* %iic.addr.3, align 4, !dbg !3809 ; [debug line = 97:2]
  store volatile i32 182, i32* %iic.addr.3, align 4, !dbg !3810 ; [debug line = 98:2]
  store volatile i32 492, i32* %iic.addr.3, align 4, !dbg !3811 ; [debug line = 101:2]
  store volatile i32 242, i32* %iic.addr.3, align 4, !dbg !3812 ; [debug line = 102:2]
  store volatile i32 0, i32* %iic.addr.3, align 4, !dbg !3813 ; [debug line = 103:2]
  store volatile i32 492, i32* %iic.addr.3, align 4, !dbg !3814 ; [debug line = 106:2]
  store volatile i32 244, i32* %iic.addr.3, align 4, !dbg !3815 ; [debug line = 107:2]
  store volatile i32 39, i32* %iic.addr.3, align 4, !dbg !3816 ; [debug line = 108:2]
  store volatile i32 492, i32* %iic.addr.3, align 4, !dbg !3817 ; [debug line = 111:2]
  store volatile i32 245, i32* %iic.addr.3, align 4, !dbg !3818 ; [debug line = 112:2]
  store volatile i32 32, i32* %iic.addr.3, align 4, !dbg !3819 ; [debug line = 113:2]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin([43 x i8]* @delay_until_ms_MD_600ull_MC__AC_50000000ull_OD__OC_region.str) nounwind ; [#uses=1 type=i32]
  call void (...)* @_ssdm_op_SpecProtocol(i32 0, [1 x i8]* @.str1) nounwind, !dbg !3820 ; [debug line = 57:1@115:2]
  br label %4, !dbg !3823                         ; [debug line = 61:10@115:2]

; <label>:4                                       ; preds = %6, %3
  %.014.0.i = phi i25 [ 0, %3 ], [ %ctr.V, %6 ]   ; [#uses=2 type=i25]
  %tmp.2 = icmp eq i25 %.014.0.i, -3554432, !dbg !3825 ; [#uses=1 type=i1] [debug line = 2042:5@61:19@115:2]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 30000000, i64 30000000, i64 30000000) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.2, label %"delay_until_ms<600ull, 50000000ull>.exit", label %6, !dbg !3827 ; [debug line = 61:19@115:2]

; <label>:6                                       ; preds = %4
  call void @llvm.dbg.value(metadata !{i8* %dummy}, i64 0, metadata !3828) nounwind, !dbg !3830 ; [debug line = 62:9@115:2] [debug variable = dummy]
  %dummy.1 = load volatile i8* %dummy, align 1, !dbg !3830 ; [#uses=1 type=i8] [debug line = 62:9@115:2]
  call void @llvm.dbg.value(metadata !{i8 %dummy.1}, i64 0, metadata !3828) nounwind, !dbg !3830 ; [debug line = 62:9@115:2] [debug variable = dummy]
  store volatile i8 %dummy.1, i8* %dummy, align 1, !dbg !3830 ; [debug line = 62:9@115:2]
  %ctr.V = add i25 %.014.0.i, 1, !dbg !3832       ; [#uses=1 type=i25] [debug line = 1879:145@1896:5@61:30@115:2]
  call void @llvm.dbg.value(metadata !{i25 %ctr.V}, i64 0, metadata !3837) nounwind, !dbg !3832 ; [debug line = 1879:145@1896:5@61:30@115:2] [debug variable = ctr.V]
  br label %4, !dbg !3836                         ; [debug line = 61:30@115:2]

"delay_until_ms<600ull, 50000000ull>.exit":       ; preds = %4
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd([43 x i8]* @delay_until_ms_MD_600ull_MC__AC_50000000ull_OD__OC_region.str, i32 %rbegin) nounwind ; [#uses=0 type=i32]
  store volatile i32 492, i32* %iic.addr.3, align 4, !dbg !3845 ; [debug line = 120:2]
  store volatile i32 247, i32* %iic.addr.3, align 4, !dbg !3846 ; [debug line = 123:2]
  store volatile i32 493, i32* %iic.addr.3, align 4, !dbg !3847 ; [debug line = 126:2]
  store volatile i32 518, i32* %iic.addr.3, align 4, !dbg !3848 ; [debug line = 129:2]
  ...
  call void (...)* @_ssdm_op_SpecProtocol(i32 0, [1 x i8]* @.str1) nounwind, !dbg !3849 ; [debug line = 57:1@134:2]
  br label %7, !dbg !3852                         ; [debug line = 61:10@134:2]

; <label>:7                                       ; preds = %9, %"delay_until_ms<600ull, 50000000ull>.exit"
  %.014.0.i9 = phi i19 [ 0, %"delay_until_ms<600ull, 50000000ull>.exit" ], [ %ctr.V.1, %9 ] ; [#uses=2 type=i19]
  %tmp.4 = icmp eq i19 %.014.0.i9, -24288, !dbg !3854 ; [#uses=1 type=i1] [debug line = 2042:5@61:19@134:2]
  %8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 500000, i64 500000, i64 500000) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.4, label %"delay_until_ms<10ull, 50000000ull>.exit10", label %9, !dbg !3855 ; [debug line = 61:19@134:2]

; <label>:9                                       ; preds = %7
  call void @llvm.dbg.value(metadata !{i8* %dummy.2}, i64 0, metadata !3856) nounwind, !dbg !3857 ; [debug line = 62:9@134:2] [debug variable = dummy]
  %dummy.3 = load volatile i8* %dummy.2, align 1, !dbg !3857 ; [#uses=1 type=i8] [debug line = 62:9@134:2]
  call void @llvm.dbg.value(metadata !{i8 %dummy.3}, i64 0, metadata !3856) nounwind, !dbg !3857 ; [debug line = 62:9@134:2] [debug variable = dummy]
  store volatile i8 %dummy.3, i8* %dummy.2, align 1, !dbg !3857 ; [debug line = 62:9@134:2]
  %ctr.V.1 = add i19 %.014.0.i9, 1, !dbg !3859    ; [#uses=1 type=i19] [debug line = 1879:145@1896:5@61:30@134:2]
  call void @llvm.dbg.value(metadata !{i19 %ctr.V.1}, i64 0, metadata !3862) nounwind, !dbg !3859 ; [debug line = 1879:145@1896:5@61:30@134:2] [debug variable = ctr.V]
  br label %7, !dbg !3861                         ; [debug line = 61:30@134:2]
...
"delay_until_ms<10ull, 50000000ull>.exit10":      ; preds = %7
  ...
  %iic.load.4 = load volatile i32* %iic.addr.2, align 4, !dbg !3864 ; [#uses=1 type=i32] [debug line = 137:2]
  %iic.addr.4 = getelementptr [4096 x i32]* %iic, i64 0, i64 268436547, !dbg !3865 ; [#uses=1 type=i32*] [debug line = 145:3]
  br label %10, !dbg !3867                        ; [debug line = 142:2]
...
; <label>:10                                      ; preds = %"delay_until_ms<10ull, 50000000ull>.exit", %"delay_until_ms<10ull, 50000000ull>.exit10"
  ...
  %storemerge1.cast = trunc i32 %storemerge1 to i7, !dbg !3868 ; [#uses=1 type=i7] [debug line = 149:3]
  store i32 %storemerge1, i32* %stat_reg_val2, align 4, !dbg !3868 ; [debug line = 149:3]
  %storemerge = and i7 %storemerge1.cast, -64, !dbg !3869 ; [#uses=2 type=i7] [debug line = 150:3]
  %storemerge.cast = zext i7 %storemerge to i32, !dbg !3869 ; [#uses=1 type=i32] [debug line = 150:3]
  store i32 %storemerge.cast, i32* %operation, align 4, !dbg !3869 ; [debug line = 150:3]
  %tmp.6 = icmp eq i7 %storemerge, 0, !dbg !3867  ; [#uses=1 type=i1] [debug line = 142:2]
  br i1 %tmp.6, label %11, label %15, !dbg !3867  ; [debug line = 142:2]

; <label>:11                                      ; preds = %10
  %iic.load.5 = load volatile i32* %iic.addr.4, align 4, !dbg !3865 ; [#uses=1 type=i32] [debug line = 145:3]
  %tmp.7 = sext i32 %index to i64, !dbg !3865     ; [#uses=1 type=i64] [debug line = 145:3]
  %sensorData.addr.1 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 %tmp.7, !dbg !3865 ; [#uses=1 type=i32*] [debug line = 145:3]
  store i32 %iic.load.5, i32* %sensorData.addr.1, align 4, !dbg !3865 ; [debug line = 145:3]
  %index.1 = add nsw i32 %index, 1, !dbg !3870    ; [#uses=1 type=i32] [debug line = 146:3]
  call void @llvm.dbg.value(metadata !{i32 %index.1}, i64 0, metadata !3871), !dbg !3870 ; [debug line = 146:3] [debug variable = index]
  ...
  call void (...)* @_ssdm_op_SpecProtocol(i32 0, [1 x i8]* @.str1) nounwind, !dbg !3872 ; [debug line = 57:1@148:3]
  br label %12, !dbg !3874                        ; [debug line = 61:10@148:3]

; <label>:12                                      ; preds = %14, %11
  %.014.0.i5 = phi i19 [ 0, %11 ], [ %ctr.V.2, %14 ] ; [#uses=2 type=i19]
  %tmp.9 = icmp eq i19 %.014.0.i5, -24288, !dbg !3875 ; [#uses=1 type=i1] [debug line = 2042:5@61:19@148:3]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 500000, i64 500000, i64 500000) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.9, label %"delay_until_ms<10ull, 50000000ull>.exit", label %14, !dbg !3876 ; [debug line = 61:19@148:3]

; <label>:14                                      ; preds = %12
  call void @llvm.dbg.value(metadata !{i8* %dummy.4}, i64 0, metadata !3877) nounwind, !dbg !3878 ; [debug line = 62:9@148:3] [debug variable = dummy]
  %dummy.5 = load volatile i8* %dummy.4, align 1, !dbg !3878 ; [#uses=1 type=i8] [debug line = 62:9@148:3]
  call void @llvm.dbg.value(metadata !{i8 %dummy.5}, i64 0, metadata !3877) nounwind, !dbg !3878 ; [debug line = 62:9@148:3] [debug variable = dummy]
  store volatile i8 %dummy.5, i8* %dummy.4, align 1, !dbg !3878 ; [debug line = 62:9@148:3]
  %ctr.V.2 = add i19 %.014.0.i5, 1, !dbg !3879    ; [#uses=1 type=i19] [debug line = 1879:145@1896:5@61:30@148:3]
  call void @llvm.dbg.value(metadata !{i19 %ctr.V.2}, i64 0, metadata !3882) nounwind, !dbg !3879 ; [debug line = 1879:145@1896:5@61:30@148:3] [debug variable = ctr.V]
  br label %12, !dbg !3881                        ; [debug line = 61:30@148:3]

"delay_until_ms<10ull, 50000000ull>.exit":        ; preds = %12
  ...
  %iic.load.6 = load volatile i32* %iic.addr.2, align 4, !dbg !3868 ; [#uses=1 type=i32] [debug line = 149:3]
  br label %10, !dbg !3883                        ; [debug line = 151:2]

; <label>:15                                      ; preds = %10
  %sensorData.addr.2 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 0, !dbg !3884 ; [#uses=1 type=i32*] [debug line = 153:2]
  %sensorData.load = load i32* %sensorData.addr.2, align 16, !dbg !3884 ; [#uses=1 type=i32] [debug line = 153:2]
  store i32 %sensorData.load, i32* %pressure_msb, align 4, !dbg !3884 ; [debug line = 153:2]
  %sensorData.addr.3 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 1, !dbg !3885 ; [#uses=1 type=i32*] [debug line = 154:2]
  %sensorData.load.1 = load i32* %sensorData.addr.3, align 4, !dbg !3885 ; [#uses=1 type=i32] [debug line = 154:2]
  store i32 %sensorData.load.1, i32* %pressure_lsb, align 4, !dbg !3885 ; [debug line = 154:2]
  %sensorData.addr.4 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 2, !dbg !3886 ; [#uses=1 type=i32*] [debug line = 155:2]
  %sensorData.load.2 = load i32* %sensorData.addr.4, align 8, !dbg !3886 ; [#uses=1 type=i32] [debug line = 155:2]
  store i32 %sensorData.load.2, i32* %pressure_xlsb, align 4, !dbg !3886 ; [debug line = 155:2]
  %sensorData.addr.5 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 3, !dbg !3887 ; [#uses=1 type=i32*] [debug line = 157:2]
  %sensorData.load.3 = load i32* %sensorData.addr.5, align 4, !dbg !3887 ; [#uses=1 type=i32] [debug line = 157:2]
  store i32 %sensorData.load.3, i32* %temp_msb, align 4, !dbg !3887 ; [debug line = 157:2]
  %sensorData.addr.6 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 4, !dbg !3888 ; [#uses=1 type=i32*] [debug line = 158:2]
  %sensorData.load.4 = load i32* %sensorData.addr.6, align 16, !dbg !3888 ; [#uses=1 type=i32] [debug line = 158:2]
  store i32 %sensorData.load.4, i32* %temp_lsb, align 4, !dbg !3888 ; [debug line = 158:2]
  %sensorData.addr.7 = getelementptr inbounds [6 x i32]* %sensorData, i64 0, i64 5, !dbg !3889 ; [#uses=1 type=i32*] [debug line = 159:2]
  %sensorData.load.5 = load i32* %sensorData.addr.7, align 4, !dbg !3889 ; [#uses=1 type=i32] [debug line = 159:2]
  store i32 %sensorData.load.5, i32* %temp_xlsb, align 4, !dbg !3889 ; [debug line = 159:2]
  ret void, !dbg !3890                            ; [debug line = 160:1]
}
...
!964 = metadata !{i32 786478, i32 0, metadata !965, metadata !"iiccomm4", metadata !"iiccomm4", metadata !"_Z8iiccomm4PVjRjS1_S1_S1_S1_S1_S1_S1_S1_S1_S1_S1_", metadata !965, i32 40, metadata !966, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 46} ; [ DW_TAG_subprogram ]
...
!1997 = metadata !{i32 786484, i32 0, metadata !964, metadata !"empty_pirq_val", metadata !"empty_pirq_val", metadata !"", metadata !965, i32 66, metadata !970, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!1998 = metadata !{i32 786484, i32 0, metadata !964, metadata !"full_pirq_val", metadata !"full_pirq_val", metadata !"", metadata !965, i32 67, metadata !970, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!1999 = metadata !{i32 786484, i32 0, metadata !964, metadata !"ctrl_reg_val", metadata !"ctrl_reg_val", metadata !"", metadata !965, i32 68, metadata !970, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2000 = metadata !{i32 786484, i32 0, metadata !964, metadata !"stat_reg_val1", metadata !"stat_reg_val1", metadata !"", metadata !965, i32 69, metadata !970, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!3735 = metadata !{metadata !"temp_msb", metadata !3692, metadata !"unsigned int", i32 0, i32 31}
!3736 = metadata !{metadata !3737}
!3737 = metadata !{i32 0, i32 31, metadata !3738}
!3738 = metadata !{metadata !3739}
!3739 = metadata !{metadata !"temp_lsb", metadata !3692, metadata !"unsigned int", i32 0, i32 31}
!3740 = metadata !{metadata !3741}
!3741 = metadata !{i32 0, i32 31, metadata !3742}
!3742 = metadata !{metadata !3743}
!3743 = metadata !{metadata !"temp_xlsb", metadata !3692, metadata !"unsigned int", i32 0, i32 31}
!3744 = metadata !{metadata !3745}
!3745 = metadata !{i32 0, i32 31, metadata !3746}
!3746 = metadata !{metadata !3747}
!3747 = metadata !{metadata !"operation", metadata !3692, metadata !"unsigned int", i32 0, i32 31}
!3748 = metadata !{i32 786689, metadata !964, metadata !"iic", null, i32 40, metadata !3749, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3749 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !969, metadata !3750, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3750 = metadata !{metadata !3751}
!3751 = metadata !{i32 786465, i64 0, i64 4095}   ; [ DW_TAG_subrange_type ]
!3752 = metadata !{i32 40, i32 33, metadata !964, null}
!3753 = metadata !{i32 786689, metadata !964, metadata !"empty_pirq_outValue", metadata !965, i32 33554473, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3754 = metadata !{i32 41, i32 12, metadata !964, null}
!3755 = metadata !{i32 786689, metadata !964, metadata !"full_pirq_outValue", metadata !965, i32 50331689, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3756 = metadata !{i32 41, i32 43, metadata !964, null}
!3757 = metadata !{i32 786689, metadata !964, metadata !"ctrl_reg_outValue", metadata !965, i32 67108905, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3758 = metadata !{i32 41, i32 73, metadata !964, null}
!3759 = metadata !{i32 786689, metadata !964, metadata !"stat_reg_outValue1", metadata !965, i32 83886122, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3760 = metadata !{i32 42, i32 12, metadata !964, null}
!3761 = metadata !{i32 786689, metadata !964, metadata !"stat_reg_val2", metadata !965, i32 100663338, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3762 = metadata !{i32 42, i32 42, metadata !964, null}
!3763 = metadata !{i32 786689, metadata !964, metadata !"pressure_msb", metadata !965, i32 117440555, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3764 = metadata !{i32 43, i32 12, metadata !964, null}
!3765 = metadata !{i32 786689, metadata !964, metadata !"pressure_lsb", metadata !965, i32 134217771, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3766 = metadata !{i32 43, i32 36, metadata !964, null}
!3767 = metadata !{i32 786689, metadata !964, metadata !"pressure_xlsb", metadata !965, i32 150994987, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3768 = metadata !{i32 43, i32 60, metadata !964, null}
!3769 = metadata !{i32 786689, metadata !964, metadata !"temp_msb", metadata !965, i32 167772204, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3770 = metadata !{i32 44, i32 12, metadata !964, null}
!3771 = metadata !{i32 786689, metadata !964, metadata !"temp_lsb", metadata !965, i32 184549420, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3772 = metadata !{i32 44, i32 32, metadata !964, null}
!3773 = metadata !{i32 786689, metadata !964, metadata !"temp_xlsb", metadata !965, i32 201326636, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3774 = metadata !{i32 44, i32 52, metadata !964, null}
!3775 = metadata !{i32 786689, metadata !964, metadata !"operation", metadata !965, i32 218103853, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3776 = metadata !{i32 45, i32 12, metadata !964, null}
!3777 = metadata !{i32 47, i32 1, metadata !3778, null}
!3778 = metadata !{i32 786443, metadata !964, i32 46, i32 1, metadata !965, i32 0} ; [ DW_TAG_lexical_block ]
!3779 = metadata !{i32 51, i32 1, metadata !3778, null}
!3780 = metadata !{i32 52, i32 1, metadata !3778, null}
!3781 = metadata !{i32 53, i32 1, metadata !3778, null}
!3782 = metadata !{i32 54, i32 1, metadata !3778, null}
!3783 = metadata !{i32 55, i32 1, metadata !3778, null}
!3784 = metadata !{i32 56, i32 1, metadata !3778, null}
!3785 = metadata !{i32 57, i32 1, metadata !3778, null}
!3786 = metadata !{i32 58, i32 1, metadata !3778, null}
!3787 = metadata !{i32 59, i32 1, metadata !3778, null}
!3788 = metadata !{i32 60, i32 1, metadata !3778, null}
!3789 = metadata !{i32 61, i32 1, metadata !3778, null}
!3790 = metadata !{i32 62, i32 1, metadata !3778, null}
!3791 = metadata !{i32 786688, metadata !3778, metadata !"sensorData", metadata !965, i32 70, metadata !3792, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3792 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 192, i64 32, i32 0, i32 0, metadata !970, metadata !3793, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3793 = metadata !{metadata !3794}
!3794 = metadata !{i32 786465, i64 0, i64 5}      ; [ DW_TAG_subrange_type ]
!3795 = metadata !{i32 70, i32 11, metadata !3778, null}
!3796 = metadata !{i32 70, i32 29, metadata !3778, null}
!3797 = metadata !{i32 74, i32 2, metadata !3778, null}
!3798 = metadata !{i32 75, i32 2, metadata !3778, null}
!3799 = metadata !{i32 78, i32 2, metadata !3778, null}
!3800 = metadata !{i32 79, i32 2, metadata !3778, null}
!3801 = metadata !{i32 80, i32 2, metadata !3778, null}
!3802 = metadata !{i32 83, i32 2, metadata !3778, null}
!3803 = metadata !{i32 86, i32 2, metadata !3778, null}
!3804 = metadata !{i32 87, i32 2, metadata !3778, null}
!3805 = metadata !{i32 88, i32 2, metadata !3778, null}
!3806 = metadata !{i32 91, i32 5, metadata !3778, null}
!3807 = metadata !{i32 92, i32 5, metadata !3778, null}
!3808 = metadata !{i32 96, i32 2, metadata !3778, null}
!3809 = metadata !{i32 97, i32 2, metadata !3778, null}
!3810 = metadata !{i32 98, i32 2, metadata !3778, null}
!3811 = metadata !{i32 101, i32 2, metadata !3778, null}
!3812 = metadata !{i32 102, i32 2, metadata !3778, null}
!3813 = metadata !{i32 103, i32 2, metadata !3778, null}
!3814 = metadata !{i32 106, i32 2, metadata !3778, null}
!3815 = metadata !{i32 107, i32 2, metadata !3778, null}
!3816 = metadata !{i32 108, i32 2, metadata !3778, null}
!3817 = metadata !{i32 111, i32 2, metadata !3778, null}
!3818 = metadata !{i32 112, i32 2, metadata !3778, null}
!3819 = metadata !{i32 113, i32 2, metadata !3778, null}
!3820 = metadata !{i32 57, i32 1, metadata !3821, metadata !3822}
!3821 = metadata !{i32 786443, metadata !1906, i32 54, i32 22, metadata !974, i32 16} ; [ DW_TAG_lexical_block ]
!3822 = metadata !{i32 115, i32 2, metadata !3778, null}
!3823 = metadata !{i32 61, i32 10, metadata !3824, metadata !3822}
!3824 = metadata !{i32 786443, metadata !3821, i32 61, i32 5, metadata !974, i32 17} ; [ DW_TAG_lexical_block ]
!3825 = metadata !{i32 2042, i32 5, metadata !3826, metadata !3827}
!3826 = metadata !{i32 786443, metadata !1808, i32 2041, i32 104, metadata !954, i32 9} ; [ DW_TAG_lexical_block ]
!3827 = metadata !{i32 61, i32 19, metadata !3824, metadata !3822}
!3828 = metadata !{i32 786688, metadata !3821, metadata !"dummy", metadata !974, i32 58, metadata !3829, i32 0, metadata !3822} ; [ DW_TAG_auto_variable ]
!3829 = metadata !{i32 786485, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !174} ; [ DW_TAG_volatile_type ]
!3830 = metadata !{i32 62, i32 9, metadata !3831, metadata !3822}
!3831 = metadata !{i32 786443, metadata !3824, i32 61, i32 36, metadata !974, i32 18} ; [ DW_TAG_lexical_block ]
!3832 = metadata !{i32 1879, i32 145, metadata !3833, metadata !3834}
!3833 = metadata !{i32 786443, metadata !1807, i32 1879, i32 141, metadata !954, i32 8} ; [ DW_TAG_lexical_block ]
!3834 = metadata !{i32 1896, i32 5, metadata !3835, metadata !3836}
!3835 = metadata !{i32 786443, metadata !979, i32 1895, i32 68, metadata !954, i32 5} ; [ DW_TAG_lexical_block ]
!3836 = metadata !{i32 61, i32 30, metadata !3824, metadata !3822}
!3837 = metadata !{i32 790529, metadata !3838, metadata !"ctr.V", null, i32 59, metadata !3839, i32 0, metadata !3834} ; [ DW_TAG_auto_variable_field ]
!3838 = metadata !{i32 786688, metadata !3821, metadata !"ctr", metadata !974, i32 59, metadata !1814, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3839 = metadata !{i32 786438, null, metadata !"ap_uint<64>", metadata !1810, i32 183, i64 64, i64 64, i32 0, i32 0, null, metadata !3840, i32 0, null, metadata !1897} ; [ DW_TAG_class_field_type ]
!3840 = metadata !{metadata !3841}
!3841 = metadata !{i32 786438, null, metadata !"ap_int_base<64, false, true>", metadata !954, i32 1453, i64 64, i64 64, i32 0, i32 0, null, metadata !3842, i32 0, null, metadata !1803} ; [ DW_TAG_class_field_type ]
!3842 = metadata !{metadata !3843}
!3843 = metadata !{i32 786438, null, metadata !"ssdm_int<64 + 1024 * 0, false>", metadata !987, i32 68, i64 64, i64 64, i32 0, i32 0, null, metadata !3844, i32 0, null, metadata !1000} ; [ DW_TAG_class_field_type ]
!3844 = metadata !{metadata !989}
!3845 = metadata !{i32 120, i32 2, metadata !3778, null}
!3846 = metadata !{i32 123, i32 2, metadata !3778, null}
!3847 = metadata !{i32 126, i32 2, metadata !3778, null}
!3848 = metadata !{i32 129, i32 2, metadata !3778, null}
!3849 = metadata !{i32 57, i32 1, metadata !3850, metadata !3851}
!3850 = metadata !{i32 786443, metadata !973, i32 54, i32 22, metadata !974, i32 2} ; [ DW_TAG_lexical_block ]
!3851 = metadata !{i32 134, i32 2, metadata !3778, null}
!3852 = metadata !{i32 61, i32 10, metadata !3853, metadata !3851}
!3853 = metadata !{i32 786443, metadata !3850, i32 61, i32 5, metadata !974, i32 3} ; [ DW_TAG_lexical_block ]
!3854 = metadata !{i32 2042, i32 5, metadata !3826, metadata !3855}
!3855 = metadata !{i32 61, i32 19, metadata !3853, metadata !3851}
!3856 = metadata !{i32 786688, metadata !3850, metadata !"dummy", metadata !974, i32 58, metadata !3829, i32 0, metadata !3851} ; [ DW_TAG_auto_variable ]
!3857 = metadata !{i32 62, i32 9, metadata !3858, metadata !3851}
!3858 = metadata !{i32 786443, metadata !3853, i32 61, i32 36, metadata !974, i32 4} ; [ DW_TAG_lexical_block ]
!3859 = metadata !{i32 1879, i32 145, metadata !3833, metadata !3860}
!3860 = metadata !{i32 1896, i32 5, metadata !3835, metadata !3861}
!3861 = metadata !{i32 61, i32 30, metadata !3853, metadata !3851}
!3862 = metadata !{i32 790529, metadata !3863, metadata !"ctr.V", null, i32 59, metadata !3839, i32 0, metadata !3860} ; [ DW_TAG_auto_variable_field ]
!3863 = metadata !{i32 786688, metadata !3850, metadata !"ctr", metadata !974, i32 59, metadata !1814, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3864 = metadata !{i32 137, i32 2, metadata !3778, null}
!3865 = metadata !{i32 145, i32 3, metadata !3866, null}
!3866 = metadata !{i32 786443, metadata !3778, i32 143, i32 2, metadata !965, i32 1} ; [ DW_TAG_lexical_block ]
!3867 = metadata !{i32 142, i32 2, metadata !3778, null}
!3868 = metadata !{i32 149, i32 3, metadata !3866, null}
!3869 = metadata !{i32 150, i32 3, metadata !3866, null}
!3870 = metadata !{i32 146, i32 3, metadata !3866, null}
!3871 = metadata !{i32 786688, metadata !3778, metadata !"index", metadata !965, i32 140, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3872 = metadata !{i32 57, i32 1, metadata !3850, metadata !3873}
!3873 = metadata !{i32 148, i32 3, metadata !3866, null}
!3874 = metadata !{i32 61, i32 10, metadata !3853, metadata !3873}
!3875 = metadata !{i32 2042, i32 5, metadata !3826, metadata !3876}
!3876 = metadata !{i32 61, i32 19, metadata !3853, metadata !3873}
!3877 = metadata !{i32 786688, metadata !3850, metadata !"dummy", metadata !974, i32 58, metadata !3829, i32 0, metadata !3873} ; [ DW_TAG_auto_variable ]
!3878 = metadata !{i32 62, i32 9, metadata !3858, metadata !3873}
!3879 = metadata !{i32 1879, i32 145, metadata !3833, metadata !3880}
!3880 = metadata !{i32 1896, i32 5, metadata !3835, metadata !3881}
!3881 = metadata !{i32 61, i32 30, metadata !3853, metadata !3873}
!3882 = metadata !{i32 790529, metadata !3863, metadata !"ctr.V", null, i32 59, metadata !3839, i32 0, metadata !3880} ; [ DW_TAG_auto_variable_field ]
!3883 = metadata !{i32 151, i32 2, metadata !3866, null}
!3884 = metadata !{i32 153, i32 2, metadata !3778, null}
!3885 = metadata !{i32 154, i32 2, metadata !3778, null}
!3886 = metadata !{i32 155, i32 2, metadata !3778, null}
!3887 = metadata !{i32 157, i32 2, metadata !3778, null}
!3888 = metadata !{i32 158, i32 2, metadata !3778, null}
!3889 = metadata !{i32 159, i32 2, metadata !3778, null}
!3890 = metadata !{i32 160, i32 1, metadata !3778, null}
