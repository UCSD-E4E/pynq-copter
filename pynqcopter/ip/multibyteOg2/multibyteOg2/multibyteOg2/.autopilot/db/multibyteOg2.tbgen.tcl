set C_TypeInfoList {{ 
"multibyteOg2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"iic": [[], {"array": [ {"scalar": "int"}, [4096]]}] }, {"pressure_msb": [[], {"reference": "0"}] }, {"pressure_lsb": [[], {"reference": "0"}] }, {"pressure_xlsb": [[], {"reference": "0"}] }],[],""], 
"0": [ "uint32_t", {"typedef": [[[], {"scalar": "unsigned int"}],""]}]
}}
set moduleName multibyteOg2
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"multibyteOg2","role":"start","value":"0","valid_bit":"0"},{"name":"multibyteOg2","role":"continue","value":"0","valid_bit":"4"},{"name":"multibyteOg2","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.multibyteOg2_CTRL_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.multibyteOg2_CTRL_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.multibyteOg2_mux_bkb_U1", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.multibyteOg2_mux_bkb_U2", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.multibyteOg2_mux_bkb_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	multibyteOg2 {
		CTRL {Type IO LastRead 56 FirstWrite 2}
		pressure_msb {Type O LastRead -1 FirstWrite 49}
		pressure_lsb {Type O LastRead -1 FirstWrite 49}
		pressure_xlsb {Type O LastRead -1 FirstWrite 49}
		firstSample {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "41", "Max" : "5000078"}
	, {"Name" : "Interval", "Min" : "42", "Max" : "5000079"}
]}
