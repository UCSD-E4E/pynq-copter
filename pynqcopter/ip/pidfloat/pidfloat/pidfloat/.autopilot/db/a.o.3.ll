; ModuleID = '/home/iavendano/pynq-copter/pynqcopter/ip/pidfloat/pidfloat/pidfloat/.autopilot/db/a.o.3.bc'
...
@pidfloat_str = internal unnamed_addr constant [9 x i8] c"pidfloat\00" ; [#uses=1 type=[9 x i8]*]
...
define void @pidfloat(float %target_roll, float %current_roll, float %Kp_roll, float %Ki_roll, float %Kd_roll, float %target_pitch, float %current_pitch, float %Kp_pitch, float %Ki_pitch, float %Kd_pitch, float %target_yaw, float %current_yaw, float %Kp_yaw, float %Ki_yaw, float %Kd_yaw, float %dt, float* %rollX, float* %pitchY, float* %yawZ) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{float %Kd_roll_read}, i64 0, metadata !193), !dbg !194 ; [debug line = 47:90] [debug variable = Kd_roll]
  %Ki_roll_read = call float @_ssdm_op_Read.s_axilite.float(float %Ki_roll) nounwind ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %Ki_roll_read}, i64 0, metadata !195), !dbg !196 ; [debug line = 47:75] [debug variable = Ki_roll]
  %Kp_roll_read = call float @_ssdm_op_Read.s_axilite.float(float %Kp_roll) nounwind ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %Kp_roll_read}, i64 0, metadata !197), !dbg !198 ; [debug line = 47:60] [debug variable = Kp_roll]
  %current_roll_read = call float @_ssdm_op_Read.s_axilite.float(float %current_roll) nounwind ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %current_roll_read}, i64 0, metadata !199), !dbg !200 ; [debug line = 47:40] [debug variable = current_roll]
  %target_roll_read = call float @_ssdm_op_Read.s_axilite.float(float %target_roll) nounwind ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %target_roll_read}, i64 0, metadata !201), !dbg !202 ; [debug line = 47:21] [debug variable = target_roll]
  call void @llvm.dbg.value(metadata !{float %target_roll}, i64 0, metadata !201), !dbg !202 ; [debug line = 47:21] [debug variable = target_roll]
  call void @llvm.dbg.value(metadata !{float %current_roll}, i64 0, metadata !199), !dbg !200 ; [debug line = 47:40] [debug variable = current_roll]
  call void @llvm.dbg.value(metadata !{float %Kp_roll}, i64 0, metadata !197), !dbg !198 ; [debug line = 47:60] [debug variable = Kp_roll]
  call void @llvm.dbg.value(metadata !{float %Ki_roll}, i64 0, metadata !195), !dbg !196 ; [debug line = 47:75] [debug variable = Ki_roll]
  call void @llvm.dbg.value(metadata !{float %Kd_roll}, i64 0, metadata !193), !dbg !194 ; [debug line = 47:90] [debug variable = Kd_roll]
...
!164 = metadata !{i32 786478, i32 0, metadata !165, metadata !"pidfloat", metadata !"pidfloat", metadata !"_Z8pidfloatffffffffffffffffRfS_S_", metadata !165, i32 47, metadata !166, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float*, float*, float*)* @pidfloat, null, null, metadata !170, i32 50} ; [ DW_TAG_subprogram ]
!165 = metadata !{i32 786473, metadata !"pidfloat.cpp", metadata !"/home/iavendano/pynq-copter/pynqcopter/ip/pidfloat", null} ; [ DW_TAG_file_type ]
...
!194 = metadata !{i32 47, i32 90, metadata !164, null}
...
!196 = metadata !{i32 47, i32 75, metadata !164, null}
...
!198 = metadata !{i32 47, i32 60, metadata !164, null}
...
!200 = metadata !{i32 47, i32 40, metadata !164, null}
...
!202 = metadata !{i32 47, i32 21, metadata !164, null}
