...
#ifndef __pidfloat_faddfsubbkb__HH__
#define __pidfloat_faddfsubbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pidfloat_faddfsubbkb) {
    ...
    SC_CTOR(pidfloat_faddfsubbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
