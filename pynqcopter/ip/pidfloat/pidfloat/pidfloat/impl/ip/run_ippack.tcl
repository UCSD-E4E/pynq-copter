...
set IPName      "pidfloat"
set Version     "1.0"
set DisplayName "Pidfloat"
set Revision    "1808281308"
set Description "HLS Core: Pidfloat Function"
set Device      "zynq"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 target_roll W 0x0 "Data signal of target_roll" {{0 32 target_roll W 0 "Bit 31 to 0 Data signal of target_roll"}}} {0x18 current_roll W 0x0 "Data signal of current_roll" {{0 32 current_roll W 0 "Bit 31 to 0 Data signal of current_roll"}}} {0x20 Kp_roll W 0x0 "Data signal of Kp_roll" {{0 32 Kp_roll W 0 "Bit 31 to 0 Data signal of Kp_roll"}}} {0x28 Ki_roll W 0x0 "Data signal of Ki_roll" {{0 32 Ki_roll W 0 "Bit 31 to 0 Data signal of Ki_roll"}}} {0x30 Kd_roll W 0x0 "Data signal of Kd_roll" {{0 32 Kd_roll W 0 "Bit 31 to 0 Data signal of Kd_roll"}}} {0x38 target_pitch W 0x0 "Data signal of target_pitch" {{0 32 target_pitch W 0 "Bit 31 to 0 Data signal of target_pitch"}}} {0x40 current_pitch W 0x0 "Data signal of current_pitch" {{0 32 current_pitch W 0 "Bit 31 to 0 Data signal of current_pitch"}}} {0x48 Kp_pitch W 0x0 "Data signal of Kp_pitch" {{0 32 Kp_pitch W 0 "Bit 31 to 0 Data signal of Kp_pitch"}}} {0x50 Ki_pitch W 0x0 "Data signal of Ki_pitch" {{0 32 Ki_pitch W 0 "Bit 31 to 0 Data signal of Ki_pitch"}}} {0x58 Kd_pitch W 0x0 "Data signal of Kd_pitch" {{0 32 Kd_pitch W 0 "Bit 31 to 0 Data signal of Kd_pitch"}}} {0x60 target_yaw W 0x0 "Data signal of target_yaw" {{0 32 target_yaw W 0 "Bit 31 to 0 Data signal of target_yaw"}}} {0x68 current_yaw W 0x0 "Data signal of current_yaw" {{0 32 current_yaw W 0 "Bit 31 to 0 Data signal of current_yaw"}}} {0x70 Kp_yaw W 0x0 "Data signal of Kp_yaw" {{0 32 Kp_yaw W 0 "Bit 31 to 0 Data signal of Kp_yaw"}}} {0x78 Ki_yaw W 0x0 "Data signal of Ki_yaw" {{0 32 Ki_yaw W 0 "Bit 31 to 0 Data signal of Ki_yaw"}}} {0x80 Kd_yaw W 0x0 "Data signal of Kd_yaw" {{0 32 Kd_yaw W 0 "Bit 31 to 0 Data signal of Kd_yaw"}}} {0x88 dt W 0x0 "Data signal of dt" {{0 32 dt W 0 "Bit 31 to 0 Data signal of dt"}}} {0x90 rollX R 0x0 "Data signal of rollX" {{0 32 rollX R 0 "Bit 31 to 0 Data signal of rollX"}}} {0x94 rollX_ctrl R 0x0 "Control signal of rollX" {{0 1 rollX_ap_vld R 0 "Control signal rollX_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 pitchY R 0x0 "Data signal of pitchY" {{0 32 pitchY R 0 "Bit 31 to 0 Data signal of pitchY"}}} {0x9c pitchY_ctrl R 0x0 "Control signal of pitchY" {{0 1 pitchY_ap_vld R 0 "Control signal pitchY_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 yawZ R 0x0 "Data signal of yawZ" {{0 32 yawZ R 0 "Bit 31 to 0 Data signal of yawZ"}}} {0xa4 yawZ_ctrl R 0x0 "Control signal of yawZ" {{0 1 yawZ_ap_vld R 0 "Control signal yawZ_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 69 II x}
