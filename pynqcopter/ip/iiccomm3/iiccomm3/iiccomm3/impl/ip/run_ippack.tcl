...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 stat_reg_outValue1_V R 0x0 "Data signal of stat_reg_outValue1_V" {{0 32 stat_reg_outValue1_V R 0 "Bit 31 to 0 Data signal of stat_reg_outValue1_V"}}} {0x14 stat_reg_outValue1_V_ctrl R 0x0 "Control signal of stat_reg_outValue1_V" {{0 1 stat_reg_outValue1_V_ap_vld R 0 "Control signal stat_reg_outValue1_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 stat_reg_outValue2_V R 0x0 "Data signal of stat_reg_outValue2_V" {{0 32 stat_reg_outValue2_V R 0 "Bit 31 to 0 Data signal of stat_reg_outValue2_V"}}} {0x1c stat_reg_outValue2_V_ctrl R 0x0 "Control signal of stat_reg_outValue2_V" {{0 1 stat_reg_outValue2_V_ap_vld R 0 "Control signal stat_reg_outValue2_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 stat_reg_outValue3_V R 0x0 "Data signal of stat_reg_outValue3_V" {{0 32 stat_reg_outValue3_V R 0 "Bit 31 to 0 Data signal of stat_reg_outValue3_V"}}} {0x24 stat_reg_outValue3_V_ctrl R 0x0 "Control signal of stat_reg_outValue3_V" {{0 1 stat_reg_outValue3_V_ap_vld R 0 "Control signal stat_reg_outValue3_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 stat_reg_outValue4_V R 0x0 "Data signal of stat_reg_outValue4_V" {{0 32 stat_reg_outValue4_V R 0 "Bit 31 to 0 Data signal of stat_reg_outValue4_V"}}} {0x2c stat_reg_outValue4_V_ctrl R 0x0 "Control signal of stat_reg_outValue4_V" {{0 1 stat_reg_outValue4_V_ap_vld R 0 "Control signal stat_reg_outValue4_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 ctrl_reg_outValue_V R 0x0 "Data signal of ctrl_reg_outValue_V" {{0 32 ctrl_reg_outValue_V R 0 "Bit 31 to 0 Data signal of ctrl_reg_outValue_V"}}} {0x34 ctrl_reg_outValue_V_ctrl R 0x0 "Control signal of ctrl_reg_outValue_V" {{0 1 ctrl_reg_outValue_V_ap_vld R 0 "Control signal ctrl_reg_outValue_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 empty_pirq_outValue_V R 0x0 "Data signal of empty_pirq_outValue_V" {{0 32 empty_pirq_outValue_V R 0 "Bit 31 to 0 Data signal of empty_pirq_outValue_V"}}} {0x3c empty_pirq_outValue_V_ctrl R 0x0 "Control signal of empty_pirq_outValue_V" {{0 1 empty_pirq_outValue_V_ap_vld R 0 "Control signal empty_pirq_outValue_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 full_pirq_outValue_V R 0x0 "Data signal of full_pirq_outValue_V" {{0 32 full_pirq_outValue_V R 0 "Bit 31 to 0 Data signal of full_pirq_outValue_V"}}} {0x44 full_pirq_outValue_V_ctrl R 0x0 "Control signal of full_pirq_outValue_V" {{0 1 full_pirq_outValue_V_ap_vld R 0 "Control signal full_pirq_outValue_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 tx_fifo_outValue1_V R 0x0 "Data signal of tx_fifo_outValue1_V" {{0 32 tx_fifo_outValue1_V R 0 "Bit 31 to 0 Data signal of tx_fifo_outValue1_V"}}} {0x4c tx_fifo_outValue1_V_ctrl R 0x0 "Control signal of tx_fifo_outValue1_V" {{0 1 tx_fifo_outValue1_V_ap_vld R 0 "Control signal tx_fifo_outValue1_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 tx_fifo_outValue2_V R 0x0 "Data signal of tx_fifo_outValue2_V" {{0 32 tx_fifo_outValue2_V R 0 "Bit 31 to 0 Data signal of tx_fifo_outValue2_V"}}} {0x54 tx_fifo_outValue2_V_ctrl R 0x0 "Control signal of tx_fifo_outValue2_V" {{0 1 tx_fifo_outValue2_V_ap_vld R 0 "Control signal tx_fifo_outValue2_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 tx_fifo_outValue3_V R 0x0 "Data signal of tx_fifo_outValue3_V" {{0 32 tx_fifo_outValue3_V R 0 "Bit 31 to 0 Data signal of tx_fifo_outValue3_V"}}} {0x5c tx_fifo_outValue3_V_ctrl R 0x0 "Control signal of tx_fifo_outValue3_V" {{0 1 tx_fifo_outValue3_V_ap_vld R 0 "Control signal tx_fifo_outValue3_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 rx_fifo_outValue_V R 0x0 "Data signal of rx_fifo_outValue_V" {{0 32 rx_fifo_outValue_V R 0 "Bit 31 to 0 Data signal of rx_fifo_outValue_V"}}} {0x64 rx_fifo_outValue_V_ctrl R 0x0 "Control signal of rx_fifo_outValue_V" {{0 1 rx_fifo_outValue_V_ap_vld R 0 "Control signal rx_fifo_outValue_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 length1_V R 0x0 "Data signal of length1_V" {{0 32 length1_V R 0 "Bit 31 to 0 Data signal of length1_V"}}} {0x6c length1_V_ctrl R 0x0 "Control signal of length1_V" {{0 1 length1_V_ap_vld R 0 "Control signal length1_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 38 II x}
