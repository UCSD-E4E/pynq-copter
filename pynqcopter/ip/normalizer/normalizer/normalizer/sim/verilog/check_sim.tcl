...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.normalizer.autotvin_regs_in_0.dat"
         "c.normalizer.autotvin_regs_in_1.dat"
         "c.normalizer.autotvin_regs_in_2.dat"
         "c.normalizer.autotvin_regs_in_3.dat"
         "c.normalizer.autotvin_regs_in_4.dat"
         "c.normalizer.autotvin_regs_in_5.dat"
         "c.normalizer.autotvin_min_high.dat"
         "c.normalizer.autotvin_max_high.dat"
         "c.normalizer.autotvout_m_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.normalizer.autotvout_m_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
