...
end entity normalizer_in_s_axi;
...
architecture behave of normalizer_in_s_axi is
    ...
    constant ADDR_REGS_IN_0_DATA_0 : INTEGER := 16#10#;
    constant ADDR_REGS_IN_0_CTRL   : INTEGER := 16#14#;
    constant ADDR_REGS_IN_1_DATA_0 : INTEGER := 16#18#;
    constant ADDR_REGS_IN_1_CTRL   : INTEGER := 16#1c#;
    constant ADDR_REGS_IN_2_DATA_0 : INTEGER := 16#20#;
    constant ADDR_REGS_IN_2_CTRL   : INTEGER := 16#24#;
    constant ADDR_REGS_IN_3_DATA_0 : INTEGER := 16#28#;
    ...
    signal int_regs_in_0       : UNSIGNED(31 downto 0) := (others => '0');
    signal int_regs_in_1       : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_REGS_IN_0_DATA_0 =>
                        rdata_data <= RESIZE(int_regs_in_0(31 downto 0), 32);
                    when ADDR_REGS_IN_1_DATA_0 =>
                        rdata_data <= RESIZE(int_regs_in_1(31 downto 0), 32);
                    when ADDR_REGS_IN_2_DATA_0 =>
                        rdata_data <= RESIZE(int_regs_in_2(31 downto 0), 32);
                    when ADDR_REGS_IN_3_DATA_0 =>
                    ...
                    when ADDR_MAX_HIGH_DATA_0 =>
                        rdata_data <= RESIZE(int_max_high(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    regs_in_0            <= STD_LOGIC_VECTOR(int_regs_in_0);
    regs_in_1            <= STD_LOGIC_VECTOR(int_regs_in_1);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_REGS_IN_0_DATA_0) then
                    int_regs_in_0(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_regs_in_0(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_REGS_IN_1_DATA_0) then
                    int_regs_in_1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_regs_in_1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_REGS_IN_2_DATA_0) then
                    int_regs_in_2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_regs_in_2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_REGS_IN_3_DATA_0) then
                    int_regs_in_3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_regs_in_3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MIN_HIGH_DATA_0) then
                    int_min_high(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_min_high(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAX_HIGH_DATA_0) then
                    int_max_high(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_max_high(31 downto 0));
                end if;
            end if;
        end if;
    end process;
