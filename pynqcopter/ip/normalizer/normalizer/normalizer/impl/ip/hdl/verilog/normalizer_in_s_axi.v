...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [31:0]                   regs_in_0,
    output wire [31:0]                   regs_in_1,
...
localparam
    ...
    ADDR_IER              = 7'h08,
    ADDR_ISR              = 7'h0c,
    ADDR_REGS_IN_0_DATA_0 = 7'h10,
    ADDR_REGS_IN_0_CTRL   = 7'h14,
    ADDR_REGS_IN_1_DATA_0 = 7'h18,
    ADDR_REGS_IN_1_CTRL   = 7'h1c,
    ADDR_REGS_IN_2_DATA_0 = 7'h20,
    ADDR_REGS_IN_2_CTRL   = 7'h24,
    ADDR_REGS_IN_3_DATA_0 = 7'h28,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_regs_in_0 = 'b0;
    reg  [31:0]                   int_regs_in_1 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_REGS_IN_0_DATA_0: begin
                    rdata <= int_regs_in_0[31:0];
                end
                ADDR_REGS_IN_1_DATA_0: begin
                    rdata <= int_regs_in_1[31:0];
                end
                ADDR_REGS_IN_2_DATA_0: begin
                    rdata <= int_regs_in_2[31:0];
                end
                ADDR_REGS_IN_3_DATA_0: begin
                    rdata <= int_regs_in_3[31:0];
                end
...
assign regs_in_0 = int_regs_in_0;
assign regs_in_1 = int_regs_in_1;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_regs_in_0[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_REGS_IN_0_DATA_0)
            int_regs_in_0[31:0] <= (WDATA[31:0] & wmask) | (int_regs_in_0[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_regs_in_1[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_REGS_IN_1_DATA_0)
            int_regs_in_1[31:0] <= (WDATA[31:0] & wmask) | (int_regs_in_1[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_regs_in_2[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_REGS_IN_2_DATA_0)
            int_regs_in_2[31:0] <= (WDATA[31:0] & wmask) | (int_regs_in_2[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_regs_in_3[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_REGS_IN_3_DATA_0)
            int_regs_in_3[31:0] <= (WDATA[31:0] & wmask) | (int_regs_in_3[31:0] & ~wmask);
    end
end
