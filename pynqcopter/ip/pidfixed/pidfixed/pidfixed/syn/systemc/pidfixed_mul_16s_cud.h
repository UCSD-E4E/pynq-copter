...
#ifndef __pidfixed_mul_16s_cud__HH__
#define __pidfixed_mul_16s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pidfixed_mul_16s_cud) {
    ...
    SC_CTOR(pidfixed_mul_16s_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
