...
#ifndef __pidfixed_mul_mul_fYi__HH__
#define __pidfixed_mul_mul_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pidfixed_mul_mul_fYi) {
    ...
    SC_CTOR(pidfixed_mul_mul_fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
