...
#ifndef __pidfixed_mul_mul_eOg__HH__
#define __pidfixed_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pidfixed_mul_mul_eOg) {
    ...
    SC_CTOR(pidfixed_mul_mul_eOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
