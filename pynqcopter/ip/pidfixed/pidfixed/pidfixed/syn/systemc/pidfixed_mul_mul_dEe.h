...
#ifndef __pidfixed_mul_mul_dEe__HH__
#define __pidfixed_mul_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pidfixed_mul_mul_dEe) {
    ...
    SC_CTOR(pidfixed_mul_mul_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
