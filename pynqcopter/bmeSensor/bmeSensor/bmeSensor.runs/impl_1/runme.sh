...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeSensor/bmeSensor/bmeSensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeSensor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeSensor_wrapper.tcl -notrace
