...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeSensor/bmeSensor/bmeSensor.runs/bmeSensor_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeSensor_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeSensor_xbar_0.tcl
