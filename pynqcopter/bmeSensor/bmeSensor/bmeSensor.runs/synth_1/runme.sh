...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeSensor/bmeSensor/bmeSensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeSensor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeSensor_wrapper.tcl
