...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte/bmeMultibyte/bmeMultibyte.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeMultibyte_wrapper.tcl -notrace
