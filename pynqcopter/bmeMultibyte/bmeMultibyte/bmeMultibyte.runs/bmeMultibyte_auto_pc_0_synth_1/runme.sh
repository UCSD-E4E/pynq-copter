...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte/bmeMultibyte/bmeMultibyte.runs/bmeMultibyte_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyte_auto_pc_0.tcl
