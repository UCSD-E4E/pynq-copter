...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte/bmeMultibyte/bmeMultibyte.runs/bmeMultibyte_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyte_rst_ps7_0_100M_0.tcl
