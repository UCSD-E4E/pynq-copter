...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte/bmeMultibyte/bmeMultibyte.runs/bmeMultibyte_multibyte_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte_multibyte_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyte_multibyte_0_0.tcl
