...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte/bmeMultibyte/bmeMultibyte.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyte_wrapper.tcl
