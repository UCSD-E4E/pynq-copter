...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/hex2/hex2/hex2.runs/hex2_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex2_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex2_auto_pc_0.tcl
