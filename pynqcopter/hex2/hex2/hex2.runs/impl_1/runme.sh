...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/hex2/hex2/hex2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex2_wrapper.tcl -notrace
