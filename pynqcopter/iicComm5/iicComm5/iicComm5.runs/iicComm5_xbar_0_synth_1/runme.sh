...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm5/iicComm5/iicComm5.runs/iicComm5_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm5_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm5_xbar_0.tcl
