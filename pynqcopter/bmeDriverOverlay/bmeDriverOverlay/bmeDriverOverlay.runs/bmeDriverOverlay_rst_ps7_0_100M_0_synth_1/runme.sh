...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeDriverOverlay/bmeDriverOverlay/bmeDriverOverlay.runs/bmeDriverOverlay_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeDriverOverlay_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeDriverOverlay_rst_ps7_0_100M_0.tcl
