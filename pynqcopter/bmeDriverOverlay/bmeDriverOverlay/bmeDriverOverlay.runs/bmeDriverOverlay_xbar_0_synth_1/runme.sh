...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeDriverOverlay/bmeDriverOverlay/bmeDriverOverlay.runs/bmeDriverOverlay_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeDriverOverlay_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeDriverOverlay_xbar_0.tcl
