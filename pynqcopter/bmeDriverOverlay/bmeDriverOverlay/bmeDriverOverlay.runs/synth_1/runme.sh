...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeDriverOverlay/bmeDriverOverlay/bmeDriverOverlay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeDriverOverlay_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeDriverOverlay_wrapper.tcl
