...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeDriverOverlay/bmeDriverOverlay/bmeDriverOverlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeDriverOverlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeDriverOverlay_wrapper.tcl -notrace
