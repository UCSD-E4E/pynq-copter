...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeDriverOverlay/bmeDriverOverlay/bmeDriverOverlay.runs/bmeDriverOverlay_s01_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeDriverOverlay_s01_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeDriverOverlay_s01_mmu_0.tcl
