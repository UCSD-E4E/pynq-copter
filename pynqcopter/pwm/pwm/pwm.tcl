...
proc create_root_design { parentCell } {
  ...
  # Create instance: atoi_0, and set properties
  set atoi_0 [ create_bd_cell -type ip -vlnv UCSD:hlsip:atoi:1.0 atoi_0 ]
 ...
 ] [get_bd_intf_pins /atoi_0/s_axi_AXILiteS]
  ...
  set mixer_0 [ create_bd_cell -type ip -vlnv UCSD:hlsip:mixer:1.0 mixer_0 ]
  ...
  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /pwm_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins mixer_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins pwm_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins atoi_0/s_axi_AXILiteS] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net mixer_0_m_axi_m_V [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins mixer_0/m_axi_m_V]
  ...
  connect_bd_net -net atoi_0_out_V [get_bd_pins atoi_0/out_V] [get_bd_pins xlconcat_1/In8]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins atoi_0/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins mixer_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins pwm_0/ap_clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins atoi_0/ap_rst_n] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins mixer_0/ap_rst_n] [get_bd_pins pwm_0/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces mixer_0/Data_m_axi_m_V] [get_bd_addr_segs pwm_0/s_axi_AXILiteS/Reg] SEG_pwm_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40002000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs atoi_0/s_axi_AXILiteS/Reg] SEG_atoi_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mixer_0/s_axi_AXILiteS/Reg] SEG_mixer_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_0/s_axi_AXILiteS/Reg] SEG_pwm_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40002000 [get_bd_addr_spaces mixer_0/Data_m_axi_m_V] [get_bd_addr_segs atoi_0/s_axi_AXILiteS/Reg] SEG_atoi_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs mixer_0/Data_m_axi_m_V/SEG_atoi_0_Reg]

  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces mixer_0/Data_m_axi_m_V] [get_bd_addr_segs mixer_0/s_axi_AXILiteS/Reg] SEG_mixer_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs mixer_0/Data_m_axi_m_V/SEG_mixer_0_Reg]
