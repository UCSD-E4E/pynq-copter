...
################################################################
# This is a generated script based on design: bd_a815
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_1_AXI_ADDR_WIDTH {6} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net net_slot_0_axi_arlock [get_bd_pins g_inst/m_slot_0_axi_arlock] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net net_slot_0_axi_arprot [get_bd_pins g_inst/m_slot_0_axi_arprot] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_0_axi_arqos [get_bd_pins g_inst/m_slot_0_axi_arqos] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net net_slot_0_axi_arready [get_bd_pins g_inst/m_slot_0_axi_arready] [get_bd_pins slot_0_ar/In1]
  connect_bd_net -net net_slot_0_axi_arregion [get_bd_pins g_inst/m_slot_0_axi_arregion] [get_bd_pins ila_lib/probe7]
  ...
  connect_bd_net -net net_slot_0_axi_awqos [get_bd_pins g_inst/m_slot_0_axi_awqos] [get_bd_pins ila_lib/probe15]
  connect_bd_net -net net_slot_0_axi_awready [get_bd_pins g_inst/m_slot_0_axi_awready] [get_bd_pins slot_0_aw/In1]
  connect_bd_net -net net_slot_0_axi_awregion [get_bd_pins g_inst/m_slot_0_axi_awregion] [get_bd_pins ila_lib/probe16]
