...
//--------------------------------------------------------------------------------
//Command: generate_target bd_a815.bd
//Design : bd_a815
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_a815,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_a815,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "pwm_system_ila_0_2.hwdef" *) 
module bd_a815
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arcache,
    SLOT_0_AXI_arlen,
  ...
  bd_a815_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe15(net_slot_0_axi_awqos),
        .probe16(net_slot_0_axi_awregion),
