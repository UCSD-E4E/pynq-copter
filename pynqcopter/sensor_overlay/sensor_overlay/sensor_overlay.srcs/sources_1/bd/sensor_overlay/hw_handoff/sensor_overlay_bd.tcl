...
################################################################
# This is a generated script based on design: sensor_overlay
#
...
# source sensor_overlay_script.tcl
...
set design_name sensor_overlay
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net S00_ARESETN_2 [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins userReset/peripheral_aresetn]
  connect_bd_net -net arduinoGpioBreakout_wire_i_i [get_bd_pins arduinoGpioBreakout/wire_i_i] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net axi_iic_0_scl_o [get_bd_pins axi_iic_0/scl_o] [get_bd_pins xlconcat_0/In18]
  connect_bd_net -net axi_iic_0_scl_t [get_bd_pins axi_iic_0/scl_t] [get_bd_pins xlconcat_1/In18]
  connect_bd_net -net axi_iic_0_sda_o [get_bd_pins axi_iic_0/sda_o] [get_bd_pins xlconcat_0/In19]
  connect_bd_net -net axi_iic_0_sda_t [get_bd_pins axi_iic_0/sda_t] [get_bd_pins xlconcat_1/In19]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins userReset/slowest_sync_clk]
  ...
  connect_bd_net -net userReset_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins userReset/interconnect_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins arduinoGpioBreakout/wire_i_o] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins arduinoGpioBreakout/wire_i_t] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins axi_iic_0/sda_i] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins axi_iic_0/scl_i] [get_bd_pins xlslice_1/Dout]
