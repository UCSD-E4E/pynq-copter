...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/sensor_overlay/sensor_overlay/sensor_overlay.runs/sensor_overlay_arduinoGpioBreakout_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_overlay_arduinoGpioBreakout_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_overlay_arduinoGpioBreakout_0.tcl
