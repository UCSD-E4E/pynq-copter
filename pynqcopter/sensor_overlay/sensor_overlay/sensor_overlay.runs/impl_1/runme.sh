...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/sensor_overlay/sensor_overlay/sensor_overlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor_overlay_wrapper.tcl -notrace
