...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm2/iicComm2/iicComm2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm2_wrapper.tcl
