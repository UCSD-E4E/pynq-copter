...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm2/iicComm2/iicComm2.runs/iicComm2_axi_iic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm2_axi_iic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm2_axi_iic_0_0.tcl
