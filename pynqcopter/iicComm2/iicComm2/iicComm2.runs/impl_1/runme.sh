...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm2/iicComm2/iicComm2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicComm2_wrapper.tcl -notrace
