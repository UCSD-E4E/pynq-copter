...
//        others - reserved
// 0x18 : Data signal of stat_reg_val2
//        bit 31~0 - stat_reg_val2[31:0] (Read)
// 0x1c : Control signal of stat_reg_val2
//        bit 0  - stat_reg_val2_ap_vld (Read/COR)
//        others - reserved
// 0x20 : Data signal of empty_pirq_outValue
//        bit 31~0 - empty_pirq_outValue[31:0] (Read)
// 0x24 : Control signal of empty_pirq_outValue
//        bit 0  - empty_pirq_outValue_ap_vld (Read/COR)
//        others - reserved
// 0x28 : Data signal of full_pirq_outValue
//        bit 31~0 - full_pirq_outValue[31:0] (Read)
// 0x2c : Control signal of full_pirq_outValue
//        bit 0  - full_pirq_outValue_ap_vld (Read/COR)
//        others - reserved
// 0x30 : Data signal of ctrl_reg_outValue
//        bit 31~0 - ctrl_reg_outValue[31:0] (Read)
// 0x34 : Control signal of ctrl_reg_outValue
...
localparam
    ...
    ADDR_STAT_REG_VAL2_DATA_0       = 7'h18,
    ADDR_STAT_REG_VAL2_CTRL         = 7'h1c,
    ADDR_EMPTY_PIRQ_OUTVALUE_DATA_0 = 7'h20,
    ADDR_EMPTY_PIRQ_OUTVALUE_CTRL   = 7'h24,
    ADDR_FULL_PIRQ_OUTVALUE_DATA_0  = 7'h28,
    ADDR_FULL_PIRQ_OUTVALUE_CTRL    = 7'h2c,
    ADDR_CTRL_REG_OUTVALUE_DATA_0   = 7'h30,
    ADDR_CTRL_REG_OUTVALUE_CTRL     = 7'h34,
    ADDR_PRESSURE_MSB_DATA_0        = 7'h38,
    ADDR_PRESSURE_MSB_CTRL          = 7'h3c,
    ADDR_PRESSURE_LSB_DATA_0        = 7'h40,
    ADDR_PRESSURE_LSB_CTRL          = 7'h44,
    ADDR_PRESSURE_XLSB_DATA_0       = 7'h48,
    ADDR_PRESSURE_XLSB_CTRL         = 7'h4c,
    ADDR_OPERATION_DATA_0           = 7'h50,
    ADDR_OPERATION_CTRL             = 7'h54,
    WRIDLE                          = 2'd0,
    WRDATA                          = 2'd1,
    WRRESP                          = 2'd2,
    WRRESET                         = 2'd3,
