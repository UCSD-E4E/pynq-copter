...
################################################################
# This is a generated script based on design: iicComm3
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: iiccomm3_0, and set properties
  set iiccomm3_0 [ create_bd_cell -type ip -vlnv UCSD:hlsip:iiccomm3:1.0 iiccomm3_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /iiccomm3_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net iiccomm3_0_m_axi_iic [get_bd_intf_pins iiccomm3_0/m_axi_iic] [get_bd_intf_pins ps7_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins iiccomm3_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
