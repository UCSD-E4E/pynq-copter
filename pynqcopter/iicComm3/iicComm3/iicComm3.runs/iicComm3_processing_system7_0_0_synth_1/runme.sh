...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm3/iicComm3/iicComm3.runs/iicComm3_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm3_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm3_processing_system7_0_0.tcl
