...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm3/iicComm3/iicComm3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm3_wrapper.tcl
