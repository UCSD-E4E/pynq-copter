...
proc create_root_design { parentCell } {
  ...
  set arduino_iic_scl_io [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 arduino_iic_scl_io ]
  set arduino_iic_sda_io [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 arduino_iic_sda_io ]
  ...
  # Create instance: iicSclBreakout, and set properties
  set iicSclBreakout [ create_bd_cell -type ip -vlnv xilinx.com:user:wire_distributor:1.0 iicSclBreakout ]
  set_property -dict [ list \
   CONFIG.TYPE {1} \
   CONFIG.WIDTH {1} \
 ] $iicSclBreakout

  # Create instance: iicSdaBreakout, and set properties
  set iicSdaBreakout [ create_bd_cell -type ip -vlnv xilinx.com:user:wire_distributor:1.0 iicSdaBreakout ]
  set_property -dict [ list \
   CONFIG.TYPE {1} \
   CONFIG.WIDTH {1} \
 ] $iicSdaBreakout
  ...
  connect_bd_intf_net -intf_net arduinoGpioBreakout_gpio_output [get_bd_intf_ports arduino_iic_sda_io] [get_bd_intf_pins iicSclBreakout/gpio_output]
  connect_bd_intf_net -intf_net iicSdaBreakout_gpio_output [get_bd_intf_ports arduino_iic_scl_io] [get_bd_intf_pins iicSdaBreakout/gpio_output]
  ...
  connect_bd_net -net axi_iic_0_scl_o [get_bd_pins axi_iic_0/scl_o] [get_bd_pins iicSclBreakout/wire_i_o]
  connect_bd_net -net axi_iic_0_scl_t [get_bd_pins axi_iic_0/scl_t] [get_bd_pins iicSclBreakout/wire_i_t]
  connect_bd_net -net axi_iic_0_sda_o [get_bd_pins axi_iic_0/sda_o] [get_bd_pins iicSdaBreakout/wire_i_o]
  connect_bd_net -net axi_iic_0_sda_t [get_bd_pins axi_iic_0/sda_t] [get_bd_pins iicSdaBreakout/wire_i_t]
  connect_bd_net -net iicSdaBreakout_wire_i_i [get_bd_pins axi_iic_0/scl_i] [get_bd_pins iicSclBreakout/wire_i_i]
  connect_bd_net -net iicSdaBreakout_wire_i_i1 [get_bd_pins axi_iic_0/sda_i] [get_bd_pins iicSdaBreakout/wire_i_i]
