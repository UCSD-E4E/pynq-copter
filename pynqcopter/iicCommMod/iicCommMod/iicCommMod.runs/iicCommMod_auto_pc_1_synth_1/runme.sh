...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicCommMod/iicCommMod/iicCommMod.runs/iicCommMod_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicCommMod_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicCommMod_auto_pc_1.tcl
