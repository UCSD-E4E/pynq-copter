...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicCommMod/iicCommMod/iicCommMod.runs/iicCommMod_iiccommmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicCommMod_iiccommmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicCommMod_iiccommmod_0_0.tcl
