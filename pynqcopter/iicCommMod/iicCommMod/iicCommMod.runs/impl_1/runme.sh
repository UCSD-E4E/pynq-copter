...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicCommMod/iicCommMod/iicCommMod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicCommMod_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicCommMod_wrapper.tcl -notrace
