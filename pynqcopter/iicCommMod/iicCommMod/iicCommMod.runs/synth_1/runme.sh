...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicCommMod/iicCommMod/iicCommMod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicCommMod_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicCommMod_wrapper.tcl
