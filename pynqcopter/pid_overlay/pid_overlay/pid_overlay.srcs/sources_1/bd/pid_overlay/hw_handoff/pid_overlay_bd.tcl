...
################################################################
# This is a generated script based on design: pid_overlay
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set arduino_i [ create_bd_port -dir I -from 19 -to 0 arduino_i ]
  set arduino_o [ create_bd_port -dir O -from 19 -to 0 arduino_o ]
  set arduino_t [ create_bd_port -dir O -from 19 -to 0 arduino_t ]
  set led_o [ create_bd_port -dir O -from 3 -to 0 led_o ]
  set pmodJA_i [ create_bd_port -dir I -from 7 -to 0 pmodJA_i ]
  set pmodJA_o [ create_bd_port -dir O -from 7 -to 0 pmodJA_o ]
  set pmodJA_t [ create_bd_port -dir O -from 7 -to 0 pmodJA_t ]
  set pmodJB_i [ create_bd_port -dir I -from 7 -to 0 pmodJB_i ]
  set pmodJB_o [ create_bd_port -dir O -from 7 -to 0 pmodJB_o ]
  set pmodJB_t [ create_bd_port -dir O -from 7 -to 0 pmodJB_t ]

  # Create instance: pidInterconnect, and set properties
  set pidInterconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 pidInterconnect ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins pidInterconnect/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net ctrlLoopInterconnect_M00_AXI [get_bd_intf_pins pidInterconnect/M00_AXI] [get_bd_intf_pins pid_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net FCLK_CLK0 [get_bd_pins pidInterconnect/ACLK] [get_bd_pins pidInterconnect/M00_ACLK] [get_bd_pins pidInterconnect/S00_ACLK] [get_bd_pins pid_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins userReset/slowest_sync_clk]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins pidInterconnect/ARESETN] [get_bd_pins userReset/interconnect_aresetn]
  connect_bd_net -net pb_i_1 [get_bd_pins pidInterconnect/M00_ARESETN] [get_bd_pins pidInterconnect/S00_ARESETN] [get_bd_pins pid_0/ap_rst_n] [get_bd_pins userReset/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins userReset/ext_reset_in]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pid_0/s_axi_CTRL/Reg] SEG_pid_0_Reg
