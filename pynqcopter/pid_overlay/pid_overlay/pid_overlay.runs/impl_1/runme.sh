...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/pid_overlay/pid_overlay/pid_overlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pid_overlay_wrapper.tcl -notrace
