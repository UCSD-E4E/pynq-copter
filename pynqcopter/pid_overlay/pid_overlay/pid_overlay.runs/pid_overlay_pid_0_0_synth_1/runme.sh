...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/pid_overlay/pid_overlay/pid_overlay.runs/pid_overlay_pid_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_overlay_pid_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_overlay_pid_0_0.tcl
