...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net S00_ARESETN_2 [get_bd_pins ctrlLoop/ap_rst_n] [get_bd_pins plIntrController/s_axi_aresetn] [get_bd_pins psInterconnect/M00_ARESETN] [get_bd_pins psInterconnect/M01_ARESETN] [get_bd_pins psInterconnect/S00_ARESETN] [get_bd_pins userReset/peripheral_aresetn]
  ...
  connect_bd_net -net pb_i_1 [get_bd_ports pb_i] [get_bd_pins ctrlLoop/buttons_V] [get_bd_pins ctrlLoopInterconnect/M00_ARESETN] [get_bd_pins ctrlLoopInterconnect/S00_ARESETN] [get_bd_pins ctrlLoopUart/s_axi_aresetn]
