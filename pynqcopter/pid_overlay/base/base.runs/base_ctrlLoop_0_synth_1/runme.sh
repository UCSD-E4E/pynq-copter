...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/base/base/base.runs/base_ctrlLoop_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ctrlLoop_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ctrlLoop_0.tcl
