...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/base/base/base.runs/base_plClk_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_plClk_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_plClk_0.tcl
