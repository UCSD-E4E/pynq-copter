...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm4/iicComm4/iicComm4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicComm4_wrapper.tcl -notrace
