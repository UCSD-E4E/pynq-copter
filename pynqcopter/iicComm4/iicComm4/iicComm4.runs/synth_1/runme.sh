...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm4/iicComm4/iicComm4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm4_wrapper.tcl
