...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm4/iicComm4/iicComm4.runs/iicComm4_axi_iic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm4_axi_iic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm4_axi_iic_0_0.tcl
