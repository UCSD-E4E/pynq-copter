...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ iicComm_iiccomm_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(rx_fifo_outValue_ap_vld, 
  ...
  m_axi_iic_AWADDR, m_axi_iic_AWLEN, m_axi_iic_AWSIZE, m_axi_iic_AWBURST, m_axi_iic_AWLOCK, 
  m_axi_iic_AWREGION, m_axi_iic_AWCACHE, m_axi_iic_AWPROT, m_axi_iic_AWQOS, 
  m_axi_iic_AWVALID, m_axi_iic_AWREADY, m_axi_iic_WDATA, m_axi_iic_WSTRB, m_axi_iic_WLAST, 
  m_axi_iic_WVALID, m_axi_iic_WREADY, m_axi_iic_BRESP, m_axi_iic_BVALID, m_axi_iic_BREADY, 
  m_axi_iic_ARADDR, m_axi_iic_ARLEN, m_axi_iic_ARSIZE, m_axi_iic_ARBURST, m_axi_iic_ARLOCK, 
  ...
  m_axi_iic_RVALID, m_axi_iic_RREADY, rx_fifo_outValue)
/* synthesis syn_black_box black_box_pad_pin="rx_fifo_outValue_ap_vld,s_axi_AXILiteS_AWADDR[6:0],s_axi_AXILiteS_AWVALID,s_axi_AXILiteS_AWREADY,s_axi_AXILiteS_WDATA[31:0],s_axi_AXILiteS_WSTRB[3:0],s_axi_AXILiteS_WVALID,s_axi_AXILiteS_WREADY,s_axi_AXILiteS_BRESP[1:0],s_axi_AXILiteS_BVALID,s_axi_AXILiteS_BREADY,s_axi_AXILiteS_ARADDR[6:0],s_axi_AXILiteS_ARVALID,s_axi_AXILiteS_ARREADY,s_axi_AXILiteS_RDATA[31:0],s_axi_AXILiteS_RRESP[1:0],s_axi_AXILiteS_RVALID,s_axi_AXILiteS_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_iic_AWADDR[31:0],m_axi_iic_AWLEN[7:0],m_axi_iic_AWSIZE[2:0],m_axi_iic_AWBURST[1:0],m_axi_iic_AWLOCK[1:0],m_axi_iic_AWREGION[3:0],m_axi_iic_AWCACHE[3:0],m_axi_iic_AWPROT[2:0],m_axi_iic_AWQOS[3:0],m_axi_iic_AWVALID,m_axi_iic_AWREADY,m_axi_iic_WDATA[31:0],m_axi_iic_WSTRB[3:0],m_axi_iic_WLAST,m_axi_iic_WVALID,m_axi_iic_WREADY,m_axi_iic_BRESP[1:0],m_axi_iic_BVALID,m_axi_iic_BREADY,m_axi_iic_ARADDR[31:0],m_axi_iic_ARLEN[7:0],m_axi_iic_ARSIZE[2:0],m_axi_iic_ARBURST[1:0],m_axi_iic_ARLOCK[1:0],m_axi_iic_ARREGION[3:0],m_axi_iic_ARCACHE[3:0],m_axi_iic_ARPROT[2:0],m_axi_iic_ARQOS[3:0],m_axi_iic_ARVALID,m_axi_iic_ARREADY,m_axi_iic_RDATA[31:0],m_axi_iic_RRESP[1:0],m_axi_iic_RLAST,m_axi_iic_RVALID,m_axi_iic_RREADY,rx_fifo_outValue[31:0]" */;
