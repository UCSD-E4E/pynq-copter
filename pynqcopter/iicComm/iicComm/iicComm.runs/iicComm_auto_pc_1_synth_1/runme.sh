...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm/iicComm/iicComm.runs/iicComm_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm_auto_pc_1.tcl
