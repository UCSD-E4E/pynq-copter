...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm/iicComm/iicComm.runs/iicComm_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm_processing_system7_0_0.tcl
