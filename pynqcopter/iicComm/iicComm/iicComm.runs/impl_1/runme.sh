...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm/iicComm/iicComm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicComm_wrapper.tcl -notrace
