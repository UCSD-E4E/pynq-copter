...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm/iicComm/iicComm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm_wrapper.tcl
