...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte2/bmeMultibyte2/bmeMultibyte2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeMultibyte2_wrapper.tcl -notrace
