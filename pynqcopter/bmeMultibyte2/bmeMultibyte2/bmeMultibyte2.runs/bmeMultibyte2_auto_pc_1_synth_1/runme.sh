...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyte2/bmeMultibyte2/bmeMultibyte2.runs/bmeMultibyte2_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyte2_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmeMultibyte2_auto_pc_1.tcl
