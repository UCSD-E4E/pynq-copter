...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicStat/iicStat/iicStat.runs/iicStat_iicstat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicStat_iicstat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicStat_iicstat_0_0.tcl
