...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicStat/iicStat/iicStat.runs/iicStat_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicStat_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicStat_auto_pc_0.tcl
