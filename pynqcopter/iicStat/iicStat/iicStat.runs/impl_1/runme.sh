...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicStat/iicStat/iicStat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicStat_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicStat_wrapper.tcl -notrace
