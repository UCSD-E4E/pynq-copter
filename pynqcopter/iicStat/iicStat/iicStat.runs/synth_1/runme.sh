...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicStat/iicStat/iicStat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicStat_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicStat_wrapper.tcl
