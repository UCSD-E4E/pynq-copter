...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/bmeMultibyteOg/bmeMultibyteOg/bmeMultibyteOg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmeMultibyteOg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmeMultibyteOg_wrapper.tcl -notrace
