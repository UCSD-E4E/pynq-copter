...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm3/iicComm3/iicComm3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicComm3_wrapper.tcl -notrace
