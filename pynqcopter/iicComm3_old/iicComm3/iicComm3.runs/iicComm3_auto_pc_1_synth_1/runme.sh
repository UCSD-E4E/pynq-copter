...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm3/iicComm3/iicComm3.runs/iicComm3_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm3_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm3_auto_pc_1.tcl
