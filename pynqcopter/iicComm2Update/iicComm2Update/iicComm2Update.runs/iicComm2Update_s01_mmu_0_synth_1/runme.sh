...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm2Update/iicComm2Update/iicComm2Update.runs/iicComm2Update_s01_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm2Update_s01_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iicComm2Update_s01_mmu_0.tcl
