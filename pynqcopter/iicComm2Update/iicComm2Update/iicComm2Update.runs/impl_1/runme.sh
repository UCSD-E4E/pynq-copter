...
HD_PWD='/home/iavendano/pynq-copter/pynqcopter/iicComm2Update/iicComm2Update/iicComm2Update.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iicComm2Update_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iicComm2Update_wrapper.tcl -notrace
