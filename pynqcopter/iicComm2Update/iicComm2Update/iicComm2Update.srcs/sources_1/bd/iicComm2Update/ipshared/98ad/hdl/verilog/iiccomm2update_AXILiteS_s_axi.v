...
#(parameter
    ...
    output wire [31:0]                   flag3,
    input  wire [31:0]                   basepoint0,
    input  wire                          basepoint0_ap_vld,
    input  wire [31:0]                   basepoint1,
    input  wire                          basepoint1_ap_vld,
    input  wire [31:0]                   basepoint2,
    input  wire                          basepoint2_ap_vld,
    input  wire [31:0]                   basepoint3,
    input  wire                          basepoint3_ap_vld,
    input  wire [31:0]                   basepoint4,
    input  wire                          basepoint4_ap_vld
);
//------------------------Address Info-------------------
...
//        bit 31~0 - flag3[31:0] (Read/Write)
// 0xb4 : reserved
// 0xb8 : Data signal of basepoint0
//        bit 31~0 - basepoint0[31:0] (Read)
// 0xbc : Control signal of basepoint0
//        bit 0  - basepoint0_ap_vld (Read/COR)
//        others - reserved
// 0xc0 : Data signal of basepoint1
//        bit 31~0 - basepoint1[31:0] (Read)
// 0xc4 : Control signal of basepoint1
//        bit 0  - basepoint1_ap_vld (Read/COR)
//        others - reserved
// 0xc8 : Data signal of basepoint2
//        bit 31~0 - basepoint2[31:0] (Read)
// 0xcc : Control signal of basepoint2
//        bit 0  - basepoint2_ap_vld (Read/COR)
//        others - reserved
// 0xd0 : Data signal of basepoint3
//        bit 31~0 - basepoint3[31:0] (Read)
// 0xd4 : Control signal of basepoint3
//        bit 0  - basepoint3_ap_vld (Read/COR)
//        others - reserved
// 0xd8 : Data signal of basepoint4
//        bit 31~0 - basepoint4[31:0] (Read)
// 0xdc : Control signal of basepoint4
//        bit 0  - basepoint4_ap_vld (Read/COR)
//        others - reserved
...
localparam
    ...
    ADDR_BASEPOINT0_DATA_0          = 8'hb8,
    ADDR_BASEPOINT0_CTRL            = 8'hbc,
    ADDR_BASEPOINT1_DATA_0          = 8'hc0,
    ADDR_BASEPOINT1_CTRL            = 8'hc4,
    ADDR_BASEPOINT2_DATA_0          = 8'hc8,
    ADDR_BASEPOINT2_CTRL            = 8'hcc,
    ADDR_BASEPOINT3_DATA_0          = 8'hd0,
    ADDR_BASEPOINT3_CTRL            = 8'hd4,
    ADDR_BASEPOINT4_DATA_0          = 8'hd8,
    ADDR_BASEPOINT4_CTRL            = 8'hdc,
    WRIDLE                          = 2'd0,
    WRDATA                          = 2'd1,
    WRRESP                          = 2'd2,
    WRRESET                         = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_basepoint1 = 'b0;
    reg                           int_basepoint1_ap_vld;
    reg  [31:0]                   int_basepoint2 = 'b0;
    reg                           int_basepoint2_ap_vld;
    reg  [31:0]                   int_basepoint3 = 'b0;
    reg                           int_basepoint3_ap_vld;
    reg  [31:0]                   int_basepoint4 = 'b0;
    reg                           int_basepoint4_ap_vld;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_BASEPOINT1_DATA_0: begin
                    rdata <= int_basepoint1[31:0];
                end
                ADDR_BASEPOINT1_CTRL: begin
                    rdata[0] <= int_basepoint1_ap_vld;
                end
                ADDR_BASEPOINT2_DATA_0: begin
                    rdata <= int_basepoint2[31:0];
                end
                ADDR_BASEPOINT2_CTRL: begin
                    rdata[0] <= int_basepoint2_ap_vld;
                end
                ADDR_BASEPOINT3_DATA_0: begin
                    rdata <= int_basepoint3[31:0];
                end
                ADDR_BASEPOINT3_CTRL: begin
                    rdata[0] <= int_basepoint3_ap_vld;
                end
                ADDR_BASEPOINT4_DATA_0: begin
                    rdata <= int_basepoint4[31:0];
                end
                ADDR_BASEPOINT4_CTRL: begin
                    rdata[0] <= int_basepoint4_ap_vld;
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_FLAG3_DATA_0)
            int_flag3[31:0] <= (WDATA[31:0] & wmask) | (int_flag3[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (basepoint1_ap_vld)
            int_basepoint1 <= basepoint1;
    end
end

// int_basepoint1_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_basepoint1_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (basepoint1_ap_vld)
            int_basepoint1_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_BASEPOINT1_CTRL)
            int_basepoint1_ap_vld <= 1'b0; // clear on read
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (basepoint2_ap_vld)
            int_basepoint2 <= basepoint2;
    end
end

// int_basepoint2_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_basepoint2_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (basepoint2_ap_vld)
            int_basepoint2_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_BASEPOINT2_CTRL)
            int_basepoint2_ap_vld <= 1'b0; // clear on read
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (basepoint3_ap_vld)
            int_basepoint3 <= basepoint3;
    end
end

// int_basepoint3_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_basepoint3_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (basepoint3_ap_vld)
            int_basepoint3_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_BASEPOINT3_CTRL)
            int_basepoint3_ap_vld <= 1'b0; // clear on read
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (basepoint4_ap_vld)
            int_basepoint4 <= basepoint4;
    end
end

// int_basepoint4_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_basepoint4_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (basepoint4_ap_vld)
            int_basepoint4_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_BASEPOINT4_CTRL)
            int_basepoint4_ap_vld <= 1'b0; // clear on read
    end
end
